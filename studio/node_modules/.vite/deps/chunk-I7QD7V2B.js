...
import {
  ...
  usePortal,
  useToast
} from "./chunk-FJ57VH7K.js";
import {
  require_compiler_runtime
} from "./chunk-UWCMJYY3.js";
import {
  require_jsx_runtime
  ...
  "node_modules/md5-o-matic/lib/md5omatic.js"(exports, module) {
    ...
    function md5omatic(str) {
      ...
      for (var i = 0; i < x.length; i += 16) {
        ...
        var oldc = c3;
        var oldd = d;
        a = ff(a, b, c3, d, x[i + 0], 7, -680876936);
        d = ff(d, a, b, c3, x[i + 1], 12, -389564586);
        c3 = ff(c3, d, a, b, x[i + 2], 17, 606105819);
        b = ff(b, c3, d, a, x[i + 3], 22, -1044525330);
        a = ff(a, b, c3, d, x[i + 4], 7, -176418897);
        d = ff(d, a, b, c3, x[i + 5], 12, 1200080426);
        c3 = ff(c3, d, a, b, x[i + 6], 17, -1473231341);
        b = ff(b, c3, d, a, x[i + 7], 22, -45705983);
        a = ff(a, b, c3, d, x[i + 8], 7, 1770035416);
        d = ff(d, a, b, c3, x[i + 9], 12, -1958414417);
        c3 = ff(c3, d, a, b, x[i + 10], 17, -42063);
        b = ff(b, c3, d, a, x[i + 11], 22, -1990404162);
        a = ff(a, b, c3, d, x[i + 12], 7, 1804603682);
        d = ff(d, a, b, c3, x[i + 13], 12, -40341101);
        c3 = ff(c3, d, a, b, x[i + 14], 17, -1502002290);
        b = ff(b, c3, d, a, x[i + 15], 22, 1236535329);
        a = gg(a, b, c3, d, x[i + 1], 5, -165796510);
        d = gg(d, a, b, c3, x[i + 6], 9, -1069501632);
        c3 = gg(c3, d, a, b, x[i + 11], 14, 643717713);
        b = gg(b, c3, d, a, x[i + 0], 20, -373897302);
        a = gg(a, b, c3, d, x[i + 5], 5, -701558691);
        d = gg(d, a, b, c3, x[i + 10], 9, 38016083);
        c3 = gg(c3, d, a, b, x[i + 15], 14, -660478335);
        b = gg(b, c3, d, a, x[i + 4], 20, -405537848);
        a = gg(a, b, c3, d, x[i + 9], 5, 568446438);
        d = gg(d, a, b, c3, x[i + 14], 9, -1019803690);
        c3 = gg(c3, d, a, b, x[i + 3], 14, -187363961);
        b = gg(b, c3, d, a, x[i + 8], 20, 1163531501);
        a = gg(a, b, c3, d, x[i + 13], 5, -1444681467);
        d = gg(d, a, b, c3, x[i + 2], 9, -51403784);
        c3 = gg(c3, d, a, b, x[i + 7], 14, 1735328473);
        b = gg(b, c3, d, a, x[i + 12], 20, -1926607734);
        a = hh(a, b, c3, d, x[i + 5], 4, -378558);
        d = hh(d, a, b, c3, x[i + 8], 11, -2022574463);
        c3 = hh(c3, d, a, b, x[i + 11], 16, 1839030562);
        b = hh(b, c3, d, a, x[i + 14], 23, -35309556);
        a = hh(a, b, c3, d, x[i + 1], 4, -1530992060);
        d = hh(d, a, b, c3, x[i + 4], 11, 1272893353);
        c3 = hh(c3, d, a, b, x[i + 7], 16, -155497632);
        b = hh(b, c3, d, a, x[i + 10], 23, -1094730640);
        a = hh(a, b, c3, d, x[i + 13], 4, 681279174);
        d = hh(d, a, b, c3, x[i + 0], 11, -358537222);
        c3 = hh(c3, d, a, b, x[i + 3], 16, -722521979);
        b = hh(b, c3, d, a, x[i + 6], 23, 76029189);
        a = hh(a, b, c3, d, x[i + 9], 4, -640364487);
        d = hh(d, a, b, c3, x[i + 12], 11, -421815835);
        c3 = hh(c3, d, a, b, x[i + 15], 16, 530742520);
        b = hh(b, c3, d, a, x[i + 2], 23, -995338651);
        a = ii(a, b, c3, d, x[i + 0], 6, -198630844);
        d = ii(d, a, b, c3, x[i + 7], 10, 1126891415);
        c3 = ii(c3, d, a, b, x[i + 14], 15, -1416354905);
        b = ii(b, c3, d, a, x[i + 5], 21, -57434055);
        a = ii(a, b, c3, d, x[i + 12], 6, 1700485571);
        d = ii(d, a, b, c3, x[i + 3], 10, -1894986606);
        c3 = ii(c3, d, a, b, x[i + 10], 15, -1051523);
        b = ii(b, c3, d, a, x[i + 1], 21, -2054922799);
        a = ii(a, b, c3, d, x[i + 8], 6, 1873313359);
        d = ii(d, a, b, c3, x[i + 15], 10, -30611744);
        c3 = ii(c3, d, a, b, x[i + 6], 15, -1560198380);
        b = ii(b, c3, d, a, x[i + 13], 21, 1309151649);
        a = ii(a, b, c3, d, x[i + 4], 6, -145523070);
        d = ii(d, a, b, c3, x[i + 11], 10, -1120210379);
        c3 = ii(c3, d, a, b, x[i + 2], 15, 718787259);
        b = ii(b, c3, d, a, x[i + 9], 21, -343485551);
        a = addme(a, olda);
        b = addme(b, oldb);
        c3 = addme(c3, oldc);
        d = addme(d, oldd);
      }
      return rhex(a) + rhex(b) + rhex(c3) + rhex(d);
    }
    ...
    function str2blks_MD5(str) {
      ...
      var l2 = str.length * 8;
      blks[nblk * 16 - 2] = l2 & 255;
      blks[nblk * 16 - 2] |= (l2 >>> 8 & 255) << 8;
      blks[nblk * 16 - 2] |= (l2 >>> 16 & 255) << 16;
      blks[nblk * 16 - 2] |= (l2 >>> 24 & 255) << 24;
      return blks;
    }
    function rol(num, cnt) {
      return num << cnt | num >>> 32 - cnt;
    }
    function cmn(q, a, b, x, s2, t2) {
      return addme(rol(addme(addme(a, q), addme(x, t2)), s2), b);
    }
    function ff(a, b, c3, d, x, s2, t2) {
      return cmn(bitOR(bitAND(b, c3), bitAND(~b, d)), a, b, x, s2, t2);
    }
    function gg(a, b, c3, d, x, s2, t2) {
      return cmn(bitOR(bitAND(b, d), bitAND(c3, ~d)), a, b, x, s2, t2);
    }
    function hh(a, b, c3, d, x, s2, t2) {
      return cmn(bitXOR(bitXOR(b, c3), d), a, b, x, s2, t2);
    }
    function ii(a, b, c3, d, x, s2, t2) {
      return cmn(bitXOR(c3, bitOR(b, ~d)), a, b, x, s2, t2);
    }
  }
});
...
var structureUsEnglishLocaleBundle = defineLocaleResourceBundle({
  ...
  resources: () => import("./resources7-DCOCRJ7R.js")
});
...
function getOrderingMenuItemsForSchemaType(context, typeName) {
  const {
    schema
  } = context, type2 = typeof typeName == "string" ? schema.get(typeName) : typeName;
  return !type2 || !("orderings" in type2) ? [] : (type2.orderings ? type2.orderings.concat(DEFAULT_ORDERING_OPTIONS) : DEFAULT_ORDERING_OPTIONS).map((ordering) => getOrderingMenuItem(context, ordering, getExtendedProjection(type2, ordering.by)));
}
...
function validateId(id2, parentPath, pathSegment) {
  if (typeof id2 != "string")
    throw new SerializeError(`Structure node id must be of type string, got ${typeof id2}`, parentPath, pathSegment);
  const [disallowedChar] = id2.match(disallowedPattern) || [];
  if (disallowedChar)
    throw new SerializeError(`Structure node id cannot contain character "${disallowedChar}"`, parentPath, pathSegment);
  if (id2.startsWith("__edit__"))
    throw new SerializeError("Structure node id cannot start with __edit__", parentPath, pathSegment);
  return id2;
}
function getStructureNodeId(title, id2) {
  if (id2)
    return id2;
...
var ComponentBuilder = class _ComponentBuilder {
  ...
  serialize(options = {
    ...
    return {
      id: validateId(id2, options.path, options.index),
      title,
      type: "component",
      child,
      component: component2,
...
async function resolveTypeForDocument(getClient, id2) {
...
var createDocumentChildResolver = ({
  ...
  let type2 = params.type;
  const parentPath = path.slice(0, path.length - 1), currentSegment = path[path.length - 1];
  if (type2 || (type2 = await resolveTypeForDocument(getClient, itemId)), !type2)
...
var DocumentBuilder = class _DocumentBuilder {
  ...
  serialize({
    ...
    const urlId = path[index || path.length - 1], id2 = this.spec.id || urlId && `${urlId}` || "", options = {
      id: id2,
      type: void 0,
      template: void 0,
    ...
    if (!options || !options.id)
      throw new SerializeError("document id (`id`) is required for document nodes", path, id2, hint).withHelpUrl(HELP_URL.DOCUMENT_ID_REQUIRED);
    if (!options || !options.type)
      throw new SerializeError("document type (`schemaType`) is required for document nodes", path, id2, hint);
    ...
    if (dupes.length > 0)
      throw new SerializeError(`document node has views with duplicate IDs: ${dupes.join(",  ")}`, path, id2, hint);
    return {
      ...this.spec,
      child: this.spec.child || createDocumentChildResolver(this._context),
      id: validateId(id2, path, index),
      type: "document",
...
function documentFromEditor(context, spec) {
  ...
  return doc = doc.id(spec.id).documentId(id2), type2 && (doc = doc.schemaType(type2)), template && (doc = doc.initialValueTemplate(template, templateParameters)), spec.child && (doc = doc.child(spec.child)), doc;
}
...
var GenericListBuilder = class {
  ...
  serialize(options = {
    ...
    const id2 = this.spec.id || "", path = options.path, defaultLayout = this.spec.defaultLayout;
    if (defaultLayout && !layoutOptions.includes(defaultLayout))
      throw new SerializeError(`\`layout\` must be one of ${layoutOptions.map((item) => `"${item}"`).join(", ")}`, path, id2 || options.index, this.spec.title);
    ...
    return {
      id: validateId(id2, options.path, id2 || options.index),
...
var createDocumentChildResolverForItem = (context) => (itemId, options) => {
  const parentItem = options.parent, template = options.params?.template ? context.templates.find((tpl) => tpl.id === options.params.template) : void 0, type2 = template ? template.schemaType : parentItem.schemaTypeName || resolveTypeForDocument(context.getClient, itemId);
  return Promise.resolve(type2).then((schemaType) => schemaType ? context.resolveDocumentNode({
    schemaType,
    documentId: itemId
...
var DocumentListBuilder = class _DocumentListBuilder extends GenericListBuilder {
   ...
   */
  schemaType(type2) {
    const schemaTypeName = typeof type2 == "string" ? type2 : type2.name;
    return this.clone({
      schemaTypeName
    });
  }
...
var ListBuilder = class _ListBuilder extends GenericListBuilder {
  ...
  serialize(options = {
    ...
    const path = (options.path || []).concat(id2), serializedItems = items2.map((item, index) => maybeSerializeListItem(item, index, path)), dupes = serializedItems.filter((val, i) => find_default(serializedItems, {
      id: val.id
    }, i + 1));
    if (dupes.length > 0) {
...
var ListItemBuilder = class _ListItemBuilder {
  ...
  serialize(options = {
    ...
    if (!options.titleIsOptional && (typeof title != "string" || !title))
      throw new SerializeError("`title` is required for list items", options.path, id2).withHelpUrl(HELP_URL.TITLE_REQUIRED);
    let schemaType = this.spec.schemaType;
    if (typeof schemaType == "string") {
      const type2 = this._context.schema.get(schemaType);
      if (!type2)
        throw new SerializeError(`Could not find type "${schemaType}" in schema`, options.path, id2).withHelpUrl(HELP_URL.SCHEMA_TYPE_NOT_FOUND);
      schemaType = type2;
    }
    const serializeOptions = {
      path: options.path.concat(id2),
      hint: "child"
    };
...
function getDocumentTypeListItem(context, typeName) {
  const {
    schema
  } = context, type2 = schema.get(typeName);
  if (!type2)
    throw new Error(`Schema type with name "${typeName}" not found`);
  const title = type2.title || startCase_default(typeName);
  return new ListItemBuilder(context).id(typeName).title(title).schemaType(type2).child((id2, childContext) => {
    const parent = childContext.parent, parentItem = isList(parent) ? parent.items.find((item) => item.id === id2) : null;
...
function getDocumentTypeList(context, typeNameOrSpec) {
  const {
    schema,
    resolveDocumentNode
  } = context, schemaType = typeof typeNameOrSpec == "string" ? typeNameOrSpec : typeNameOrSpec.schemaType, typeName = typeof schemaType == "string" ? schemaType : schemaType.name, spec = typeof typeNameOrSpec == "string" ? {} : typeNameOrSpec, type2 = schema.get(typeName);
  if (!type2)
    throw new Error(`Schema type with name "${typeName}" not found`);
  const title = type2.title || startCase_default(typeName);
  return new DocumentTypeListBuilder(context).id(spec.id || typeName).title(spec.title || title).filter("_type == $type").params({
    type: typeName
  }).schemaType(type2).defaultOrdering(DEFAULT_SELECTED_ORDERING_OPTION.by).menuItemGroups(spec.menuItemGroups || [{
    id: "sorting",
    title: "Sort",
    i18n: {
      title: {
    ...
    // Sort by <Y>
    ...getOrderingMenuItemsForSchemaType(context, type2),
    // Display as <Z>
...
function getDefaultStructure(context) {
  const items2 = getDocumentTypeListItems(context);
  return new ListBuilder(context).id("__root__").title("Content").i18n({
    title: {
      key: "default-definition.content-title",
      ns: structureLocaleNamespace
    }
  }).items(items2).showIcons(items2.some((item) => hasIcon(item.getSchemaType())));
}
...
function isPrimitive(value) {
  const t2 = type(value);
  return t2 !== "Object" && t2 !== "Array";
}
var Highlighter = class extends import_react2.Component {
  ...
  render() {
    ...
    if (!highlight || highlightStart === -1)
      return (0, import_jsx_runtime2.jsx)("span", { children: str });
    const highlightLength = highlight.source.length, highlightString = str.slice(
      highlightStart,
      highlightStart + highlightLength
    );
    return (0, import_jsx_runtime2.jsx)("span", { children: str.split(highlight).map(function(part, index) {
      return (0, import_jsx_runtime2.jsxs)("span", { children: [
        index > 0 ? (0, import_jsx_runtime2.jsx)("span", { className: "json-inspector__hl", children: highlightString }) : null,
        part
      ] }, index);
    }) });
  }
...
var Leaf = class _Leaf extends import_react2.Component {
  constructor(props) {
  ...
  render() {
    const { label, data, root: root2, id: inputId } = this.props, id2 = "id_" + uid(), d = {
      path: this.keypath(),
      key: label.toString(),
      value: data
    ...
    return (0, import_jsx_runtime2.jsxs)(
      "div",
      {
        "data-testid": root2 ? "leaf-root" : "leaf-child",
        "aria-expanded": this.state.expanded,
        "data-root": root2 || void 0,
        ...
        children: [
          ...
          (0, import_jsx_runtime2.jsxs)(
            "label",
            {
              ...
              children: [
                (0, import_jsx_runtime2.jsx)("div", { className: "json-inspector__flatpath", children: d.path }),
                (0, import_jsx_runtime2.jsxs)("span", { className: "json-inspector__key", children: [
                  this.format(d.key),
                  ":",
  ...
  renderTitle() {
    const data = this.data(), t2 = type(data);
    if (Array.isArray(data)) {
      const length = data.length;
      return (0, import_jsx_runtime2.jsxs)("span", { className: "json-inspector__value json-inspector__value_helper", children: [
        length > 0 ? "[…] " : "[] ",
        items(length)
      ] });
    }
    ...
    return (0, import_jsx_runtime2.jsxs)(
      "span",
      {
        className: "json-inspector__value json-inspector__value_" + t2.toLowerCase(),
        children: [
  ...
  renderShowOriginalButton() {
    ...
    return isPrimitive(data) || this.state.original || !getOriginal || !query || query.test(this.keypath()) ? null : (0, import_jsx_runtime2.jsx)(
      "span",
      {
  ...
  renderInteractiveLabel(originalValue, isKey) {
    ...
    return typeof InteractiveLabel == "function" ? (0, import_jsx_runtime2.jsx)(
      InteractiveLabel,
      {
  ...
  format(str) {
    return (0, import_jsx_runtime2.jsx)(Highlighter, { string: str, highlight: this.props.query });
  }
  getClassName() {
  ...
  _onClick(data, e2) {
    this.toggle(), this.props.onClick && this.props.onClick(data), e2.stopPropagation();
  }
  _onShowOriginalClick = (e2) => {
    this.setState({
...
function items(count2) {
  return count2 + (count2 === 1 ? " item" : " items");
}
function properties(count2) {
  return count2 + (count2 === 1 ? " property" : " properties");
}
...
var SearchBar = ({ onChange = noop }) => {
  const onSearchChange = (0, import_react2.useCallback)(
...
var JsonInspector = class extends import_react2.Component {
  static defaultProps = {
    data: null,
    search: SearchBar,
    searchOptions: {
  ...
  render() {
    ...
    return (0, import_jsx_runtime2.jsxs)(
      "div",
      {
        ...
        children: [
          this.renderToolbar(),
          isNotFound ? (0, import_jsx_runtime2.jsx)("div", { className: "json-inspector__not-found", children: "Nothing found" }) : (0, import_jsx_runtime2.jsx)(
            Leaf,
            {
              data,
              onClick,
  ...
  renderToolbar() {
    const Search2 = this.props.search;
    return Search2 ? (0, import_jsx_runtime2.jsx)("div", { className: "json-inspector__toolbar", children: (0, import_jsx_runtime2.jsx)(
      Search2,
      {
...
var createRow = (table, id2, original, rowIndex, depth, subRows, parentId) => {
  let row = {
    id: id2,
    index: rowIndex,
    original,
...
var mutateRowIsSelected = (selectedRowIds, id2, value, includeChildren, table) => {
  var _row$subRows;
...
function useDiffViewState(t0) {
  ...
  const mode = t2, anyParamSet = [previousDocument, nextDocument, mode].some(_temp$K), t3 = previousDocument ?? "", t4 = nextDocument ?? "", t5 = mode ?? "";
  let t6;
  ...
  let t8;
  if ($[15] !== anyParamSet || $[16] !== onParamsError || $[17] !== params ? (t8 = [anyParamSet, onParamsError, params], $[15] = anyParamSet, $[16] = onParamsError, $[17] = params, $[18] = t8) : t8 = $[18], (0, import_react3.useEffect)(t7, t8), params.result === "error") {
    let t92;
...
function useScrollMirror(elements) {
  ...
  let t0, t1;
  $[0] !== elements ? (t0 = () => {
    const existentElements = elements.filter(_temp$J);
    if (existentElements.length === 0)
      return;
    const scrollMirror = new s(existentElements);
    return () => scrollMirror.destroy();
  }, t1 = [elements], $[0] = elements, $[1] = t0, $[2] = t1) : (t0 = $[1], t1 = $[2]), (0, import_react3.useEffect)(t0, t1);
}
function _temp$J(element) {
  return element !== null;
}
...
var VersionModeHeaderLayout = at.header`
  display: grid;
  grid-area: header;
  grid-template-columns: 1fr min-content 1fr;
  border-block-end: 1px solid var(--card-border-color);
`;
var VersionModeHeaderLayoutSection = at.div`
  display: flex;
...
var VersionModeHeader = (t0) => {
  ...
  let t22;
  $[2] !== documentVersions ? (t22 = documentVersions.flatMap(_temp$I), $[2] = documentVersions, $[3] = t22) : t22 = $[3];
  ...
  let t8;
  $[19] !== t7 ? (t8 = (0, import_jsx_runtime3.jsx)(Box, { padding: 4, children: (0, import_jsx_runtime3.jsx)(Text, { as: "h1", size: 1, muted: true, children: t7 }) }), $[19] = t7, $[20] = t8) : t8 = $[20];
  let t9;
  $[21] !== documentId || $[22] !== documents || $[23] !== onSelectPreviousRelease || $[24] !== releases || $[25] !== releasesState || $[26] !== state2 ? (t9 = typeof documents?.previous < "u" && (0, import_jsx_runtime3.jsx)(VersionMenu, { releases, releasesState, onSelectRelease: onSelectPreviousRelease, role: "previous", documentId, state: state2, document: documents.previous }), $[21] = documentId, $[22] = documents, $[23] = onSelectPreviousRelease, $[24] = releases, $[25] = releasesState, $[26] = state2, $[27] = t9) : t9 = $[27];
  let t10;
  $[28] !== t8 || $[29] !== t9 ? (t10 = (0, import_jsx_runtime3.jsxs)(VersionModeHeaderLayoutSection, { children: [
    t8,
    t9
  ] }), $[28] = t8, $[29] = t9, $[30] = t10) : t10 = $[30];
  let t11;
  $[31] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t11 = (0, import_jsx_runtime3.jsx)(Flex, { align: "center", paddingX: 3, children: (0, import_jsx_runtime3.jsx)(Text, { size: 1, children: (0, import_jsx_runtime3.jsx)(TransferIcon, {}) }) }), $[31] = t11) : t11 = $[31];
  let t12;
  $[32] !== documentId || $[33] !== documents || $[34] !== onSelectNextRelease || $[35] !== releases || $[36] !== releasesState || $[37] !== state2 ? (t12 = typeof documents?.next < "u" && (0, import_jsx_runtime3.jsx)(VersionMenu, { releases, releasesState, onSelectRelease: onSelectNextRelease, role: "next", documentId, state: state2, document: documents.next }), $[32] = documentId, $[33] = documents, $[34] = onSelectNextRelease, $[35] = releases, $[36] = releasesState, $[37] = state2, $[38] = t12) : t12 = $[38];
  let t13;
  $[39] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t13 = {
    justifySelf: "end"
  }, $[39] = t13) : t13 = $[39];
  let t14;
  $[40] !== exitDiffView ? (t14 = (0, import_jsx_runtime3.jsx)(Box, { padding: 3, style: t13, children: (0, import_jsx_runtime3.jsx)(Button, { icon: CloseIcon, mode: "bleed", onClick: exitDiffView, padding: 2 }) }), $[40] = exitDiffView, $[41] = t14) : t14 = $[41];
  let t15;
  $[42] !== t12 || $[43] !== t14 ? (t15 = (0, import_jsx_runtime3.jsxs)(VersionModeHeaderLayoutSection, { children: [
    t12,
    t14
  ] }), $[42] = t12, $[43] = t14, $[44] = t15) : t15 = $[44];
  let t16;
  return $[45] !== t10 || $[46] !== t15 ? (t16 = (0, import_jsx_runtime3.jsxs)(VersionModeHeaderLayout, { children: [
    t10,
    t11,
    t15
...
var VersionMenu = (t0) => {
  ...
  if (releasesState === "error") {
    ...
    let t82;
    return $[9] !== t72 ? (t82 = (0, import_jsx_runtime3.jsx)(Badge, { tone: "critical", radius: 3, children: t72 }), $[9] = t72, $[10] = t82) : t82 = $[10], t82;
  }
  let t7;
  ...
  let t8;
  $[16] !== t7 ? (t8 = (0, import_jsx_runtime3.jsx)(Button, { type: "button", mode: "bleed", padding: 2, paddingRight: 3, radius: "full", selected: true, ...t7 }), $[16] = t7, $[17] = t8) : t8 = $[17];
  let t9;
  $[18] !== documentId || $[19] !== onSelectRelease || $[20] !== published || $[21] !== selected ? (t9 = published && (0, import_jsx_runtime3.jsx)(VersionMenuItem, { type: "published", onSelect: onSelectRelease, isSelected: selected === "published", documentId }), $[18] = documentId, $[19] = onSelectRelease, $[20] = published, $[21] = selected, $[22] = t9) : t9 = $[22];
  let t10;
  $[23] !== documentId || $[24] !== draft || $[25] !== isDraftModelEnabled || $[26] !== onSelectRelease || $[27] !== selected ? (t10 = isDraftModelEnabled && draft && (0, import_jsx_runtime3.jsx)(VersionMenuItem, { type: "draft", onSelect: onSelectRelease, isSelected: selected === "draft", documentId }), $[23] = documentId, $[24] = draft, $[25] = isDraftModelEnabled, $[26] = onSelectRelease, $[27] = selected, $[28] = t10) : t10 = $[28];
  let t11;
  if ($[29] !== documentId || $[30] !== onSelectRelease || $[31] !== releases || $[32] !== selected) {
    let t122;
    $[34] !== documentId || $[35] !== onSelectRelease || $[36] !== selected ? (t122 = (release) => (0, import_jsx_runtime3.jsx)(VersionMenuItem, { release, onSelect: onSelectRelease, isSelected: typeof selected != "string" && selected?._id === release._id, documentId }, release._id), $[34] = documentId, $[35] = onSelectRelease, $[36] = selected, $[37] = t122) : t122 = $[37], t11 = releases.map(t122), $[29] = documentId, $[30] = onSelectRelease, $[31] = releases, $[32] = selected, $[33] = t11;
  } else
    t11 = $[33];
  let t12;
  $[38] !== t10 || $[39] !== t11 || $[40] !== t9 ? (t12 = (0, import_jsx_runtime3.jsxs)(Menu, { children: [
    t9,
    t10,
    t11
  ] }), $[38] = t10, $[39] = t11, $[40] = t9, $[41] = t12) : t12 = $[41];
  let t13;
  return $[42] !== role || $[43] !== t12 || $[44] !== t8 ? (t13 = (0, import_jsx_runtime3.jsx)(MenuButton, { id: role, button: t8, menu: t12 }), $[42] = role, $[43] = t12, $[44] = t8, $[45] = t13) : t13 = $[45], t13;
};
var VersionMenuItem = (t0) => {
  ...
  let t1;
  $[0] !== documentId || $[1] !== onSelect || $[2] !== release || $[3] !== type2 ? (t1 = () => {
    if (type2 === "draft") {
  ...
  }, $[0] = documentId, $[1] = onSelect, $[2] = release, $[3] = type2, $[4] = t1) : t1 = $[4];
  const onClick = t1;
  if (type2) {
    const tone = type2 === "published" ? "positive" : "caution";
    let t22;
    $[5] !== tone ? (t22 = (0, import_jsx_runtime3.jsx)(ReleaseAvatar, { padding: 2, tone }), $[5] = tone, $[6] = t22) : t22 = $[6];
    let t32;
    $[7] !== type2 ? (t32 = ["compare-versions.status", type2], $[7] = type2, $[8] = t32) : t32 = $[8];
    const t42 = t32.join(".");
    let t52;
    $[9] !== t42 || $[10] !== tStructure ? (t52 = tStructure(t42), $[9] = t42, $[10] = tStructure, $[11] = t52) : t52 = $[11];
    let t62;
    $[12] !== t52 ? (t62 = (0, import_jsx_runtime3.jsx)(Box, { paddingY: 2, children: (0, import_jsx_runtime3.jsx)(Text, { size: 1, weight: "medium", children: t52 }) }), $[12] = t52, $[13] = t62) : t62 = $[13];
    let t72;
    $[14] !== t22 || $[15] !== t62 ? (t72 = (0, import_jsx_runtime3.jsxs)(Flex, { gap: 1, children: [
      t22,
      t62
    ] }), $[14] = t22, $[15] = t62, $[16] = t72) : t72 = $[16];
    let t82;
    return $[17] !== isSelected || $[18] !== onClick || $[19] !== t72 ? (t82 = (0, import_jsx_runtime3.jsx)(MenuItem, { padding: 1, paddingRight: 3, onClick, pressed: isSelected, children: t72 }), $[17] = isSelected, $[18] = onClick, $[19] = t72, $[20] = t82) : t82 = $[20], t82;
  }
  let t2;
  $[21] !== release ? (t2 = release ? getReleaseTone(release) : "neutral", $[21] = release, $[22] = t2) : t2 = $[22];
  const tone_0 = t2;
  let t3;
  $[23] !== tone_0 ? (t3 = (0, import_jsx_runtime3.jsx)(ReleaseAvatar, { padding: 2, tone: tone_0 }), $[23] = tone_0, $[24] = t3) : t3 = $[24];
  let t4;
  ...
  let t5;
  $[28] !== t4 ? (t5 = (0, import_jsx_runtime3.jsx)(Text, { size: 1, weight: "medium", children: t4 }), $[28] = t4, $[29] = t5) : t5 = $[29];
  let t6;
  $[30] !== release.metadata.releaseType || $[31] !== tCore ? (t6 = ["asap", "undecided"].includes(release.metadata.releaseType) && (0, import_jsx_runtime3.jsx)(Text, { muted: true, size: 1, children: tCore(`release.type.${release.metadata.releaseType}`) }), $[30] = release.metadata.releaseType, $[31] = tCore, $[32] = t6) : t6 = $[32];
  let t7;
  $[33] !== release ? (t7 = release.metadata.releaseType === "scheduled" && (0, import_jsx_runtime3.jsx)(Text, { muted: true, size: 1, children: formatRelativeLocalePublishDate(release) }), $[33] = release, $[34] = t7) : t7 = $[34];
  let t8;
  $[35] !== t5 || $[36] !== t6 || $[37] !== t7 ? (t8 = (0, import_jsx_runtime3.jsxs)(Stack, { flex: 1, paddingY: 2, paddingRight: 2, space: 2, children: [
    t5,
    t6,
    t7
  ] }), $[35] = t5, $[36] = t6, $[37] = t7, $[38] = t8) : t8 = $[38];
  let t9;
  $[39] !== release ? (t9 = isReleaseScheduledOrScheduling(release) && (0, import_jsx_runtime3.jsx)(Box, { padding: 2, children: (0, import_jsx_runtime3.jsx)(Text, { size: 1, children: (0, import_jsx_runtime3.jsx)(LockIcon, {}) }) }), $[39] = release, $[40] = t9) : t9 = $[40];
  let t10;
  $[41] !== t9 ? (t10 = (0, import_jsx_runtime3.jsx)(Flex, { flex: "none", children: t9 }), $[41] = t9, $[42] = t10) : t10 = $[42];
  let t11;
  $[43] !== t10 || $[44] !== t3 || $[45] !== t8 ? (t11 = (0, import_jsx_runtime3.jsxs)(Flex, { gap: 1, children: [
    t3,
    t8,
    t10
  ] }), $[43] = t10, $[44] = t3, $[45] = t8, $[46] = t11) : t11 = $[46];
  let t12;
  return $[47] !== isSelected || $[48] !== onClick || $[49] !== t11 ? (t12 = (0, import_jsx_runtime3.jsx)(MenuItem, { padding: 1, paddingRight: 3, onClick, pressed: isSelected, children: t11 }), $[47] = isSelected, $[48] = onClick, $[49] = t11, $[50] = t12) : t12 = $[50], t12;
};
function getMenuButtonProps({
  ...
  if (isReleaseDocument(selected)) {
    ...
    return {
      ...
      icon: (0, import_jsx_runtime3.jsx)(ReleaseAvatar, { padding: 1, tone }),
      iconRight: selected && isReleaseScheduledOrScheduling(selected) ? (0, import_jsx_runtime3.jsx)(LockIcon, {}) : void 0,
      tone
    };
  }
  ...
  return {
    text: selected,
    icon: (0, import_jsx_runtime3.jsx)(ReleaseAvatar, { padding: 1, tone: "neutral" }),
    tone: "neutral"
  };
}
...
function _temp$I(id2) {
  return getVersionFromId(id2) ?? [];
}
var DialogLayout = at.div`
  --offset-block: 40px;
  display: grid;
...
function usePathSyncChannel(t0) {
  ...
  let t1;
  $[0] !== id2 || $[1] !== syncChannel ? (t1 = (state2) => syncChannel.next({
    ...state2,
    source: id2
  }), $[0] = id2, $[1] = syncChannel, $[2] = t1) : t1 = $[2];
  const push = t1;
  let t2;
  if ($[3] !== id2 || $[4] !== syncChannel) {
    let t32;
    $[6] !== id2 ? (t32 = (t4) => {
      const {
        source
      ...
      return source !== id2;
    }, $[6] = id2, $[7] = t32) : t32 = $[7], t2 = syncChannel.pipe(distinctUntilChanged(_temp$H), filter(t32), map(_temp2$i)), $[3] = id2, $[4] = syncChannel, $[5] = t2;
  } else
    t2 = $[5];
  const path = t2;
  let t3;
...
`;
var DiffViewPaneLayout = at(Card)`
  position: relative;
  grid-area: var(--grid-area);
`;
var Container2 = at(Container)`
  width: auto;
`;
var DiffViewPane = (0, import_react3.forwardRef)(function(t0, ref) {
  const $ = (0, import_compiler_runtime2.c)(36), {
    ...
    syncChannel,
    compareDocument
  } = t0, containerElement = (0, import_react3.useRef)(null), [portalElement, setPortalElement] = (0, import_react3.useState)(null), [boundaryElement, setBoundaryElement] = (0, import_react3.useState)(null);
  let t1;
  $[0] !== compareDocument || $[1] !== documentId || $[2] !== documentType || $[3] !== role || $[4] !== scrollElement || $[5] !== syncChannel ? (t1 = () => (0, import_jsx_runtime3.jsx)(DiffViewDocument, { compareDocument, documentId, documentType, role, scrollElement, syncChannel }), $[0] = compareDocument, $[1] = documentId, $[2] = documentType, $[3] = role, $[4] = scrollElement, $[5] = syncChannel, $[6] = t1) : t1 = $[6];
  const t2 = t1;
  let t3;
  $[7] !== t2 ? (t3 = {
  ...
  const t11 = t10;
  let t12;
  $[14] !== DocumentLayout2 || $[15] !== documentId || $[16] !== documentType ? (t12 = (0, import_jsx_runtime3.jsx)(DialogProvider, { position: "absolute", children: (0, import_jsx_runtime3.jsx)(Container2, { ref: containerElement, padding: 4, width: 1, children: (0, import_jsx_runtime3.jsx)(DocumentLayout2, { documentId, documentType }) }) }), $[14] = DocumentLayout2, $[15] = documentId, $[16] = documentType, $[17] = t12) : t12 = $[17];
  let t13;
  $[18] !== portalElement || $[19] !== t12 ? (t13 = (0, import_jsx_runtime3.jsx)(PortalProvider, { element: portalElement, children: t12 }), $[18] = portalElement, $[19] = t12, $[20] = t13) : t13 = $[20];
  let t14;
  $[21] !== ref || $[22] !== t11 || $[23] !== t13 ? (t14 = (0, import_jsx_runtime3.jsx)(Scroller$5, { ref, style: t11, children: t13 }), $[21] = ref, $[22] = t11, $[23] = t13, $[24] = t14) : t14 = $[24];
  let t15;
  $[25] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t15 = (0, import_jsx_runtime3.jsx)("div", { "data-testid": "diffView-document-panel-portal", ref: setPortalElement }), $[25] = t15) : t15 = $[25];
  let t16;
  $[26] !== t14 || $[27] !== t7 || $[28] !== t8 ? (t16 = (0, import_jsx_runtime3.jsxs)(DiffViewPaneLayout, { ref: setBoundaryElement, style: t7, borderLeft: t8, children: [
    t14,
    t15
  ] }), $[26] = t14, $[27] = t7, $[28] = t8, $[29] = t16) : t16 = $[29];
  let t17;
  $[30] !== boundaryElement || $[31] !== t16 ? (t17 = (0, import_jsx_runtime3.jsx)(BoundaryElementProvider, { element: boundaryElement, children: t16 }), $[30] = boundaryElement, $[31] = t16, $[32] = t17) : t17 = $[32];
  let t18;
  return $[33] !== scrollElement || $[34] !== t17 ? (t18 = (0, import_jsx_runtime3.jsx)(ReviewChangesContext.Provider, { value: t4, children: (0, import_jsx_runtime3.jsx)(ChangeIndicatorsTracker, { children: (0, import_jsx_runtime3.jsx)(VirtualizerScrollInstanceProvider, { scrollElement, containerElement, children: t17 }) }) }), $[33] = scrollElement, $[34] = t17, $[35] = t18) : t18 = $[35], t18;
});
var DiffViewDocument = (t0) => {
  ...
  const compareValue = useCompareValue(t1), {
    data: releases
  } = useActiveReleases(), [patchChannel] = (0, import_react3.useState)(_temp$G);
  let t2;
...
var EditReferenceLinkComponent = (t0) => {
  ...
  let t2;
  return $[3] !== children || $[4] !== href ? (t2 = (0, import_jsx_runtime3.jsx)(Link, { href, target: "_blank", rel: "noopener noreferrer", children }), $[3] = children, $[4] = href, $[5] = t2) : t2 = $[5], t2;
};
var DiffView = (t0) => {
  const $ = (0, import_compiler_runtime2.c)(24), {
    ...
    exitDiffView
  } = useDiffViewRouter(), syncChannel = useCreatePathSyncChannel(), [previousPaneElement, setPreviousPaneElement] = (0, import_react3.useState)(null), [nextPaneElement, setNextPaneElement] = (0, import_react3.useState)(null), referenceInputOptionsContext = (0, import_react3.useContext)(ReferenceInputOptionsContext);
  let t1;
  ...
  let t3;
  $[5] !== documentId || $[6] !== mode || $[7] !== state2 ? (t3 = mode === "version" && (0, import_jsx_runtime3.jsx)(VersionModeHeader, { documentId, state: state2 }), $[5] = documentId, $[6] = mode, $[7] = state2, $[8] = t3) : t3 = $[8];
  let t4;
  $[9] !== documents || $[10] !== nextPaneElement || $[11] !== previousPaneElement || $[12] !== state2 || $[13] !== syncChannel ? (t4 = state2 === "ready" && (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
    (0, import_jsx_runtime3.jsx)(DiffViewPane, { documentType: documents.previous.type, documentId: documents.previous.id, role: "previous", ref: setPreviousPaneElement, scrollElement: previousPaneElement, syncChannel, compareDocument: documents.previous }),
    (0, import_jsx_runtime3.jsx)(DiffViewPane, { documentType: documents.next.type, documentId: documents.next.id, role: "next", ref: setNextPaneElement, scrollElement: nextPaneElement, syncChannel, compareDocument: documents.previous })
  ] }), $[9] = documents, $[10] = nextPaneElement, $[11] = previousPaneElement, $[12] = state2, $[13] = syncChannel, $[14] = t4) : t4 = $[14];
  let t5;
  $[15] !== t3 || $[16] !== t4 ? (t5 = (0, import_jsx_runtime3.jsxs)(DialogLayout, { children: [
    t3,
    t4
  ] }), $[15] = t3, $[16] = t4, $[17] = t5) : t5 = $[17];
  let t6;
  $[18] !== exitDiffView || $[19] !== t5 ? (t6 = (0, import_jsx_runtime3.jsx)(Dialog2, { id: "diffView", width: "auto", onClose: exitDiffView, padding: false, __unstable_hideCloseButton: true, children: t5 }), $[18] = exitDiffView, $[19] = t5, $[20] = t6) : t6 = $[20];
  let t7;
  return $[21] !== diffViewReferenceInputOptionsContext || $[22] !== t6 ? (t7 = (0, import_jsx_runtime3.jsx)(ReferenceInputOptionsContext.Provider, { value: diffViewReferenceInputOptionsContext, children: t6 }), $[21] = diffViewReferenceInputOptionsContext, $[22] = t6, $[23] = t7) : t7 = $[23], t7;
};
var DiffViewDocumentLayout = (t0) => {
  ...
  $[0] !== t2 || $[1] !== toast ? (t1 = {
    onParamsError: (errors) => {
      toast.push({
        ...
        description: (0, import_jsx_runtime3.jsx)("ul", { children: errors.map((t222) => {
          const [error, input] = t222;
          return (0, import_jsx_runtime3.jsx)("li", { children: t2(`compare-version.error.${error}`, {
            input
          }) }, error);
        }) })
      });
  ...
  let t22;
  $[3] !== documentId || $[4] !== isActive ? (t22 = isActive && (0, import_jsx_runtime3.jsx)(DiffView, { documentId }), $[3] = documentId, $[4] = isActive, $[5] = t22) : t22 = $[5];
  let t3;
  return $[6] !== children || $[7] !== t22 ? (t3 = (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
    children,
    t22
...
function usePaneLayout() {
  const pane2 = (0, import_react3.useContext)(PaneLayoutContext);
  if (!pane2)
...
function PaneDivider(t0) {
  const $ = (0, import_compiler_runtime2.c)(7), {
    ...
    resize
  } = usePaneLayout(), [dragging, setDragging] = (0, import_react3.useState)(false);
  let t1;
  ...
  let t4;
  return $[3] !== handleMouseDown || $[4] !== t2 || $[5] !== t3 ? (t4 = (0, import_jsx_runtime3.jsx)(Root$9, { "data-disabled": t2, "data-dragging": t3, onMouseDown: handleMouseDown }), $[3] = handleMouseDown, $[4] = t2, $[5] = t3, $[6] = t4) : t4 = $[6], t4;
}
var Root$8 = at(Card)`
  outline: none;
...
`;
var Pane = (0, import_react3.forwardRef)(function(props, forwardedRef) {
  const $ = (0, import_compiler_runtime2.c)(86);
  let children, currentMaxWidthProp, currentMinWidthProp, id2, maxWidthProp, minWidthProp, restProps, t0, t1;
  $[0] !== props ? ({
    children,
    ...
    selected: t1,
    ...restProps
  } = props, $[0] = props, $[1] = children, $[2] = currentMaxWidthProp, $[3] = currentMinWidthProp, $[4] = id2, $[5] = maxWidthProp, $[6] = minWidthProp, $[7] = restProps, $[8] = t0, $[9] = t1) : (children = $[1], currentMaxWidthProp = $[2], currentMinWidthProp = $[3], id2 = $[4], maxWidthProp = $[5], minWidthProp = $[6], restProps = $[7], t0 = $[8], t1 = $[9]);
  const flexProp = t0 === void 0 ? 1 : t0, selected = t1 === void 0 ? false : t1, [rootElement, setRootElement] = (0, import_react3.useState)(null), {
    collapse,
  ...
  if ($[10] !== panes || $[11] !== rootElement) {
    ...
    pane2 = $[12], t2 = $[13];
  const paneIndex = t2, nextPane = typeof paneIndex == "number" ? panes[paneIndex + 1] : void 0, isLast = paneIndex === panes.length - 1, expanded = expandedElement === rootElement, collapsed = layoutCollapsed ? false : pane2?.collapsed || false, nextCollapsed = nextPane?.collapsed || false, ref = (0, import_react3.useRef)(null), flex = pane2?.flex ?? flexProp, currentMinWidth = pane2?.currentMinWidth ?? currentMinWidthProp, currentMaxWidth = pane2?.currentMaxWidth ?? currentMaxWidthProp;
  let t3;
  $[16] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t3 = () => ref.current, $[16] = t3) : t3 = $[16], (0, import_react3.useImperativeHandle)(forwardedRef, t3);
  let t4;
  ...
  const setRef = t4;
  let t5, t6;
  $[18] !== currentMaxWidthProp || $[19] !== currentMinWidthProp || $[20] !== flexProp || $[21] !== id2 || $[22] !== maxWidthProp || $[23] !== minWidthProp || $[24] !== mount || $[25] !== rootElement ? (t5 = () => {
    if (rootElement)
  ...
  }, t6 = [currentMinWidthProp, currentMaxWidthProp, flexProp, id2, minWidthProp, maxWidthProp, mount, rootElement], $[18] = currentMaxWidthProp, $[19] = currentMinWidthProp, $[20] = flexProp, $[21] = id2, $[22] = maxWidthProp, $[23] = minWidthProp, $[24] = mount, $[25] = rootElement, $[26] = t5, $[27] = t6) : (t5 = $[26], t6 = $[27]), (0, import_react3.useLayoutEffect)(t5, t6);
  let t7;
  ...
  let t20;
  $[60] !== children || $[61] !== hidden ? (t20 = !hidden && (0, import_jsx_runtime3.jsx)(Flex, { direction: "column", height: "fill", children }), $[60] = children, $[61] = hidden, $[62] = t20) : t20 = $[62];
  let t21;
  $[63] !== rootElement || $[64] !== t20 ? (t21 = (0, import_jsx_runtime3.jsx)(BoundaryElementProvider, { element: rootElement, children: t20 }), $[63] = rootElement, $[64] = t20, $[65] = t21) : t21 = $[65];
  let t22;
  $[66] !== hidden || $[67] !== id2 || $[68] !== paneIndex || $[69] !== restProps || $[70] !== style || $[71] !== t16 || $[72] !== t17 || $[73] !== t18 || $[74] !== t19 || $[75] !== t21 ? (t22 = (0, import_jsx_runtime3.jsxs)(Root$8, { "data-testid": "pane", "data-ui": "Pane", tone: "inherit", hidden, id: id2, overflow: t16, ...restProps, "data-pane-collapsed": t17, "data-pane-index": paneIndex, "data-pane-selected": t18, ref: setRef, style, children: [
    t19,
    t21
  ] }), $[66] = hidden, $[67] = id2, $[68] = paneIndex, $[69] = restProps, $[70] = style, $[71] = t16, $[72] = t17, $[73] = t18, $[74] = t19, $[75] = t21, $[76] = t22) : t22 = $[76];
  let t23;
  $[77] !== isLast || $[78] !== t22 ? (t23 = (0, import_jsx_runtime3.jsx)(IsLastPaneProvider, { isLastPane: isLast, children: t22 }), $[77] = isLast, $[78] = t22, $[79] = t23) : t23 = $[79];
  let t24;
  $[80] !== contextValue || $[81] !== t23 ? (t24 = (0, import_jsx_runtime3.jsx)(LegacyLayerProvider, { zOffset: "pane", children: (0, import_jsx_runtime3.jsx)(PaneContext.Provider, { value: contextValue, children: t23 }) }), $[80] = contextValue, $[81] = t23, $[82] = t24) : t24 = $[82];
  let t25;
  return $[83] !== divider || $[84] !== t24 ? (t25 = (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
    t24,
    divider
...
function usePane() {
  const pane2 = (0, import_react3.useContext)(PaneContext);
  if (!pane2)
    throw new Error("Pane: missing context value");
  return pane2;
}
var PaneContent = (0, import_react3.forwardRef)(function(props, ref) {
  ...
  let t1;
  return $[6] !== as || $[7] !== children || $[8] !== collapsed || $[9] !== padding || $[10] !== ref || $[11] !== restProps || $[12] !== t0 ? (t1 = (0, import_jsx_runtime3.jsx)(Root$7, { "data-testid": "pane-content", forwardedAs: as, ...restProps, flex: 1, hidden: collapsed, overflow: t0, padding, ref, tone: "inherit", children }), $[6] = as, $[7] = children, $[8] = collapsed, $[9] = padding, $[10] = ref, $[11] = restProps, $[12] = t0, $[13] = t1) : t1 = $[13], t1;
});
...
function PaneMenuButtonItem(props) {
  ...
  if (node.type === "divider") {
    let t02;
    return $[0] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t02 = (0, import_jsx_runtime3.jsx)(MenuDivider, {}), $[0] = t02) : t02 = $[0], t02;
  }
  let t0;
  ...
  if (node.type === "group") {
    ...
    if (node.expanded) {
      let t13;
      $[4] !== isAfterGroup ? (t13 = isAfterGroup && (0, import_jsx_runtime3.jsx)(MenuDivider, {}), $[4] = isAfterGroup, $[5] = t13) : t13 = $[5];
      let t23;
      $[6] !== disabled || $[7] !== node.children || $[8] !== node.disabled ? (t23 = node.children.map((child, childIndex) => (0, import_jsx_runtime3.jsx)(PaneMenuButtonItem, { disabled: disabled || !!node.disabled, isAfterGroup: node.children[childIndex - 1]?.type === "group", node: child }, child.key)), $[6] = disabled, $[7] = node.children, $[8] = node.disabled, $[9] = t23) : t23 = $[9];
      let t33;
      return $[10] !== t13 || $[11] !== t23 ? (t33 = (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
        t13,
        t23
      ] }), $[10] = t13, $[11] = t23, $[12] = t33) : t33 = $[12], t33;
    }
    let t12;
    $[13] !== isAfterGroup ? (t12 = isAfterGroup && (0, import_jsx_runtime3.jsx)(MenuDivider, {}), $[13] = isAfterGroup, $[14] = t12) : t12 = $[14];
    const t22 = node.icon;
    let t32;
    $[15] !== disabled || $[16] !== node.children || $[17] !== node.disabled ? (t32 = node.children.map((child_0, childIndex_0) => (0, import_jsx_runtime3.jsx)(PaneMenuButtonItem, { disabled: disabled || !!node.disabled, isAfterGroup: node.children[childIndex_0 - 1]?.type === "group", node: child_0 }, child_0.key)), $[15] = disabled, $[16] = node.children, $[17] = node.disabled, $[18] = t32) : t32 = $[18];
    let t4;
    $[19] !== disabled || $[20] !== node.icon || $[21] !== t32 || $[22] !== title ? (t4 = (0, import_jsx_runtime3.jsx)(MenuGroup, { disabled, icon: t22, popover: MENU_GROUP_POPOVER_PROPS, text: title, children: t32 }), $[19] = disabled, $[20] = node.icon, $[21] = t32, $[22] = title, $[23] = t4) : t4 = $[23];
    let t5;
    return $[24] !== t12 || $[25] !== t4 ? (t5 = (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
      t12,
      t4
    ] }), $[24] = t12, $[25] = t4, $[26] = t5) : t5 = $[26], t5;
  }
  let t1;
  $[27] !== isAfterGroup ? (t1 = isAfterGroup && (0, import_jsx_runtime3.jsx)(MenuDivider, {}), $[27] = isAfterGroup, $[28] = t1) : t1 = $[28];
  let t2;
  $[29] !== disabled || $[30] !== node ? (t2 = (0, import_jsx_runtime3.jsx)(PaneContextMenuItemResolver, { disabled, node }), $[29] = disabled, $[30] = node, $[31] = t2) : t2 = $[31];
  let t3;
  return $[32] !== t1 || $[33] !== t2 ? (t3 = (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
    t1,
    t2
...
function PaneContextMenuItemResolver(props) {
  ...
  if (node.intent) {
    let t02;
    return $[0] !== node.intent || $[1] !== props ? (t02 = (0, import_jsx_runtime3.jsx)(PaneContextIntentMenuItem, { ...props, intent: node.intent }), $[0] = node.intent, $[1] = props, $[2] = t02) : t02 = $[2], t02;
  }
  let t0;
  return $[3] !== props ? (t0 = (0, import_jsx_runtime3.jsx)(PaneContextMenuItem, { ...props }), $[3] = props, $[4] = t0) : t0 = $[4], t0;
}
function PaneContextMenuItem(props) {
  ...
  let t0;
  $[0] !== node.disabled ? (t0 = typeof node.disabled == "object" && (0, import_jsx_runtime3.jsx)(Text, { size: 1, children: node.disabled.reason }), $[0] = node.disabled, $[1] = t0) : t0 = $[1];
  ...
  const t9 = `action-${t8}`;
  let t10;
  $[6] !== node.icon || $[7] !== node.onAction || $[8] !== node.selected || $[9] !== node.tone || $[10] !== t1 || $[11] !== t2 || $[12] !== t4 || $[13] !== t9 || $[14] !== title ? (t10 = (0, import_jsx_runtime3.jsx)(MenuItem2, { disabled: t1, hotkeys: t2, icon: t3, iconRight: t4, onClick: t5, pressed: t6, text: title, tone: t7, "data-testid": t9 }), $[6] = node.icon, $[7] = node.onAction, $[8] = node.selected, $[9] = node.tone, $[10] = t1, $[11] = t2, $[12] = t4, $[13] = t9, $[14] = title, $[15] = t10) : t10 = $[15];
  let t11;
  return $[16] !== t10 || $[17] !== tooltipContent ? (t11 = (0, import_jsx_runtime3.jsx)(TooltipOfDisabled, { content: tooltipContent, placement: "left", children: t10 }), $[16] = t10, $[17] = tooltipContent, $[18] = t11) : t11 = $[18], t11;
}
function PaneContextIntentMenuItem(props) {
  ...
  let t6;
  $[10] !== handleClick || $[11] !== intentLink.href || $[12] !== node.icon || $[13] !== node.selected || $[14] !== node.tone || $[15] !== t3 || $[16] !== t4 || $[17] !== t5 || $[18] !== title ? (t6 = (0, import_jsx_runtime3.jsx)(MenuItem2, { as: "a", disabled: t3, hotkeys: t4, href: intentLink.href, icon: node.icon, iconRight: t5, onClick: handleClick, pressed: node.selected, text: title, tone: node.tone }), $[10] = handleClick, $[11] = intentLink.href, $[12] = node.icon, $[13] = node.selected, $[14] = node.tone, $[15] = t3, $[16] = t4, $[17] = t5, $[18] = title, $[19] = t6) : t6 = $[19];
  let t7;
  return $[20] !== t6 || $[21] !== tooltipContent ? (t7 = (0, import_jsx_runtime3.jsx)(TooltipOfDisabled, { content: tooltipContent, placement: "left", children: t6 }), $[20] = t6, $[21] = tooltipContent, $[22] = t7) : t7 = $[22], t7;
}
...
function PaneContextMenuButton(props) {
  const $ = (0, import_compiler_runtime2.c)(13), {
    nodes,
    actionsNodes
  } = props, id2 = (0, import_react3.useId)(), hasCritical = nodesHasTone(nodes, "critical"), hasCaution = nodesHasTone(nodes, "caution"), t0 = hasCritical ? "critical" : hasCaution ? "caution" : void 0;
  let t1;
  $[0] !== t0 ? (t1 = (0, import_jsx_runtime3.jsx)(ContextMenuButton, { tone: t0, "data-testid": "pane-context-menu-button" }), $[0] = t0, $[1] = t1) : t1 = $[1];
  let t2;
  $[2] !== actionsNodes ? (t2 = actionsNodes && (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
    actionsNodes,
    (0, import_jsx_runtime3.jsx)(MenuDivider, {})
  ] }), $[2] = actionsNodes, $[3] = t2) : t2 = $[3];
  let t3;
  $[4] !== nodes ? (t3 = nodes.map((node, nodeIndex) => {
    const isAfterGroup = nodes[nodeIndex - 1]?.type === "group";
    return (0, import_jsx_runtime3.jsx)(PaneMenuButtonItem, { isAfterGroup, node }, node.key);
  }), $[4] = nodes, $[5] = t3) : t3 = $[5];
  let t4;
  $[6] !== t2 || $[7] !== t3 ? (t4 = (0, import_jsx_runtime3.jsxs)(Menu, { children: [
    t2,
    t3
  ] }), $[6] = t2, $[7] = t3, $[8] = t4) : t4 = $[8];
  let t5;
  return $[9] !== id2 || $[10] !== t1 || $[11] !== t4 ? (t5 = (0, import_jsx_runtime3.jsx)(MenuButton, { button: t1, id: id2, menu: t4, popover: CONTEXT_MENU_POPOVER_PROPS }), $[9] = id2, $[10] = t1, $[11] = t4, $[12] = t5) : t5 = $[12], t5;
}
var Root$6 = at(Layer)`
  position: sticky;
  bottom: 0;
`;
var RootCard = at(Card)`
  padding-bottom: env(safe-area-inset-bottom);
`;
var PaneFooter = (0, import_react3.forwardRef)(function(props, ref) {
  const $ = (0, import_compiler_runtime2.c)(7), {
    children,
    padding
  } = props, {
  ...
  let t0;
  $[0] !== children || $[1] !== padding ? (t0 = (0, import_jsx_runtime3.jsx)(RootCard, { tone: "inherit", children: (0, import_jsx_runtime3.jsx)(Box, { padding, children }) }), $[0] = children, $[1] = padding, $[2] = t0) : t0 = $[2];
  let t1;
  return $[3] !== collapsed || $[4] !== ref || $[5] !== t0 ? (t1 = (0, import_jsx_runtime3.jsx)(LegacyLayerProvider, { zOffset: "paneFooter", children: (0, import_jsx_runtime3.jsx)(Root$6, { "data-testid": "pane-footer", hidden: collapsed, ref, children: t0 }) }), $[3] = collapsed, $[4] = ref, $[5] = t0, $[6] = t1) : t1 = $[6], t1;
});
var Root$5 = at(Layer)(({
  $border
}) => rt`
...
var TitleTextSkeleton = at(TextSkeleton)`
  width: 66%;
  max-width: 175px;
`;
var TitleText = at(Text)`
  cursor: default;
  outline: none;
`;
var PaneHeader$1 = (0, import_react3.forwardRef)(function(props, ref) {
  const $ = (0, import_compiler_runtime2.c)(48), {
    actions,
    backButton,
    border,
  ...
  let t6;
  $[8] !== backButton ? (t6 = backButton && (0, import_jsx_runtime3.jsx)(Box, { flex: "none", children: backButton }), $[8] = backButton, $[9] = t6) : t6 = $[9];
  const t7 = backButton ? 1 : 2;
  let t8;
  $[10] !== loading ? (t8 = loading && (0, import_jsx_runtime3.jsx)(Box, { children: (0, import_jsx_runtime3.jsx)(TitleTextSkeleton, { animated: true, radius: 1, size: 1 }) }), $[10] = loading, $[11] = t8) : t8 = $[11];
  let t9;
  $[12] !== appendTitle || $[13] !== loading || $[14] !== title ? (t9 = !loading && (0, import_jsx_runtime3.jsxs)(Flex, { align: "center", gap: 1, children: [
    (0, import_jsx_runtime3.jsx)(TitleText, { size: 1, textOverflow: "ellipsis", weight: "semibold", children: title }),
    appendTitle
  ] }), $[12] = appendTitle, $[13] = loading, $[14] = title, $[15] = t9) : t9 = $[15];
  let t10;
  $[16] !== handleTitleClick || $[17] !== t7 || $[18] !== t8 || $[19] !== t9 || $[20] !== tabIndex ? (t10 = (0, import_jsx_runtime3.jsxs)(TitleCard, { __unstable_focusRing: true, flex: 1, onClick: handleTitleClick, paddingLeft: t7, padding: 2, tabIndex, children: [
    t8,
    t9
  ] }), $[16] = handleTitleClick, $[17] = t7, $[18] = t8, $[19] = t9, $[20] = tabIndex, $[21] = t10) : t10 = $[21];
  let t11;
  $[22] !== actions || $[23] !== collapsed ? (t11 = actions && (0, import_jsx_runtime3.jsx)(Box, { hidden: collapsed, children: (0, import_jsx_runtime3.jsx)(LegacyLayerProvider, { zOffset: "paneHeader", children: actions }) }), $[22] = actions, $[23] = collapsed, $[24] = t11) : t11 = $[24];
  let t12;
  $[25] !== t10 || $[26] !== t11 || $[27] !== t6 ? (t12 = (0, import_jsx_runtime3.jsxs)(Flex, { align: "flex-start", gap: 3, children: [
    t6,
    t10,
    t11
  ] }), $[25] = t10, $[26] = t11, $[27] = t6, $[28] = t12) : t12 = $[28];
  let t13;
  $[29] !== collapsed || $[30] !== showTabsOrSubActions || $[31] !== subActions || $[32] !== tabs ? (t13 = showTabsOrSubActions && (0, import_jsx_runtime3.jsxs)(Flex, { align: "center", hidden: collapsed, overflow: "auto", children: [
    (0, import_jsx_runtime3.jsx)(Box, { flex: 1, marginRight: subActions ? 3 : 0, children: tabs }),
    subActions
  ] }), $[29] = collapsed, $[30] = showTabsOrSubActions, $[31] = subActions, $[32] = tabs, $[33] = t13) : t13 = $[33];
  let t14;
  $[34] !== handleLayoutClick || $[35] !== layoutStyle || $[36] !== t12 || $[37] !== t13 ? (t14 = (0, import_jsx_runtime3.jsxs)(Layout, { direction: "column", gap: 3, onClick: handleLayoutClick, padding: 3, sizing: "border", style: layoutStyle, children: [
    t12,
    t13
  ] }), $[34] = handleLayoutClick, $[35] = layoutStyle, $[36] = t12, $[37] = t13, $[38] = t14) : t14 = $[38];
  const t15 = !collapsed && contentAfter;
  let t16;
  $[39] !== t14 || $[40] !== t15 || $[41] !== t5 ? (t16 = (0, import_jsx_runtime3.jsx)(LegacyLayerProvider, { zOffset: "paneHeader", children: (0, import_jsx_runtime3.jsxs)(Card, { "data-collapsed": t5, tone: "inherit", children: [
    t14,
    t15
  ] }) }), $[39] = t14, $[40] = t15, $[41] = t5, $[42] = t16) : t16 = $[42];
  let t17;
  return $[43] !== border || $[44] !== ref || $[45] !== t16 || $[46] !== t4 ? (t17 = (0, import_jsx_runtime3.jsx)(LayerProvider, { zOffset: 100, children: (0, import_jsx_runtime3.jsx)(Root$5, { $border: border, "data-collapsed": t4, "data-testid": "pane-header", ref, children: t16 }) }), $[43] = border, $[44] = ref, $[45] = t16, $[46] = t4, $[47] = t17) : t17 = $[47], t17;
});
...
function PaneHeaderActionButton(props) {
  ...
  if (node.type === "item") {
    let t0;
    return $[0] !== node ? (t0 = (0, import_jsx_runtime3.jsx)(PaneHeaderMenuItemActionButton, { node }), $[0] = node, $[1] = t0) : t0 = $[1], t0;
  }
  if (node.type === "group") {
    let t0;
    return $[2] !== node ? (t0 = (0, import_jsx_runtime3.jsx)(PaneHeaderMenuGroupActionButton, { node }), $[2] = node, $[3] = t0) : t0 = $[3], t0;
  }
...
function PaneHeaderMenuItemActionButton(props) {
  ...
  if (node.intent) {
    let t02;
    return $[0] !== node.intent || $[1] !== props ? (t02 = (0, import_jsx_runtime3.jsx)(PaneHeaderActionIntentButton, { ...props, intent: node.intent }), $[0] = node.intent, $[1] = props, $[2] = t02) : t02 = $[2], t02;
  }
  let t0;
  ...
  let t5;
  return $[15] !== isDisabled || $[16] !== node.icon || $[17] !== node.onAction || $[18] !== node.selected || $[19] !== node.tone || $[20] !== t1 || $[21] !== t4 ? (t5 = (0, import_jsx_runtime3.jsx)(StatusButton, { disabled: isDisabled, icon: node.icon, onClick: node.onAction, selected: node.selected, tone: node.tone, "aria-label": t1, tooltipProps: t4 }), $[15] = isDisabled, $[16] = node.icon, $[17] = node.onAction, $[18] = node.selected, $[19] = node.tone, $[20] = t1, $[21] = t4, $[22] = t5) : t5 = $[22], t5;
}
function PaneHeaderActionIntentButton(props) {
  ...
  let t7;
  return $[18] !== handleClick || $[19] !== intentLink.href || $[20] !== isDisabled || $[21] !== node.icon || $[22] !== node.selected || $[23] !== node.tone || $[24] !== t3 || $[25] !== t6 ? (t7 = (0, import_jsx_runtime3.jsx)(StatusButton, { forwardedAs: "a", disabled: isDisabled, href: intentLink.href, icon: node.icon, onClick: handleClick, selected: node.selected, tone: node.tone, "aria-label": t3, tooltipProps: t6 }), $[18] = handleClick, $[19] = intentLink.href, $[20] = isDisabled, $[21] = node.icon, $[22] = node.selected, $[23] = node.tone, $[24] = t3, $[25] = t6, $[26] = t7) : t7 = $[26], t7;
}
function PaneHeaderMenuGroupActionButton(props) {
  ...
  let t3;
  $[2] !== t0 || $[3] !== t1 || $[4] !== t2 || $[5] !== title ? (t3 = (0, import_jsx_runtime3.jsx)(Button2, { disabled: t0, icon: t1, label: title, mode: "bleed", tooltipProps: t2 }), $[2] = t0, $[3] = t1, $[4] = t2, $[5] = title, $[6] = t3) : t3 = $[6];
  const t4 = (0, import_react3.useId)();
  let t5;
  $[7] !== node.children || $[8] !== node.disabled ? (t5 = node.children.map((child, idx) => (0, import_jsx_runtime3.jsx)(PaneMenuButtonItem, { disabled: !!node.disabled, isAfterGroup: node.children[idx - 1]?.type === "group", node: child }, child.key)), $[7] = node.children, $[8] = node.disabled, $[9] = t5) : t5 = $[9];
  let t6;
  $[10] !== t5 ? (t6 = (0, import_jsx_runtime3.jsx)(Menu, { children: t5 }), $[10] = t5, $[11] = t6) : t6 = $[11];
  let t7;
  return $[12] !== t3 || $[13] !== t4 || $[14] !== t6 ? (t7 = (0, import_jsx_runtime3.jsx)(MenuButton, { button: t3, id: t4, menu: t6 }), $[12] = t3, $[13] = t4, $[14] = t6, $[15] = t7) : t7 = $[15], t7;
}
var Root$4 = at(Card)`
...
function createPaneLayoutController() {
  ...
  function resize(type2, leftElement, deltaX) {
    ...
    if (rightOptions) {
      if (type2 === "start" && (resizing = true, cache.left = {
        element: leftElement,
      ...
      }, _notifyObservers()), type2 === "move" && cache.left && cache.right) {
...
function PaneLayout(props) {
  ...
  const [controller] = (0, import_react3.useState)(_temp$F), [rootElement, setRootElement] = (0, import_react3.useState)(null), width = useElementRect(rootElement)?.width || 0, collapsed = width === void 0 || !minWidth ? void 0 : width < minWidth;
  let t0;
  ...
  const [state2, setState] = (0, import_react3.useState)(t0);
  let t1, t2;
  $[7] !== controller || $[8] !== rootElement ? (t1 = () => controller.setRootElement(rootElement), t2 = [controller, rootElement], $[7] = controller, $[8] = rootElement, $[9] = t1, $[10] = t2) : (t1 = $[9], t2 = $[10]), (0, import_react3.useEffect)(t1, t2);
  let t3, t4;
  $[11] !== controller || $[12] !== width ? (t3 = () => controller.setRootWidth(width), t4 = [controller, width], $[11] = controller, $[12] = width, $[13] = t3, $[14] = t4) : (t3 = $[13], t4 = $[14]), (0, import_react3.useEffect)(t3, t4);
  let t5, t6;
  $[15] !== controller ? (t5 = () => controller.subscribe(setState), t6 = [controller], $[15] = controller, $[16] = t5, $[17] = t6) : (t5 = $[16], t6 = $[17]), (0, import_react3.useEffect)(t5, t6);
  let t7, t8;
  $[18] !== collapsed || $[19] !== onCollapse || $[20] !== onExpand ? (t7 = () => {
    collapsed !== void 0 && (collapsed && onCollapse && onCollapse(), !collapsed && onExpand && onExpand());
  }, t8 = [collapsed, onCollapse, onExpand], $[18] = collapsed, $[19] = onCollapse, $[20] = onExpand, $[21] = t7, $[22] = t8) : (t7 = $[21], t8 = $[22]), (0, import_react3.useEffect)(t7, t8);
  let t9;
  ...
  let t13;
  $[32] !== children || $[33] !== restProps || $[34] !== t10 || $[35] !== t11 || $[36] !== t12 ? (t13 = (0, import_jsx_runtime3.jsx)(Root$4, { "data-ui": "PaneLayout", ...restProps, "data-collapsed": t10, "data-resizing": t11, "data-mounted": t12, ref: setRootElement, children }), $[32] = children, $[33] = restProps, $[34] = t10, $[35] = t11, $[36] = t12, $[37] = t13) : t13 = $[37];
  let t14;
  return $[38] !== paneLayout || $[39] !== t13 ? (t14 = (0, import_jsx_runtime3.jsx)(PaneLayoutContext.Provider, { value: paneLayout, children: t13 }), $[38] = paneLayout, $[39] = t13, $[40] = t14) : t14 = $[40], t14;
}
function _temp$F() {
...
function ErrorPane(props) {
  ...
  let t2;
  $[0] !== title ? (t2 = (0, import_jsx_runtime3.jsx)(PaneHeader$1, { title }), $[0] = title, $[1] = t2) : t2 = $[1];
  let t3;
  $[2] !== children ? (t3 = (0, import_jsx_runtime3.jsx)(PaneContent, { overflow: "auto", children: (0, import_jsx_runtime3.jsx)(Box, { paddingX: 4, paddingY: 5, children }) }), $[2] = children, $[3] = t3) : t3 = $[3];
  let t4;
  return $[4] !== currentMinWidth || $[5] !== flex || $[6] !== minWidth || $[7] !== paneKey || $[8] !== t2 || $[9] !== t3 || $[10] !== tone ? (t4 = (0, import_jsx_runtime3.jsxs)(Pane, { currentMinWidth, flex, id: paneKey, minWidth, tone, children: [
    t2,
    t3
...
function Delay(t0) {
  const $ = (0, import_compiler_runtime2.c)(6), {
    children,
    ms: t1
  } = t0, ms = t1 === void 0 ? 0 : t1, [ready, setReady] = (0, import_react3.useState)(ms <= 0);
  let t2, t3;
  if ($[0] !== ms ? (t2 = () => {
    if (ms <= 0)
      return;
  ...
  }, t3 = [ms], $[0] = ms, $[1] = t2, $[2] = t3) : (t2 = $[1], t3 = $[2]), (0, import_react3.useEffect)(t2, t3), !ready || !children) {
    let t42;
    return $[3] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t42 = (0, import_jsx_runtime3.jsx)(import_jsx_runtime3.Fragment, {}), $[3] = t42) : t42 = $[3], t42;
  }
  let t4;
...
var LoadingPane = (0, import_react3.memo)((props) => {
  ...
  const [currentMessage, setCurrentMessage] = (0, import_react3.useState)(t3);
  let t4, t5;
  ...
  }, t5 = [resolvedMessage, t2], $[6] = resolvedMessage, $[7] = t2, $[8] = t4, $[9] = t5) : (t4 = $[8], t5 = $[9]), (0, import_react3.useEffect)(t4, t5);
  const [contentElement, setContentElement] = (0, import_react3.useState)(null), [mounted, setMounted] = (0, import_react3.useState)(false);
  let t6, t7;
  $[10] !== contentElement ? (t6 = () => {
    if (contentElement)
      return _raf2(() => setMounted(true));
  }, t7 = [contentElement], $[10] = contentElement, $[11] = t6, $[12] = t7) : (t6 = $[11], t7 = $[12]), (0, import_react3.useEffect)(t6, t7);
  const t8 = mounted ? "" : void 0, t9 = title || currentMessage;
  let t10;
  $[13] !== t9 ? (t10 = (0, import_jsx_runtime3.jsx)(LoadingBlock, { showText: true, title: t9 }), $[13] = t9, $[14] = t10) : t10 = $[14];
  let t11;
  $[15] !== t10 || $[16] !== t8 ? (t11 = (0, import_jsx_runtime3.jsx)(Content$2, { align: "center", "data-mounted": t8, direction: "column", height: "fill", justify: "center", ref: setContentElement, children: t10 }), $[15] = t10, $[16] = t8, $[17] = t11) : t11 = $[17];
  const content = t11;
  let t12;
  $[18] !== content || $[19] !== delay2 ? (t12 = (0, import_jsx_runtime3.jsx)(PaneContent, { children: content }), $[18] = content, $[19] = delay2, $[20] = t12) : t12 = $[20];
  let t13;
  return $[21] !== flex || $[22] !== minWidth || $[23] !== paneKey || $[24] !== selected || $[25] !== t12 || $[26] !== tone ? (t13 = (0, import_jsx_runtime3.jsx)(Pane, { flex, id: paneKey, minWidth, selected, tone, children: t12 }), $[21] = flex, $[22] = minWidth, $[23] = paneKey, $[24] = selected, $[25] = t12, $[26] = tone, $[27] = t13) : t13 = $[27], t13;
});
...
function CommentsWrapper(props) {
  ...
  let t0;
  $[0] !== children || $[1] !== documentId || $[2] !== documentType ? (t0 = (0, import_jsx_runtime3.jsx)(CommentsProviderWrapper, { documentId, documentType, children }), $[0] = children, $[1] = documentId, $[2] = documentType, $[3] = t0) : t0 = $[3];
  let t1;
  return $[4] !== documentId || $[5] !== documentType || $[6] !== t0 ? (t1 = (0, import_jsx_runtime3.jsx)(CommentsEnabledProvider, { documentId, documentType, children: t0 }), $[4] = documentId, $[5] = documentType, $[6] = t0, $[7] = t1) : t1 = $[7], t1;
}
function CommentsProviderWrapper(props) {
  const $ = (0, import_compiler_runtime2.c)(26), {
    ...
    resolveIntentLink
  } = useRouter(), selectedCommentId = params?.comment, paramsRef = (0, import_react3.useRef)(params);
  let t0, t1;
  $[0] !== params ? (t0 = () => {
    paramsRef.current = params;
  }, t1 = [params], $[0] = params, $[1] = t0, $[2] = t1) : (t0 = $[1], t1 = $[2]), (0, import_react3.useLayoutEffect)(t0, t1);
  let t2;
  ...
  if (!enabled) {
    let t52;
    return $[12] !== children ? (t52 = (0, import_jsx_runtime3.jsx)(import_jsx_runtime3.Fragment, { children }), $[12] = children, $[13] = t52) : t52 = $[13], t52;
  }
  const t5 = inspector?.name === COMMENTS_INSPECTOR_NAME, t6 = connectionState === "connecting";
  let t7;
  return $[14] !== children || $[15] !== documentId || $[16] !== documentType || $[17] !== getCommentLink || $[18] !== handleClearSelectedComment || $[19] !== handleOpenCommentsInspector || $[20] !== onPathOpen || $[21] !== selectedCommentId || $[22] !== selectedReleaseId || $[23] !== t5 || $[24] !== t6 ? (t7 = (0, import_jsx_runtime3.jsx)(CommentsProvider, { documentId, documentType, getCommentLink, isCommentsOpen: t5, isConnecting: t6, onClearSelectedComment: handleClearSelectedComment, onCommentsOpen: handleOpenCommentsInspector, onPathOpen, selectedCommentId, sortOrder: "desc", type: "field", releaseId: selectedReleaseId, children }), $[14] = children, $[15] = documentId, $[16] = documentType, $[17] = getCommentLink, $[18] = handleClearSelectedComment, $[19] = handleOpenCommentsInspector, $[20] = onPathOpen, $[21] = selectedCommentId, $[22] = selectedReleaseId, $[23] = t5, $[24] = t6, $[25] = t7) : t7 = $[25], t7;
}
function DocumentActionsProvider(props) {
  const $ = (0, import_compiler_runtime2.c)(20), {
    ...
    revisionId
  } = useDocumentPane(), onCompleteRef = (0, import_react3.useRef)(null);
  let t0;
  if ($[0] !== activeReleases || $[1] !== editState?.release) {
    let t12;
    $[3] !== editState?.release ? (t12 = (candidate) => candidate === editState?.release, $[3] = editState?.release, $[4] = t12) : t12 = $[4], t0 = activeReleases.map(_temp$E).find(t12), $[0] = activeReleases, $[1] = editState?.release, $[2] = t0;
  } else
    t0 = $[2];
  ...
  $[13] !== actionProps || $[14] !== children ? (t5 = (t62) => {
    ...
    return (0, import_jsx_runtime3.jsx)(ActionsGuardWrapper, { states, actionProps, children });
  }, $[13] = actionProps, $[14] = children, $[15] = t5) : t5 = $[15];
  let t6;
  return $[16] !== t3 || $[17] !== t4 || $[18] !== t5 ? (t6 = (0, import_jsx_runtime3.jsx)(GetHookCollectionState, { args: t3, hooks: t4, resetRef: onCompleteRef, children: t5 }), $[16] = t3, $[17] = t4, $[18] = t5, $[19] = t6) : t6 = $[19], t6;
}
function _temp$E(r2) {
...
function ActionsGuardWrapper(props) {
  ...
  let t22;
  return $[6] !== children || $[7] !== t1 ? (t22 = (0, import_jsx_runtime3.jsx)(DocumentActionsStateContext.Provider, { value: t1, children }), $[6] = children, $[7] = t1, $[8] = t22) : t22 = $[8], t22;
}
...
function DocumentInspectorMenuItemsResolver(props) {
  ...
  const [menuItems, setMenuItems] = (0, import_react3.useState)(t0);
  let t1, t2;
  ...
  }, t2 = [len, menuItems], $[2] = len, $[3] = menuItems, $[4] = t1, $[5] = t2) : (t1 = $[4], t2 = $[5]), (0, import_react3.useEffect)(t1, t2);
  let t3;
  ...
  }, t5 = [menuItems, onMenuItems], $[7] = menuItems, $[8] = onMenuItems, $[9] = t4, $[10] = t5) : (t4 = $[9], t5 = $[10]), (0, import_react3.useEffect)(t4, t5);
  let t6;
  if ($[11] !== documentId || $[12] !== documentType || $[13] !== inspectors2) {
    ...
    }), inspector.name] : [_temp$D, ""], $[15] = documentId, $[16] = documentType, $[17] = t72) : t72 = $[17], t6 = inspectors2.map(t72), $[11] = documentId, $[12] = documentType, $[13] = inspectors2, $[14] = t6;
  } else
    t6 = $[14];
  ...
  let t8;
  return $[20] !== t7 ? (t8 = (0, import_jsx_runtime3.jsx)(import_jsx_runtime3.Fragment, { children: t7 }), $[20] = t7, $[21] = t8) : t8 = $[21], t8;
}
function _temp2$h(t0) {
  const [InspectorMenuItem, key] = t0;
  return key && (0, import_jsx_runtime3.jsx)(InspectorMenuItem, {}, key);
}
function _temp$D() {
  return null;
}
...
function defineInspectorMenuItemComponent({
  ...
  return (0, import_react3.memo)(function() {
    const $ = (0, import_compiler_runtime2.c)(4);
    let t0;
    ...
    }, t2 = [node], $[1] = node, $[2] = t1, $[3] = t2) : (t1 = $[2], t2 = $[3]), (0, import_react3.useEffect)(t1, t2), null;
  });
}
...
var DocumentOperationResults = (0, import_react3.memo)(function() {
  const $ = (0, import_compiler_runtime2.c)(13), {
    push: pushToast
  } = useToast(), {
    documentId,
  ...
  } = useDocumentPane(), documentTitleInfo = useDocumentTitle(), titleError = documentTitleInfo.error, event = useDocumentOperationEvent(documentId, documentType), prevEvent = (0, import_react3.useRef)(event), paneRouter = usePaneRouter(), {
    t: t2
  } = useTranslation(structureLocaleNamespace), {
    handleOpenDialog
  } = useDocumentLimitsUpsellContext();
  ...
  return $[5] !== documentTitle || $[6] !== event || $[7] !== handleOpenDialog || $[8] !== paneRouter || $[9] !== pushToast || $[10] !== t2 ? (t3 = () => {
    ...
    if (event.type === "error") {
      ...
      pushToast({
        ...
        description: (0, import_jsx_runtime3.jsxs)("details", { children: [
          (0, import_jsx_runtime3.jsx)("summary", { children: t2("panes.document-operation-results.error.summary.title") }),
          event.error.message
        ] })
      });
    }
    return event.type === "success" && !IGNORE_OPS.includes(event.op) && pushToast({
      closable: true,
      status: "success",
      title: (0, import_jsx_runtime3.jsx)(Translate, { context: event.op, i18nKey: "panes.document-operation-results.operation-success", t: t2, values: {
        op: event.op,
        title: documentTitle
      }, components: {
        Strong: "strong"
  ...
  }, t4 = [event, paneRouter, pushToast, t2, documentTitle, handleOpenDialog], $[5] = documentTitle, $[6] = event, $[7] = handleOpenDialog, $[8] = paneRouter, $[9] = pushToast, $[10] = t2, $[11] = t3, $[12] = t4) : (t3 = $[11], t4 = $[12]), (0, import_react3.useEffect)(t3, t4), null;
});
...
function DocumentInspectorHeader(props) {
  ...
  let t0;
  $[7] !== title ? (t0 = (0, import_jsx_runtime3.jsx)(Box, { flex: 1, padding: 3, children: (0, import_jsx_runtime3.jsx)(Text, { as: "h1", size: 1, weight: "medium", children: title }) }), $[7] = title, $[8] = t0) : t0 = $[8];
  let t1;
  ...
  let t3;
  $[13] !== closeButtonLabel || $[14] !== onClose || $[15] !== t22 ? (t3 = (0, import_jsx_runtime3.jsx)(Box, { flex: "none", padding: 1, children: (0, import_jsx_runtime3.jsx)(Button2, { "aria-label": closeButtonLabel, icon: CloseIcon, mode: "bleed", onClick: onClose, tooltipProps: t22 }) }), $[13] = closeButtonLabel, $[14] = onClose, $[15] = t22, $[16] = t3) : t3 = $[16];
  let t4;
  $[17] !== t0 || $[18] !== t3 ? (t4 = (0, import_jsx_runtime3.jsxs)(Flex, { padding: 2, children: [
    t0,
    t3
  ] }), $[17] = t0, $[18] = t3, $[19] = t4) : t4 = $[19];
  let t5;
  return $[20] !== children || $[21] !== forwardedAs || $[22] !== restProps || $[23] !== t4 ? (t5 = (0, import_jsx_runtime3.jsxs)(Root$3, { ...restProps, as: forwardedAs, children: [
    t4,
    children
...
function DocumentInspectorPanel(props) {
  ...
  if (collapsed || !inspector)
    return null;
  const Component2 = inspector.component;
  let t1;
  $[3] !== Component2 || $[4] !== documentId || $[5] !== documentType || $[6] !== handleClose ? (t1 = (0, import_jsx_runtime3.jsx)(Component2, { onClose: handleClose, documentId, documentType }), $[3] = Component2, $[4] = documentId, $[5] = documentType, $[6] = handleClose, $[7] = t1) : t1 = $[7];
  const element = t1;
  if (features.resizablePanes) {
    let t22;
    return $[8] !== element || $[9] !== flex ? (t22 = (0, import_jsx_runtime3.jsx)(Resizable, { as: "aside", "data-ui": "DocumentInspectorPanel", flex, resizerPosition: "left", maxWidth: DOCUMENT_INSPECTOR_MAX_WIDTH, minWidth: DOCUMENT_INSPECTOR_MIN_WIDTH, children: element }), $[8] = element, $[9] = flex, $[10] = t22) : t22 = $[10], t22;
  }
  let t2;
  return $[11] !== element || $[12] !== flex ? (t2 = (0, import_jsx_runtime3.jsx)(Box, { as: "aside", "data-ui": "DocumentInspectorPanel", flex, children: element }), $[11] = element, $[12] = flex, $[13] = t2) : t2 = $[13], t2;
}
...
var JSONInspectorWrapper = at.div(({
  theme
}) => {
  const {
    color,
...
function Search(props) {
  ...
  const t22 = query || "";
  let t3;
  return $[4] !== handleChange || $[5] !== t1 || $[6] !== t22 ? (t3 = (0, import_jsx_runtime3.jsx)(TextInput, { icon: SearchIcon, onChange: handleChange, placeholder: t1, radius: 2, value: t22 }), $[4] = handleChange, $[5] = t1, $[6] = t22, $[7] = t3) : t3 = $[7], t3;
}
function InspectDialog(props) {
  ...
  let t4;
  $[6] !== t3 || $[7] !== value ? (t4 = isDocumentLike(value) ? (0, import_jsx_runtime3.jsx)(Translate, { t: t3, i18nKey: "document-inspector.dialog.title", components: {
    DocumentTitle: () => (0, import_jsx_runtime3.jsx)("em", { children: (0, import_jsx_runtime3.jsx)(DocTitle, { document: value }) })
  } }) : (0, import_jsx_runtime3.jsx)("em", { children: t3("document-inspector.dialog.title-no-value") }), $[6] = t3, $[7] = value, $[8] = t4) : t4 = $[8];
  let t5;
  ...
  let t10;
  $[12] !== setParsedViewMode || $[13] !== t6 || $[14] !== t7 || $[15] !== t8 || $[16] !== t9 ? (t10 = (0, import_jsx_runtime3.jsx)(Tab, { "aria-controls": t6, id: t7, label: t8, onClick: setParsedViewMode, selected: t9 }), $[12] = setParsedViewMode, $[13] = t6, $[14] = t7, $[15] = t8, $[16] = t9, $[17] = t10) : t10 = $[17];
  ...
  let t15;
  $[20] !== setRawViewMode || $[21] !== t11 || $[22] !== t12 || $[23] !== t13 || $[24] !== t14 ? (t15 = (0, import_jsx_runtime3.jsx)(Tab, { "aria-controls": t11, id: t12, label: t13, onClick: setRawViewMode, selected: t14 }), $[20] = setRawViewMode, $[21] = t11, $[22] = t12, $[23] = t13, $[24] = t14, $[25] = t15) : t15 = $[25];
  let t16;
  $[26] !== t10 || $[27] !== t15 ? (t16 = (0, import_jsx_runtime3.jsx)(Card, { padding: 3, paddingTop: 0, shadow: 1, style: t5, children: (0, import_jsx_runtime3.jsxs)(TabList, { space: 1, children: [
    t10,
    t15
  ...
  let t20;
  $[30] !== value || $[31] !== viewMode ? (t20 = viewMode === VIEW_MODE_PARSED && (0, import_jsx_runtime3.jsx)(JSONInspectorWrapper, { children: (0, import_jsx_runtime3.jsx)(JsonInspector, { data: value, isExpanded, onClick: toggleExpanded, search: Search, filterOptions: {
    ignoreCase: true
  } }) }), $[30] = value, $[31] = viewMode, $[32] = t20) : t20 = $[32];
  let t21;
  $[33] !== value || $[34] !== viewMode ? (t21 = viewMode === VIEW_MODE_RAW && (0, import_jsx_runtime3.jsx)(Code, { language: "json", tabIndex: 0, onKeyDown: maybeSelectAll, onDoubleClick: select, size: 1, children: JSON.stringify(value, null, 2) }), $[33] = value, $[34] = viewMode, $[35] = t21) : t21 = $[35];
  let t22;
  $[36] !== t17 || $[37] !== t18 || $[38] !== t20 || $[39] !== t21 ? (t22 = (0, import_jsx_runtime3.jsxs)(TabPanel, { "aria-labelledby": t17, flex: 1, id: t18, overflow: "auto", padding: 4, style: t19, children: [
    t20,
    t21
  ] }), $[36] = t17, $[37] = t18, $[38] = t20, $[39] = t21, $[40] = t22) : t22 = $[40];
  let t23;
  $[41] !== t16 || $[42] !== t22 ? (t23 = (0, import_jsx_runtime3.jsxs)(Flex, { direction: "column", height: "fill", children: [
    t16,
    t22
  ] }), $[41] = t16, $[42] = t22, $[43] = t23) : t23 = $[43];
  let t24;
  return $[44] !== onInspectClose || $[45] !== t23 || $[46] !== t32 || $[47] !== t4 ? (t24 = (0, import_jsx_runtime3.jsx)(Dialog2, { bodyHeight: "fill", id: t32, header: t4, onClose: onInspectClose, onClickOutside: onInspectClose, padding: false, width: 2, children: t23 }), $[44] = onInspectClose, $[45] = t23, $[46] = t32, $[47] = t4, $[48] = t24) : t24 = $[48], t24;
}
function Banner(props) {
  ...
  let t2;
  $[7] !== Icon ? (t2 = Icon && (0, import_jsx_runtime3.jsx)(Text, { size: 0, children: (0, import_jsx_runtime3.jsx)(Icon, {}) }), $[7] = Icon, $[8] = t2) : t2 = $[8];
  let t3;
  $[9] !== content ? (t3 = (0, import_jsx_runtime3.jsx)(Flex, { align: "center", flex: 1, gap: 2, paddingY: 2, children: content }), $[9] = content, $[10] = t3) : t3 = $[10];
  let t4;
  $[11] !== action ? (t4 = action && (0, import_jsx_runtime3.jsx)(Button2, { ...action, mode: action.mode || "ghost", tone: action.tone || "default" }), $[11] = action, $[12] = t4) : t4 = $[12];
  let t5;
  $[13] !== t2 || $[14] !== t3 || $[15] !== t4 ? (t5 = (0, import_jsx_runtime3.jsxs)(Flex, { align: "center", gap: 3, paddingX: 2, children: [
    t2,
    t3,
    t4
  ] }), $[13] = t2, $[14] = t3, $[15] = t4, $[16] = t5) : t5 = $[16];
  let t6;
  return $[17] !== paddingY || $[18] !== rest || $[19] !== t5 || $[20] !== tone ? (t6 = (0, import_jsx_runtime3.jsx)(Box, { padding: 1, children: (0, import_jsx_runtime3.jsx)(Card, { radius: 3, paddingX: 2, paddingY, tone, ...rest, children: t5 }) }), $[17] = paddingY, $[18] = rest, $[19] = t5, $[20] = tone, $[21] = t6) : t6 = $[21], t6;
}
function DeletedDocumentBanners() {
  ...
  if (!isPublishedPerspective(selectedPerspective) && !isDraftPerspective(selectedPerspective) && isReleaseDocument(selectedPerspective) && selectedPerspective.state === "archived") {
    let t0;
    return $[0] !== selectedPerspective ? (t0 = (0, import_jsx_runtime3.jsx)(ArchivedReleaseBanner, { release: selectedPerspective }), $[0] = selectedPerspective, $[1] = t0) : t0 = $[1], t0;
  }
  if (isDeleted && !isDeleting) {
    let t0;
    return $[2] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t0 = (0, import_jsx_runtime3.jsx)(DeletedDocumentBanner, {}), $[2] = t0) : t0 = $[2], t0;
  }
}
function DeletedDocumentBanner() {
  ...
  let t4;
  $[12] !== t3 ? (t4 = (0, import_jsx_runtime3.jsx)(Text, { size: 1, weight: "medium", children: t3 }), $[12] = t3, $[13] = t4) : t4 = $[13];
  let t5;
  return $[14] !== t22 || $[15] !== t4 ? (t5 = (0, import_jsx_runtime3.jsx)(Banner, { action: t22, content: t4, "data-testid": "deleted-document-banner", icon: ReadOnlyIcon }), $[14] = t22, $[15] = t4, $[16] = t5) : t5 = $[16], t5;
}
var ArchivedReleaseBanner = (t0) => {
  ...
  let t3;
  return $[5] !== t2 || $[6] !== t22 ? (t3 = (0, import_jsx_runtime3.jsx)(Banner, { tone: "caution", content: (0, import_jsx_runtime3.jsx)(Text, { size: 1, weight: "medium", children: (0, import_jsx_runtime3.jsx)(Translate, { t: t2, i18nKey: "banners.deleted-release-banner.text", values: t22 }) }), "data-testid": "deleted-release-banner", icon: DocumentRemoveIcon }), $[5] = t2, $[6] = t22, $[7] = t3) : t3 = $[7], t3;
};
function DeprecatedDocumentTypeBanner() {
  ...
  if (!isDeprecatedSchemaType(schemaType))
    return null;
  let t0;
  $[0] !== t2 ? (t0 = (0, import_jsx_runtime3.jsx)(Translate, { t: t2, i18nKey: "banners.deprecated-document-type-banner.text" }), $[0] = t2, $[1] = t0) : t0 = $[1];
  let t1;
  return $[2] !== schemaType.deprecated.reason || $[3] !== t0 ? (t1 = (0, import_jsx_runtime3.jsx)(Banner, { content: (0, import_jsx_runtime3.jsxs)(Text, { size: 1, weight: "medium", children: [
    t0,
    " ",
...
function RequestPermissionDialog(t0) {
  const $ = (0, import_compiler_runtime2.c)(56), {
    ...
    t: t2
  } = useTranslation(structureLocaleNamespace), telemtry = useTelemetry(), dialogId = `request-permissions-${(0, import_react3.useId)()}`, projectId = useProjectId();
  let t1;
  $[0] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t1 = {
    apiVersion: "2024-09-26"
  }, $[0] = t1) : t1 = $[0];
  const client = useClient(t1), toast = useToast(), zOffset = useZIndex(), [isSubmitting, setIsSubmitting] = (0, import_react3.useState)(false), [note, setNote] = (0, import_react3.useState)(""), [msgError, setMsgError] = (0, import_react3.useState)(), [hasTooManyRequests, setHasTooManyRequests] = (0, import_react3.useState)(false), [hasBeenDenied, setHasBeenDenied] = (0, import_react3.useState)(false);
  let t22;
  bb0: {
    ...
    if ($[2] !== client.observable || $[3] !== projectId) {
      let t42;
      $[5] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t42 = (roles) => roles.filter(_temp$C).find(_temp2$g) ? "editor" : adminRole, $[5] = t42) : t42 = $[5];
      let t52;
  ...
  let t13;
  $[34] !== t12 ? (t13 = (0, import_jsx_runtime3.jsx)(Text, { children: t12 }), $[34] = t12, $[35] = t13) : t13 = $[35];
  let t14;
  $[36] !== hasBeenDenied || $[37] !== hasTooManyRequests || $[38] !== isSubmitting || $[39] !== msgError || $[40] !== note || $[41] !== onSubmit || $[42] !== t2 ? (t14 = hasTooManyRequests || hasBeenDenied ? (0, import_jsx_runtime3.jsx)(Card, { tone: "caution", padding: 3, radius: 2, shadow: 1, children: (0, import_jsx_runtime3.jsxs)(Text, { size: 1, children: [
    hasTooManyRequests && (0, import_jsx_runtime3.jsx)(import_jsx_runtime3.Fragment, { children: msgError ?? t2("request-permission-dialog.warning.limit-reached.text") }),
    hasBeenDenied && (0, import_jsx_runtime3.jsx)(import_jsx_runtime3.Fragment, { children: msgError ?? t2("request-permission-dialog.warning.denied.text") })
  ] }) }) : (0, import_jsx_runtime3.jsxs)(Stack, { space: 3, paddingBottom: 0, children: [
    (0, import_jsx_runtime3.jsx)(TextInput, { placeholder: t2("request-permission-dialog.note-input.placeholder.text"), disabled: isSubmitting, onKeyDown: (e2) => {
      e2.key === "Enter" && onSubmit();
    }, maxLength: MAX_NOTE_LENGTH, value: note, onChange: (e_0) => {
      setNote(e_0.currentTarget.value);
    } }),
    (0, import_jsx_runtime3.jsx)(Text, { align: "right", muted: true, size: 1, children: `${note.length}/${MAX_NOTE_LENGTH}` })
  ] }), $[36] = hasBeenDenied, $[37] = hasTooManyRequests, $[38] = isSubmitting, $[39] = msgError, $[40] = note, $[41] = onSubmit, $[42] = t2, $[43] = t14) : t14 = $[43];
  let t15;
  $[44] !== t13 || $[45] !== t14 ? (t15 = (0, import_jsx_runtime3.jsx)(DialogBody$1, { children: (0, import_jsx_runtime3.jsxs)(Stack, { space: 4, children: [
    t13,
    t14
  ] }) }), $[44] = t13, $[45] = t14, $[46] = t15) : t15 = $[46];
  let t16;
  $[47] !== dialogId || $[48] !== onClose || $[49] !== t11 || $[50] !== t15 || $[51] !== t5 ? (t16 = (0, import_jsx_runtime3.jsx)(Dialog2, { width: 1, id: dialogId, header: t5, footer: t11, onClose, onClickOutside: onClose, children: t15 }), $[47] = dialogId, $[48] = onClose, $[49] = t11, $[50] = t15, $[51] = t5, $[52] = t16) : t16 = $[52];
  let t17;
  return $[53] !== t16 || $[54] !== zOffset.fullscreen ? (t17 = (0, import_jsx_runtime3.jsx)(DialogProvider, { position: "fixed", zOffset: t4, children: t16 }), $[53] = t16, $[54] = zOffset.fullscreen, $[55] = t17) : t17 = $[55], t17;
}
...
function InsufficientPermissionBanner(t0) {
  ...
  const listFormat = useListFormat(t1), {
    t: t2
  } = useTranslation(structureLocaleNamespace), telemetry = useTelemetry(), roleTitles = currentUserRoles.map(_temp$B), roles = listFormat.formatToParts(roleTitles).map(_temp2$f);
  let t22;
  $[1] !== roles ? (t22 = {
    Roles: () => (0, import_jsx_runtime3.jsx)(import_jsx_runtime3.Fragment, { children: roles })
  }, $[1] = roles, $[2] = t22) : t22 = $[2];
  let t3;
  ...
  let t4;
  $[6] !== requiredPermission || $[7] !== t2 || $[8] !== t22 || $[9] !== t3 ? (t4 = (0, import_jsx_runtime3.jsx)(Text, { size: 1, weight: "medium", children: (0, import_jsx_runtime3.jsx)(Translate, { t: t2, i18nKey: "banners.permission-check-banner.missing-permission", components: t22, values: t3, context: requiredPermission }) }), $[6] = requiredPermission, $[7] = t2, $[8] = t22, $[9] = t3, $[10] = t4) : t4 = $[10];
  let t5;
  ...
  let t6;
  $[20] !== t4 || $[21] !== t5 ? (t6 = (0, import_jsx_runtime3.jsx)(Banner, { content: t4, action: t5, "data-testid": "permission-check-banner", icon: ReadOnlyIcon }), $[20] = t4, $[21] = t5, $[22] = t6) : t6 = $[22];
  let t7;
  $[23] !== setShowRequestPermissionDialog || $[24] !== showRequestPermissionDialog ? (t7 = showRequestPermissionDialog && (0, import_jsx_runtime3.jsx)(RequestPermissionDialog, { onClose: () => setShowRequestPermissionDialog(false), onRequestSubmitted: () => {
  ...
  let t8;
  return $[26] !== t6 || $[27] !== t7 ? (t8 = (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
    t6,
    t7
  ] }), $[26] = t6, $[27] = t7, $[28] = t8) : t8 = $[28], t8;
}
function _temp2$f(part) {
  return part.type === "element" ? (0, import_jsx_runtime3.jsx)("code", { children: part.value }, part.value) : part.value;
}
...
var ReferenceChangedBanner = (0, import_react3.memo)(() => {
  ...
  bb0: {
    ...
    if ($[3] !== documentPreviewStore || $[4] !== parentId || $[5] !== parentRefPath || $[6] !== parentRefPathSegment || $[7] !== selectedPerspectiveName) {
      const publishedId = getPublishedId(parentId), path = fromString(parentRefPathSegment), keyedSegmentIndex = path.findIndex(_temp$A);
      let t32;
  ...
  let t6;
  $[27] !== t5 ? (t6 = (0, import_jsx_runtime3.jsx)(Text, { size: 1, weight: "medium", children: t5 }), $[27] = t5, $[28] = t6) : t6 = $[28];
  let t7;
  return $[29] !== t4 || $[30] !== t6 ? (t7 = (0, import_jsx_runtime3.jsx)(Banner, { action: t4, "data-testid": "reference-changed-banner", content: t6, icon: WarningOutlineIcon, tone: "caution" }), $[29] = t4, $[30] = t6, $[31] = t7) : t7 = $[31], t7;
});
...
function ScheduledDraftOverrideBanner(t0) {
  ...
  if (draftPublishedId !== scheduledPublishedId || !(!draftRev || !scheduledBaseRev || draftRev !== scheduledBaseRev))
    return null;
  let t1;
  return $[0] !== t2 ? (t1 = (0, import_jsx_runtime3.jsx)(Banner, { tone: "caution", icon: WarningOutlineIcon, content: (0, import_jsx_runtime3.jsx)(Text, { size: 1, children: (0, import_jsx_runtime3.jsx)(Translate, { t: t2, i18nKey: "banners.scheduled-draft-override-banner.text" }) }) }), $[0] = t2, $[1] = t1) : t1 = $[1], t1;
}
...
function ArchivedReleaseDocumentBanner() {
  ...
  let t7;
  $[17] !== description || $[18] !== t2 || $[19] !== t4 || $[20] !== t6 ? (t7 = (0, import_jsx_runtime3.jsx)(Text, { size: 1, children: (0, import_jsx_runtime3.jsx)(Translate, { t: t2, i18nKey: description, values: t4, components: t6 }) }), $[17] = description, $[18] = t2, $[19] = t4, $[20] = t6, $[21] = t7) : t7 = $[21];
  let t8;
  ...
  let t9;
  return $[25] !== t7 || $[26] !== t8 ? (t9 = (0, import_jsx_runtime3.jsx)(Banner, { tone: "caution", content: t7, action: t8 }), $[25] = t7, $[26] = t8, $[27] = t9) : t9 = $[27], t9;
}
var Image = at.img`
  object-fit: cover;
  width: 100%;
...
var CanvasPopoverContent = (t0) => {
  const $ = (0, import_compiler_runtime2.c)(24), {
    ...
    t: t2
  } = useTranslation(structureLocaleNamespace), ref = (0, import_react3.useRef)(null);
  let t1;
  ...
  let t4;
  $[7] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t4 = (0, import_jsx_runtime3.jsx)(Image, { src: CANVAS_IMAGE_URL, alt: "Canvas" }), $[7] = t4) : t4 = $[7];
  let t5;
  $[8] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t5 = (0, import_jsx_runtime3.jsx)(Text, { size: 1, weight: "semibold", children: CANVAS_APP_NAME }), $[8] = t5) : t5 = $[8];
  let t6;
  $[9] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t6 = (0, import_jsx_runtime3.jsxs)(Flex, { paddingY: 1, gap: 2, children: [
    t5,
    (0, import_jsx_runtime3.jsx)(Text, { size: 1, muted: true, children: (0, import_jsx_runtime3.jsx)(ComposeSparklesIcon, {}) })
  ] }), $[9] = t6) : t6 = $[9];
  let t7;
  $[10] !== popoverHeading ? (t7 = (0, import_jsx_runtime3.jsx)(Box, { paddingTop: 3, children: (0, import_jsx_runtime3.jsx)(Heading, { size: 1, children: popoverHeading }) }), $[10] = popoverHeading, $[11] = t7) : t7 = $[11];
  let t8;
  $[12] !== popoverDescription ? (t8 = (0, import_jsx_runtime3.jsx)(Box, { paddingTop: 4, children: (0, import_jsx_runtime3.jsx)(Text, { size: 1, children: popoverDescription }) }), $[12] = popoverDescription, $[13] = t8) : t8 = $[13];
  let t9;
  $[14] !== t7 || $[15] !== t8 ? (t9 = (0, import_jsx_runtime3.jsxs)(Flex, { paddingX: 4, paddingBottom: 4, paddingTop: 3, direction: "column", children: [
    t6,
    t7,
    t8
  ...
  let t11;
  $[19] !== t10 ? (t11 = (0, import_jsx_runtime3.jsx)(Flex, { width: "full", gap: 3, justify: "flex-end", paddingX: 4, paddingBottom: 4, children: (0, import_jsx_runtime3.jsx)(Button2, { mode: "bleed", text: t10, autoFocus: true, tone: "primary", href: "https://snty.link/canvas-docs", target: "_blank", rel: "noopener noreferrer", as: "a", iconRight: LaunchIcon }) }), $[19] = t10, $[20] = t11) : t11 = $[20];
  let t12;
  return $[21] !== t11 || $[22] !== t9 ? (t12 = (0, import_jsx_runtime3.jsx)(Card, { radius: 3, overflow: "hidden", width: 0, ref, children: (0, import_jsx_runtime3.jsxs)(Container, { width: 0, children: [
    t4,
    t9,
    t11
...
var CanvasLinkedBannerContent = (t0) => {
  const $ = (0, import_compiler_runtime2.c)(21), {
    ...
    t: t2
  } = useTranslation(structureLocaleNamespace), [open, setOpen] = (0, import_react3.useState)(false), documentVariantType = getDocumentVariantType(documentId), {
    isLockedByCanvas
  ...
  let t22;
  $[8] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t22 = () => setOpen(_temp$z), $[8] = t22) : t22 = $[8];
  const togglePopover = t22;
  let t3;
  $[9] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t3 = () => setOpen(false), $[9] = t3) : t3 = $[9];
  const onClose = t3;
  let t4;
  $[10] !== variantText ? (t4 = (0, import_jsx_runtime3.jsx)(Text, { size: 1, weight: "medium", children: variantText }), $[10] = variantText, $[11] = t4) : t4 = $[11];
  let t5;
  $[12] !== isLockedByCanvas ? (t5 = (0, import_jsx_runtime3.jsx)(CanvasPopoverContent, { onClose, isLockedByCanvas }), $[12] = isLockedByCanvas, $[13] = t5) : t5 = $[13];
  let t6;
  $[14] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t6 = (0, import_jsx_runtime3.jsx)(Button2, { tooltipProps: null, mode: "bleed", tone: "default", icon: InfoOutlineIcon, onClick: togglePopover }), $[14] = t6) : t6 = $[14];
  let t7;
  $[15] !== open || $[16] !== t5 ? (t7 = (0, import_jsx_runtime3.jsx)(Popover2, { open, size: 0, tone: "default", portal: true, placement: "bottom-start", content: t5, children: t6 }), $[15] = open, $[16] = t5, $[17] = t7) : t7 = $[17];
  let t8;
  return $[18] !== t4 || $[19] !== t7 ? (t8 = (0, import_jsx_runtime3.jsxs)(Flex, { align: "center", gap: 2, children: [
    t4,
    t7
...
function CanvasLinkedBanner() {
  const $ = (0, import_compiler_runtime2.c)(10), {
    ...
    t: t2
  } = useTranslation(structureLocaleNamespace), id2 = displayed?._id || documentId, {
    companionDoc
  } = useCanvasCompanionDoc(id2), navigateToCanvas = useNavigateToCanvasDoc(companionDoc?.canvasDocumentId, "banner");
  if (!companionDoc)
    return null;
  let t0;
  $[0] !== id2 ? (t0 = (0, import_jsx_runtime3.jsx)(CanvasLinkedBannerContent, { documentId: id2 }), $[0] = id2, $[1] = t0) : t0 = $[1];
  let t1;
  ...
  let t3;
  return $[7] !== t0 || $[8] !== t22 ? (t3 = (0, import_jsx_runtime3.jsx)(Banner, { tone: "neutral", "data-test-id": "canvas-linked-banner", paddingY: 0, content: t0, action: t22 }), $[7] = t0, $[8] = t22, $[9] = t3) : t3 = $[9], t3;
}
function _temp$z(prev) {
  return !prev;
}
var ChooseNewDocumentDestinationBanner = (t0) => {
  ...
  let t6;
  $[9] !== reason || $[10] !== selectedPerspective || $[11] !== t2 ? (t6 = reason === "RELEASE_NOT_ACTIVE" && isReleaseDocument(selectedPerspective) && (0, import_jsx_runtime3.jsx)(Translate, { t: t2, i18nKey: "banners.choose-new-document-destination.release-inactive", values: {
  ...
  let t8;
  $[15] !== t7 ? (t8 = (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
    " ",
    t7
  ] }), $[15] = t7, $[16] = t8) : t8 = $[16];
  let t9;
  $[17] !== t4 || $[18] !== t5 || $[19] !== t6 || $[20] !== t8 ? (t9 = (0, import_jsx_runtime3.jsxs)(Text, { size: 1, children: [
    t4,
    t5,
    t6,
    t8
  ...
  let t10;
  $[22] !== menuItemProps ? (t10 = (0, import_jsx_runtime3.jsx)(ReleasesNav, { menuItemProps }), $[22] = menuItemProps, $[23] = t10) : t10 = $[23];
  let t11;
  return $[24] !== t10 || $[25] !== t9 ? (t11 = (0, import_jsx_runtime3.jsx)(Banner, { tone: "caution", icon: WarningOutlineIcon, content: (0, import_jsx_runtime3.jsxs)(Flex, { align: "center", gap: 2, children: [
    t9,
    t10
...
function CreateLinkedBanner() {
  ...
  if (!CreateLinkedBannerContent || !createLinkMetadata)
    return null;
  let t1;
  return $[2] !== CreateLinkedBannerContent || $[3] !== createLinkMetadata ? (t1 = (0, import_jsx_runtime3.jsx)(Banner, { tone: "transparent", "data-test-id": "sanity-create-read-only-banner", content: (0, import_jsx_runtime3.jsx)(CreateLinkedBannerContent, { metadata: createLinkMetadata }) }), $[2] = CreateLinkedBannerContent, $[3] = createLinkMetadata, $[4] = t1) : t1 = $[4], t1;
}
var TOAST_DELAY = 1e3;
function DocumentNotInReleaseBanner(t0) {
  ...
  const tone = t2, {
    ...
    createVersion
  } = useVersionOperations(), isAnonymousBundle = typeof currentRelease == "string", [versionCreateState, setVersionCreateState] = (0, import_react3.useState)(), toast = useToast();
  let t32;
  $[2] !== createVersion || $[3] !== currentRelease || $[4] !== documentId || $[5] !== isAnonymousBundle || $[6] !== t3 || $[7] !== toast ? (t32 = async () => {
  ...
  }, $[2] = createVersion, $[3] = currentRelease, $[4] = documentId, $[5] = isAnonymousBundle, $[6] = t3, $[7] = toast, $[8] = t32) : t32 = $[8];
  ...
  let t5;
  $[9] !== t3 ? (t5 = t3("banners.release.waiting.title"), $[9] = t3, $[10] = t5) : t5 = $[10];
  let t6;
  $[11] !== t3 ? (t6 = t3("banners.release.waiting.description"), $[11] = t3, $[12] = t6) : t6 = $[12];
  let t7;
  $[13] !== t4 || $[14] !== t5 || $[15] !== t6 ? (t7 = {
    status: "info",
    ...
    title: t5,
    description: t6
  }, $[13] = t4, $[14] = t5, $[15] = t6, $[16] = t7) : t7 = $[16], useConditionalToast(t7);
  let t8;
  $[17] !== currentRelease || $[18] !== isAnonymousBundle || $[19] !== tCore ? (t8 = isAnonymousBundle ? currentRelease : currentRelease?.metadata?.title || tCore("release.placeholder-untitled-release"), $[17] = currentRelease, $[18] = isAnonymousBundle, $[19] = tCore, $[20] = t8) : t8 = $[20];
  let t9;
  $[21] !== t8 ? (t9 = {
    title: t8
  }, $[21] = t8, $[22] = t9) : t9 = $[22];
  let t10;
  $[23] !== currentRelease ? (t10 = getVersionInlineBadge(currentRelease), $[23] = currentRelease, $[24] = t10) : t10 = $[24];
  let t11;
  $[25] !== t10 ? (t11 = {
    VersionBadge: t10
  }, $[25] = t10, $[26] = t11) : t11 = $[26];
  let t12;
  $[27] !== t3 || $[28] !== t11 || $[29] !== t9 ? (t12 = (0, import_jsx_runtime3.jsx)(Text, { size: 1, children: (0, import_jsx_runtime3.jsx)(Translate, { i18nKey: "banners.release.not-in-release", t: t3, values: t9, components: t11 }) }), $[27] = t3, $[28] = t11, $[29] = t9, $[30] = t12) : t12 = $[30];
  let t13;
  $[31] !== handleAddToRelease || $[32] !== isScheduledRelease || $[33] !== t3 || $[34] !== tone || $[35] !== versionCreateState ? (t13 = isScheduledRelease ? void 0 : {
    text: t3("banners.release.action.add-to-release"),
    tone,
    disabled: !!versionCreateState,
    onClick: handleAddToRelease,
    mode: "default"
  }, $[31] = handleAddToRelease, $[32] = isScheduledRelease, $[33] = t3, $[34] = tone, $[35] = versionCreateState, $[36] = t13) : t13 = $[36];
  let t14;
  return $[37] !== t12 || $[38] !== t13 || $[39] !== tone ? (t14 = (0, import_jsx_runtime3.jsx)(Banner, { tone, content: t12, action: t13 }), $[37] = t12, $[38] = t13, $[39] = tone, $[40] = t14) : t14 = $[40], t14;
}
function useCurrentTime(updateIntervalMs) {
  const $ = (0, import_compiler_runtime2.c)(4);
  let t0;
  $[0] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t0 = /* @__PURE__ */ new Date(), $[0] = t0) : t0 = $[0];
  const [currentTime, setCurrentTime] = (0, import_react3.useState)(t0);
  let t1, t2;
  ...
  }, t2 = [updateIntervalMs], $[1] = updateIntervalMs, $[2] = t1, $[3] = t2) : (t1 = $[2], t2 = $[3]), (0, import_react3.useEffect)(t1, t2), currentTime;
}
...
var ObsoleteDraftBanner = (t0) => {
  const $ = (0, import_compiler_runtime2.c)(47), {
    ...
    t: t2
  } = useTranslation(structureLocaleNamespace), [isPublishing, setPublishing] = (0, import_react3.useState)(false), [isDiscarding, setDiscarding] = (0, import_react3.useState)(false), telemetry = useTelemetry(), {
    publish,
    discardChanges
  ...
  }, $[6] = t3) : t3 = $[6], (0, import_react3.useEffect)(t3);
  ...
  let t6;
  $[13] !== i18nKey || $[14] !== t2 || $[15] !== t5 ? (t6 = (0, import_jsx_runtime3.jsx)(Text, { size: 1, weight: "medium", children: (0, import_jsx_runtime3.jsx)(Translate, { t: t2, i18nKey, values: t5 }) }), $[13] = i18nKey, $[14] = t2, $[15] = t5, $[16] = t6) : t6 = $[16];
  let t7;
  $[17] !== t2 ? (t7 = t2("banners.obsolete-draft.actions.compare-draft.text"), $[17] = t2, $[18] = t7) : t7 = $[18];
  let t8;
  $[19] !== compareDraft || $[20] !== t7 ? (t8 = (0, import_jsx_runtime3.jsx)(Button2, { text: t7, mode: "ghost", onClick: compareDraft }), $[19] = compareDraft, $[20] = t7, $[21] = t8) : t8 = $[21];
  let t9;
  ...
  let t11;
  $[27] !== handlePublish || $[28] !== isPublishing || $[29] !== t10 || $[30] !== t9 ? (t11 = (0, import_jsx_runtime3.jsx)(Button2, { onClick: handlePublish, text: t9, tooltipProps: t10, loading: isPublishing, tone: "positive" }), $[27] = handlePublish, $[28] = isPublishing, $[29] = t10, $[30] = t9, $[31] = t11) : t11 = $[31];
  let t12;
  ...
  let t14;
  $[37] !== handleDiscard || $[38] !== isDiscarding || $[39] !== t12 || $[40] !== t13 ? (t14 = (0, import_jsx_runtime3.jsx)(Button2, { onClick: handleDiscard, text: t12, tooltipProps: t13, loading: isDiscarding, tone: "caution" }), $[37] = handleDiscard, $[38] = isDiscarding, $[39] = t12, $[40] = t13, $[41] = t14) : t14 = $[41];
  let t15;
  return $[42] !== t11 || $[43] !== t14 || $[44] !== t6 || $[45] !== t8 ? (t15 = (0, import_jsx_runtime3.jsx)(Banner, { content: (0, import_jsx_runtime3.jsxs)(Flex, { align: "center", justify: "space-between", gap: 2, children: [
    t6,
    t8,
    t11,
    t14
...
function OpenReleaseToEditBanner(t0) {
  ...
  if (!isVersionId(documentId) || !onlyHasVersions || !isPinnedDraftOrPublished)
    return null;
  let t2;
  return $[2] !== documentId ? (t2 = (0, import_jsx_runtime3.jsx)(OpenReleaseToEditBannerInner, { documentId }), $[2] = documentId, $[3] = t2) : t2 = $[3], t2;
}
function OpenReleaseToEditBannerInner(t0) {
  ...
  if (documentVersionsTitleList.length === 0)
    return null;
  let t7;
  $[22] !== documentVersionsTitleList[0] || $[23] !== documentVersionsTitleList.length || $[24] !== t6 ? (t7 = (0, import_jsx_runtime3.jsx)(Text, { size: 1, children: (0, import_jsx_runtime3.jsx)(Flex, { direction: "row", gap: 1, wrap: "wrap", children: documentVersionsTitleList.length > 1 ? (0, import_jsx_runtime3.jsx)(Translate, { t: t6, i18nKey: "banners.release.navigate-to-edit-description-multiple", components: {
    VersionBadge: () => (0, import_jsx_runtime3.jsxs)(VersionInlineBadge, { children: [
      " ",
      documentVersionsTitleList[0]
    ] })
  }, values: {
    count: documentVersionsTitleList.length - 1
  } }) : (0, import_jsx_runtime3.jsx)(Translate, { t: t6, i18nKey: "banners.release.navigate-to-edit-description-single", components: {
    VersionBadge: () => (0, import_jsx_runtime3.jsxs)(VersionInlineBadge, { children: [
      " ",
      documentVersionsTitleList[0]
    ] })
  ...
  let t9;
  return $[31] !== t7 || $[32] !== t8 || $[33] !== tone ? (t9 = (0, import_jsx_runtime3.jsx)(Banner, { tone, "data-testid": "open-release-to-edit-banner", content: t7, action: t8 }), $[31] = t7, $[32] = t8, $[33] = tone, $[34] = t9) : t9 = $[34], t9;
}
function PausedScheduledDraftBanner() {
  ...
  let t0;
  return $[0] !== t2 ? (t0 = (0, import_jsx_runtime3.jsx)(Banner, { tone: "caution", icon: PauseIcon, content: (0, import_jsx_runtime3.jsx)(Text, { size: 1, children: (0, import_jsx_runtime3.jsx)(Translate, { t: t2, i18nKey: "banners.paused-scheduled-draft.text" }) }) }), $[0] = t2, $[1] = t0) : t0 = $[1], t0;
}
function RevisionNotFoundBanner() {
  ...
  let t1;
  return $[2] !== t0 ? (t1 = (0, import_jsx_runtime3.jsx)(Banner, { tone: "caution", "data-test-id": "revision-not-found-banner", icon: WarningOutlineIcon, content: (0, import_jsx_runtime3.jsx)(Text, { size: 1, children: t0 }) }), $[2] = t0, $[3] = t1) : t1 = $[3], t1;
}
function ScheduledReleaseBanner(t0) {
  ...
  let t5;
  $[6] !== t4 || $[7] !== tCore ? (t5 = (0, import_jsx_runtime3.jsx)(Text, { size: 1, children: (0, import_jsx_runtime3.jsx)(Translate, { t: tCore, i18nKey: "release.banner.scheduled-for-publishing-on", values: t4 }) }), $[6] = t4, $[7] = tCore, $[8] = t5) : t5 = $[8];
  let t6;
  return $[9] !== t5 || $[10] !== tone ? (t6 = (0, import_jsx_runtime3.jsx)(Banner, { tone, icon: LockIcon, content: t5 }), $[9] = t5, $[10] = tone, $[11] = t6) : t6 = $[11], t6;
}
function UnpublishedDocumentBanner() {
  ...
  if (isReleaseDocument(selectedPerspective) && isCurrentVersionGoingToUnpublish) {
    ...
    let t4;
    $[9] !== t2 || $[10] !== t1 || $[11] !== t3 ? (t4 = (0, import_jsx_runtime3.jsx)(Text, { size: 1, children: (0, import_jsx_runtime3.jsx)(Translate, { t: t2, i18nKey: "banners.unpublished-release-banner.text", values: t1, components: t3 }) }), $[9] = t2, $[10] = t1, $[11] = t3, $[12] = t4) : t4 = $[12];
    let t5;
    $[13] !== t2 ? (t5 = (0, import_jsx_runtime3.jsx)(Text, { size: 1, children: (0, import_jsx_runtime3.jsx)(Translate, { t: t2, i18nKey: "banners.unpublished-release-banner.text-with-published" }) }), $[13] = t2, $[14] = t5) : t5 = $[14];
    let t6;
    return $[15] !== t4 || $[16] !== t5 ? (t6 = (0, import_jsx_runtime3.jsx)(Banner, { tone: "critical", content: (0, import_jsx_runtime3.jsxs)(Stack, { space: 2, children: [
      t4,
      t5
...
var FormHeader = (t0) => {
  ...
  if (schemaType.__experimental_formPreviewTitle === false)
    return null;
  let t1;
  $[0] !== description || $[1] !== isSingleton || $[2] !== schemaType.name || $[3] !== schemaType.title ? (t1 = !isSingleton && (0, import_jsx_runtime3.jsxs)(Inline, { space: 1, children: [
    (0, import_jsx_runtime3.jsx)(Text, { muted: true, size: 1, children: schemaType.title ?? schemaType.name }),
    description && (0, import_jsx_runtime3.jsx)(Tooltip, { content: description, placement: "right", children: (0, import_jsx_runtime3.jsx)(InfoOutlineIcon, { "data-testid": "schema-description-icon" }) })
  ...
  let t4;
  $[8] !== t22 || $[9] !== t3 ? (t4 = (0, import_jsx_runtime3.jsx)(Heading, { as: "h2", "data-heading": true, muted: t22, "data-testid": "document-panel-document-title", children: t3 }), $[8] = t22, $[9] = t3, $[10] = t4) : t4 = $[10];
  let t5;
  return $[11] !== t1 || $[12] !== t4 ? (t5 = (0, import_jsx_runtime3.jsxs)(TitleContainer, { marginBottom: 6, space: 4, children: [
    t1,
    t4
  ] }), $[11] = t1, $[12] = t4, $[13] = t5) : t5 = $[13], t5;
};
var preventDefault = (ev) => ev.preventDefault();
var FormView = (0, import_react3.forwardRef)(function(props, ref) {
  const $ = (0, import_compiler_runtime2.c)(77), {
    ...
    title
  } = useDocumentTitle(), [patchChannel] = (0, import_react3.useState)(_temp$y), isLocked = editState?.transactionSyncLock?.enabled, {
    t: t2
  } = useTranslation(structureLocaleNamespace);
  let t0;
  ...
  let t4;
  $[14] !== documentId || $[15] !== documentStore || $[16] !== documentType || $[17] !== patchChannel || $[18] !== selectedReleaseId ? (t4 = [documentId, documentStore, documentType, patchChannel, selectedReleaseId], $[14] = documentId, $[15] = documentStore, $[16] = documentType, $[17] = patchChannel, $[18] = selectedReleaseId, $[19] = t4) : t4 = $[19], (0, import_react3.useEffect)(t3, t4);
  ...
  const handleInitialValue = (0, import_react3.useEffectEvent)(t5);
  let t6;
  $[23] !== handleInitialValue || $[24] !== hasRev ? (t6 = () => {
    hasRev && handleInitialValue();
  }, $[23] = handleInitialValue, $[24] = hasRev, $[25] = t6) : t6 = $[25];
  let t7;
  $[26] !== hasRev ? (t7 = [hasRev], $[26] = hasRev, $[27] = t7) : t7 = $[27], (0, import_react3.useEffect)(t6, t7);
  const [formRef, setFormRef] = (0, import_react3.useState)(null), [focusedFirstDescendant, setFocusedFirstDescendant] = (0, import_react3.useState)(false);
  let t8;
  ...
  let t10;
  $[33] !== focusedFirstDescendant || $[34] !== formRef || $[35] !== ready || $[36] !== t9 ? (t10 = [focusedFirstDescendant, formRef, t9, ready], $[33] = focusedFirstDescendant, $[34] = formRef, $[35] = ready, $[36] = t9, $[37] = t10) : t10 = $[37], (0, import_react3.useEffect)(t8, t10);
  let t11;
  $[38] !== ref ? (t11 = (node) => {
  ...
  let t13;
  $[40] !== collapsedFieldSets || $[41] !== collapsedPaths || $[42] !== compareValue || $[43] !== connectionState || $[44] !== documentId || $[45] !== editState?.draft || $[46] !== editState?.published || $[47] !== fieldActions || $[48] !== formState || $[49] !== hasUpstreamVersion || $[50] !== hidden || $[51] !== isReadOnly || $[52] !== onBlur || $[53] !== onChange || $[54] !== onFocus || $[55] !== onPathOpen || $[56] !== onSetActiveFieldGroup || $[57] !== onSetCollapsedFieldSet || $[58] !== onSetCollapsedPath || $[59] !== openPath || $[60] !== patchChannel || $[61] !== presence || $[62] !== selectedPerspective || $[63] !== t2 || $[64] !== title || $[65] !== validation ? (t13 = connectionState === "connecting" && !editState?.draft && !editState?.published ? (0, import_jsx_runtime3.jsx)(Delay, { ms: 300, children: (0, import_jsx_runtime3.jsxs)(Flex, { align: "center", direction: "column", height: "fill", justify: "center", children: [
    (0, import_jsx_runtime3.jsx)(Spinner, { muted: true }),
    (0, import_jsx_runtime3.jsx)(Box, { marginTop: 3, children: (0, import_jsx_runtime3.jsx)(Text, { align: "center", muted: true, size: 1, children: t2("document-view.form-view.loading") }) })
  ] }) }) : formState === null || hidden ? (0, import_jsx_runtime3.jsx)(Box, { padding: 2, children: (0, import_jsx_runtime3.jsx)(Text, { children: t2("document-view.form-view.form-hidden") }) }) : (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
    (0, import_jsx_runtime3.jsx)(FormHeader, { documentId, schemaType: formState.schemaType, title }),
    (0, import_jsx_runtime3.jsx)(FormBuilder, { __internal_fieldActions: fieldActions, __internal_patchChannel: patchChannel, changed: formState.changed, collapsedFieldSets, collapsedPaths, compareValue: compareValue ?? void 0, focused: formState.focused, focusPath: formState.focusPath, groups: formState.groups, id: "root", members: formState.members, onChange, onFieldGroupSelect: onSetActiveFieldGroup, onPathBlur: onBlur, onPathFocus: onFocus, onPathOpen, onSetFieldSetCollapsed: onSetCollapsedFieldSet, onSetPathCollapsed: onSetCollapsedPath, openPath, perspective: selectedPerspective, hasUpstreamVersion, presence, readOnly: isReadOnly, schemaType: formState.schemaType, validation, value: formState.value })
  ] }), $[40] = collapsedFieldSets, $[41] = collapsedPaths, $[42] = compareValue, $[43] = connectionState, $[44] = documentId, $[45] = editState?.draft, $[46] = editState?.published, $[47] = fieldActions, $[48] = formState, $[49] = hasUpstreamVersion, $[50] = hidden, $[51] = isReadOnly, $[52] = onBlur, $[53] = onChange, $[54] = onFocus, $[55] = onPathOpen, $[56] = onSetActiveFieldGroup, $[57] = onSetCollapsedFieldSet, $[58] = onSetCollapsedPath, $[59] = openPath, $[60] = patchChannel, $[61] = presence, $[62] = selectedPerspective, $[63] = t2, $[64] = title, $[65] = validation, $[66] = t13) : t13 = $[66];
  let t14;
  $[67] !== setRef || $[68] !== t12 || $[69] !== t13 ? (t14 = (0, import_jsx_runtime3.jsx)(Box, { as: "form", onSubmit: preventDefault, ref: setRef, "data-testid": "form-view", "data-read-only": t12, children: t13 }), $[67] = setRef, $[68] = t12, $[69] = t13, $[70] = t14) : t14 = $[70];
  let t15;
  $[71] !== margins || $[72] !== t14 ? (t15 = (0, import_jsx_runtime3.jsx)(PresenceOverlay, { margins, children: t14 }), $[71] = margins, $[72] = t14, $[73] = t15) : t15 = $[73];
  let t16;
  return $[74] !== hidden || $[75] !== t15 ? (t16 = (0, import_jsx_runtime3.jsx)(Container, { hidden, paddingX: 4, paddingTop: 5, paddingBottom: 9, sizing: "border", width: 1, children: t15 }), $[74] = hidden, $[75] = t15, $[76] = t16) : t16 = $[76], t16;
});
...
function DocumentHeaderTabs() {
  ...
  if ($[0] !== activeViewId || $[1] !== paneKey || $[2] !== tabPanelId || $[3] !== views2) {
    let t12;
    $[5] !== activeViewId || $[6] !== paneKey || $[7] !== tabPanelId ? (t12 = (view, index) => (0, import_jsx_runtime3.jsx)(DocumentHeaderTab, { icon: view.icon, id: `${paneKey}tab-${view.id}`, isActive: activeViewId === view.id, label: view.title, tabPanelId, viewId: index === 0 ? null : view.id ?? null }, view.id), $[5] = activeViewId, $[6] = paneKey, $[7] = tabPanelId, $[8] = t12) : t12 = $[8], t0 = views2.map(t12), $[0] = activeViewId, $[1] = paneKey, $[2] = tabPanelId, $[3] = views2, $[4] = t0;
  } else
    t0 = $[4];
  let t1;
  return $[9] !== t0 ? (t1 = (0, import_jsx_runtime3.jsx)(TabList, { space: 1, children: t0 }), $[9] = t0, $[10] = t1) : t1 = $[10], t1;
}
function DocumentHeaderTab(props) {
  const $ = (0, import_compiler_runtime2.c)(20);
  let icon, id2, isActive, label, rest, tabPanelId, viewId;
  $[0] !== props ? ({
    icon,
    id: id2,
    isActive,
    ...
    viewId,
    ...rest
  } = props, $[0] = props, $[1] = icon, $[2] = id2, $[3] = isActive, $[4] = label, $[5] = rest, $[6] = tabPanelId, $[7] = viewId) : (icon = $[1], id2 = $[2], isActive = $[3], label = $[4], rest = $[5], tabPanelId = $[6], viewId = $[7]);
  const {
    ready,
    editState
  } = useDocumentPane(), {
  ...
  let t2;
  return $[11] !== handleClick || $[12] !== icon || $[13] !== id2 || $[14] !== isActive || $[15] !== label || $[16] !== rest || $[17] !== t1 || $[18] !== tabPanelId ? (t2 = (0, import_jsx_runtime3.jsx)(Tab, { ...rest, "aria-controls": tabPanelId, disabled: t1, icon, id: id2, label, onClick: handleClick, selected: isActive }), $[11] = handleClick, $[12] = icon, $[13] = id2, $[14] = isActive, $[15] = label, $[16] = rest, $[17] = t1, $[18] = tabPanelId, $[19] = t2) : t2 = $[19], t2;
}
var DEFAULT_VALUE = {
  paneDataItems: [],
  routerPanes: [],
...
function useResolvedPanesList() {
  return (0, import_react3.useContext)(ResolvedPanesContext) ?? DEFAULT_VALUE;
}
var _DEBUG = false;
...
function DocumentHeaderBreadcrumbItem(t0) {
  ...
  let t11;
  return $[22] !== handleClick || $[23] !== t10 || $[24] !== t7 || $[25] !== t9 ? (t11 = (0, import_jsx_runtime3.jsx)(Button2, { mode: "bleed", text: t7, tooltipProps: t9, onClick: handleClick, paddingLeft: t10 }), $[22] = handleClick, $[23] = t10, $[24] = t7, $[25] = t9, $[26] = t11) : t11 = $[26], t11;
}
  ...
  if ($[0] !== currentPaneIndex || $[1] !== paneDataItems) {
    ...
    $[3] !== currentPaneIndex ? (t22 = (paneData, idx) => {
      ...
      return (0, import_jsx_runtime3.jsxs)(import_react3.Fragment, { children: [
        (0, import_jsx_runtime3.jsx)(DocumentHeaderBreadcrumbItem, { paneData, index: idx }),
        idx < currentPaneIndex && (isDocumentPane ? (0, import_jsx_runtime3.jsx)(Box, { padding: 1, children: (0, import_jsx_runtime3.jsx)(ArrowRightIcon, {}) }) : (0, import_jsx_runtime3.jsx)(Text, { children: "/" }))
    ...
    t1 = $[2];
  let t2;
  return $[5] !== t1 ? (t2 = (0, import_jsx_runtime3.jsx)(Flex, { direction: "row", align: "center", "data-testid": "document-header-breadcrumb", children: t1 }), $[5] = t1, $[6] = t2) : t2 = $[6], t2;
}
function DocumentHeaderTitle() {
  ...
  let t0;
  $[0] !== paneDataItems ? (t0 = paneDataItems.some(_temp$x), $[0] = paneDataItems, $[1] = t0) : t0 = $[1];
  const hasMaximizedPane = t0;
  if (connectionState === "connecting" && !subscribed) {
    let t12;
    return $[2] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t12 = (0, import_jsx_runtime3.jsx)(import_jsx_runtime3.Fragment, {}), $[2] = t12) : t12 = $[2], t12;
  }
  if (title) {
    let t12;
    return $[3] !== title ? (t12 = (0, import_jsx_runtime3.jsx)(import_jsx_runtime3.Fragment, { children: title }), $[3] = title, $[4] = t12) : t12 = $[4], t12;
  }
  if (!documentValue) {
    ...
    let t3;
    return $[8] !== t222 ? (t3 = (0, import_jsx_runtime3.jsx)(import_jsx_runtime3.Fragment, { children: t222 }), $[8] = t222, $[9] = t3) : t3 = $[9], t3;
  }
  if (error) {
    let t12;
    ...
    let t222;
    return $[13] !== t12 ? (t222 = (0, import_jsx_runtime3.jsx)(import_jsx_runtime3.Fragment, { children: t12 }), $[13] = t12, $[14] = t222) : t222 = $[14], t222;
  }
  let t1;
  $[15] !== documentTitle || $[16] !== hasMaximizedPane || $[17] !== index || $[18] !== paneDataItems || $[19] !== t2 ? (t1 = hasMaximizedPane ? (0, import_jsx_runtime3.jsx)(DocumentHeaderBreadcrumb, { paneDataItems, currentPaneIndex: index }) : documentTitle || (0, import_jsx_runtime3.jsx)("span", { style: {
  ...
  let t22;
  return $[21] !== t1 ? (t22 = (0, import_jsx_runtime3.jsx)(import_jsx_runtime3.Fragment, { children: t1 }), $[21] = t1, $[22] = t22) : t22 = $[22], t22;
}
function _temp$x(paneData) {
...
var FavoriteToggle = (t0) => {
  ...
  let t5;
  $[6] !== description ? (t5 = {
    content: (0, import_jsx_runtime3.jsx)(Text, { size: 1, children: description }),
    placement: "right"
  }, $[6] = description, $[7] = t5) : t5 = $[7];
  let t6;
  $[8] !== isFavorited ? (t6 = (0, import_jsx_runtime3.jsx)(Text, { size: 1, children: isFavorited ? (0, import_jsx_runtime3.jsx)(StarFilledIcon, {}) : (0, import_jsx_runtime3.jsx)(StarIcon, {}) }), $[8] = isFavorited, $[9] = t6) : t6 = $[9];
  let t7;
  return $[10] !== description || $[11] !== t3 || $[12] !== t4 || $[13] !== t5 || $[14] !== t6 ? (t7 = (0, import_jsx_runtime3.jsx)(Button2, { mode: "bleed", onClick: t3, disabled: t4, "aria-label": description, "aria-live": "assertive", tooltipProps: t5, children: t6 }), $[10] = description, $[11] = t3, $[12] = t4, $[13] = t5, $[14] = t6, $[15] = t7) : t7 = $[15], t7;
};
var DocumentPanelSubHeader = (0, import_react3.memo)(function() {
  const $ = (0, import_compiler_runtime2.c)(24), {
    editState,
    connectionState,
    views: views2,
  ...
  let t0;
  $[0] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t0 = (0, import_jsx_runtime3.jsx)(DocumentHeaderTitle, {}), $[0] = t0) : t0 = $[0];
  const title = t0;
  let t1;
  $[1] !== showTabs ? (t1 = showTabs && (0, import_jsx_runtime3.jsx)(DocumentHeaderTabs, {}), $[1] = showTabs, $[2] = t1) : t1 = $[2];
  const tabs = t1;
  let t22;
  $[3] !== BackLink2 || $[4] !== showBackButton || $[5] !== t2 ? (t22 = showBackButton && (0, import_jsx_runtime3.jsx)(Button2, { as: BackLink2, "data-as": "a", icon: ArrowLeftIcon, mode: "bleed", tooltipProps: {
  ...
  let t8;
  $[10] !== activeWorkspace.dataset || $[11] !== activeWorkspace.name || $[12] !== activeWorkspace.projectId || $[13] !== t3 || $[14] !== t4 || $[15] !== t6 || $[16] !== t7 ? (t8 = (0, import_jsx_runtime3.jsx)(CapabilityGate, { capability: "comlink", condition: "available", children: (0, import_jsx_runtime3.jsx)(FavoriteToggle, { resourceType: "studio", documentId: t3, documentType: t4, resourceId: t6, schemaName: activeWorkspace.name, projectId: activeWorkspace.projectId, dataset: activeWorkspace.dataset, documentExists: t7 }) }), $[10] = activeWorkspace.dataset, $[11] = activeWorkspace.name, $[12] = activeWorkspace.projectId, $[13] = t3, $[14] = t4, $[15] = t6, $[16] = t7, $[17] = t8) : t8 = $[17];
  const favoriteToggle = t8, t9 = connectionState === "connecting" && !editState?.draft && !editState?.published;
  let t10;
  return $[18] !== backButton || $[19] !== favoriteToggle || $[20] !== t9 || $[21] !== tabIndex || $[22] !== tabs ? (t10 = (0, import_jsx_runtime3.jsx)(PaneHeader$1, { loading: t9, title, tabs, tabIndex, backButton, appendTitle: favoriteToggle }), $[18] = backButton, $[19] = favoriteToggle, $[20] = t9, $[21] = tabIndex, $[22] = tabs, $[23] = t10) : t10 = $[23], t10;
});
var DocumentBox = at(Box)({
  position: "relative"
});
var Scroller$4 = at(ScrollContainer)(({
  $disabled
}) => $disabled ? {
  height: "100%"
} : rt`
...
var DocumentPanel = function(props) {
  const $ = (0, import_compiler_runtime2.c)(115), {
    footerHeight,
    headerHeight,
    isInspectOpen,
    rootElement,
  ...
  const showCreateBanner = t0, {
    ...
    features
  } = useStructureTool(), [_portalElement, setPortalElement] = (0, import_react3.useState)(null), [documentScrollElement, setDocumentScrollElement] = (0, import_react3.useState)(null), formContainerElement = (0, import_react3.useRef)(null), workspace = useWorkspace(), requiredPermission = value._createdAt ? "update" : "create";
  let t1;
  ...
  $[9] !== activeView.component || $[10] !== activeView.options || $[11] !== activeView.type || $[12] !== displayed || $[13] !== documentId || $[14] !== editState?.draft || $[15] !== editState?.published || $[16] !== schemaType || $[17] !== value ? (t3 = () => {
    if (activeView.type === "component" && activeView.component) {
      ...
      return (0, import_jsx_runtime3.jsx)(ActiveViewComponent, { document: {
  ...
  let t6;
  $[23] !== documentId || $[24] !== documentScrollElement ? (t6 = [documentId, documentScrollElement], $[23] = documentId, $[24] = documentScrollElement, $[25] = t6) : t6 = $[25], (0, import_react3.useEffect)(t5, t6);
  let t7, t8;
  $[26] !== portalElement || $[27] !== setDocumentPanelPortalElement ? (t7 = () => {
    portalElement && setDocumentPanelPortalElement(portalElement);
  }, t8 = [portalElement, setDocumentPanelPortalElement], $[26] = portalElement, $[27] = setDocumentPanelPortalElement, $[28] = t7, $[29] = t8) : (t7 = $[28], t8 = $[29]), (0, import_react3.useEffect)(t7, t8);
  let t9;
  $[30] !== displayed || $[31] !== isInspectOpen || $[32] !== value ? (t9 = isInspectOpen ? (0, import_jsx_runtime3.jsx)(InspectDialog, { value: displayed || value }) : null, $[30] = displayed, $[31] = isInspectOpen, $[32] = value, $[33] = t9) : t9 = $[33];
  ...
  bb1: {
    if (params?.historyVersion) {
      let t133;
      $[38] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t133 = (0, import_jsx_runtime3.jsx)(ArchivedReleaseDocumentBanner, {}), $[38] = t133) : t133 = $[38], t12 = t133;
      break bb1;
    }
    let t132;
    ...
    if ($[41] !== editState || $[42] !== schemaType || $[43] !== selectedPerspective || $[44] !== workspace.document.drafts.enabled ? (isSelectedPerspectiveWriteable = isPerspectiveWriteable({
      ...
      let t153;
      $[47] !== isSelectedPerspectiveWriteable.reason || $[48] !== isSelectedPerspectiveWriteable.result || $[49] !== schemaType || $[50] !== selectedPerspective ? (t153 = !isSelectedPerspectiveWriteable.result && (0, import_jsx_runtime3.jsx)(ChooseNewDocumentDestinationBanner, { schemaType, selectedPerspective, reason: isSelectedPerspectiveWriteable.reason }), $[47] = isSelectedPerspectiveWriteable.reason, $[48] = isSelectedPerspectiveWriteable.result, $[49] = schemaType, $[50] = selectedPerspective, $[51] = t153) : t153 = $[51], t12 = t153;
      break bb1;
    }
    if (isPausedDraft && displayed?._id) {
      let t153;
      $[52] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t153 = (0, import_jsx_runtime3.jsx)(PausedScheduledDraftBanner, {}), $[52] = t153) : t153 = $[52], t12 = t153;
      break bb1;
    }
    if (documentInScheduledRelease) {
      const t153 = selectedPerspective;
      let t163;
      $[53] !== t153 ? (t163 = (0, import_jsx_runtime3.jsx)(ScheduledReleaseBanner, { currentRelease: t153 }), $[53] = t153, $[54] = t163) : t163 = $[54], t12 = t163;
      break bb1;
    }
    let t152;
    $[55] !== filteredReleases.currentReleases || $[56] !== filteredReleases.notCurrentReleases ? (t152 = [...filteredReleases.currentReleases, ...filteredReleases.notCurrentReleases].find(_temp$w), $[55] = filteredReleases.currentReleases, $[56] = filteredReleases.notCurrentReleases, $[57] = t152) : t152 = $[57];
    ...
    if (selectedPerspective === "drafts" && scheduledCardinalityOneRelease && displayedIsDraft) {
      let t163;
      $[58] !== displayed || $[59] !== scheduledCardinalityOneRelease._id ? (t163 = (0, import_jsx_runtime3.jsx)(ScheduledDraftOverrideBanner, { releaseId: scheduledCardinalityOneRelease._id, draftDocument: displayed }), $[58] = displayed, $[59] = scheduledCardinalityOneRelease._id, $[60] = t163) : t163 = $[60], t12 = t163;
      break bb1;
    }
    let t162;
    $[61] !== selectedPerspective ? (t162 = isSystemBundle(selectedPerspective), $[61] = selectedPerspective, $[62] = t162) : t162 = $[62];
    ...
    if (!isSystemBundle(selectedPerspective) && displayed?._id && getVersionFromId(displayed._id) !== selectedPerspectiveName && ready && !isPinnedDraftOrPublish && isNewDocument(editState) === false && !isCurrentVersionGoingToUnpublish) {
      let t172;
      $[63] !== isScheduledRelease || $[64] !== selectedPerspective || $[65] !== value._id ? (t172 = (0, import_jsx_runtime3.jsx)(DocumentNotInReleaseBanner, { documentId: value._id, currentRelease: selectedPerspective, isScheduledRelease }), $[63] = isScheduledRelease, $[64] = selectedPerspective, $[65] = value._id, $[66] = t172) : t172 = $[66], t12 = t172;
      break bb1;
    }
    ...
    if (activeView.type === "form" && !selectedReleaseId && displayedHasObsoleteDraft.result) {
      if (displayedHasObsoleteDraft.reason === "DRAFT_MODEL_INACTIVE") {
        let t172;
        $[67] !== displayed || $[68] !== documentId || $[69] !== schemaType ? (t172 = (0, import_jsx_runtime3.jsx)(ObsoleteDraftBanner, { displayed, documentId, schemaType, i18nKey: "banners.obsolete-draft.draft-model-inactive.text" }), $[67] = displayed, $[68] = documentId, $[69] = schemaType, $[70] = t172) : t172 = $[70], t12 = t172;
        break bb1;
      }
      if (displayedHasObsoleteDraft.reason === "LIVE_EDIT_ACTIVE") {
        let t172;
        $[71] !== displayed || $[72] !== documentId || $[73] !== schemaType ? (t172 = (0, import_jsx_runtime3.jsx)(ObsoleteDraftBanner, { displayed, documentId, schemaType, i18nKey: "banners.live-edit-draft-banner.text", isEditBlocking: true }), $[71] = displayed, $[72] = documentId, $[73] = schemaType, $[74] = t172) : t172 = $[74], t12 = t172;
        break bb1;
      }
    }
    ...
    let t17;
    $[75] !== showCreateBanner ? (t17 = showCreateBanner && (0, import_jsx_runtime3.jsx)(CreateLinkedBanner, {}), $[75] = showCreateBanner, $[76] = t17) : t17 = $[76];
    let t18;
    $[77] !== permissions?.granted || $[78] !== requiredPermission ? (t18 = !permissions?.granted && (0, import_jsx_runtime3.jsx)(InsufficientPermissionBanner, { requiredPermission }), $[77] = permissions?.granted, $[78] = requiredPermission, $[79] = t18) : t18 = $[79];
    let t19, t20, t21, t22, t23, t24;
    $[80] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t19 = (0, import_jsx_runtime3.jsx)(RevisionNotFoundBanner, {}), t20 = (0, import_jsx_runtime3.jsx)(ReferenceChangedBanner, {}), t21 = (0, import_jsx_runtime3.jsx)(DeprecatedDocumentTypeBanner, {}), t22 = (0, import_jsx_runtime3.jsx)(CanvasLinkedBanner, {}), t23 = (0, import_jsx_runtime3.jsx)(DeletedDocumentBanners, {}), t24 = (0, import_jsx_runtime3.jsx)(UnpublishedDocumentBanner, {}), $[80] = t19, $[81] = t20, $[82] = t21, $[83] = t22, $[84] = t23, $[85] = t24) : (t19 = $[80], t20 = $[81], t21 = $[82], t22 = $[83], t23 = $[84], t24 = $[85]);
    const t25 = displayed?._id ?? documentId;
    let t26;
    $[86] !== isPinnedDraftOrPublish || $[87] !== t25 ? (t26 = (0, import_jsx_runtime3.jsx)(OpenReleaseToEditBanner, { documentId: t25, isPinnedDraftOrPublished: isPinnedDraftOrPublish }), $[86] = isPinnedDraftOrPublish, $[87] = t25, $[88] = t26) : t26 = $[88];
    let t27;
    $[89] !== t17 || $[90] !== t18 || $[91] !== t26 ? (t27 = (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
      t17,
      t18,
      t19,
      t20,
      ...
      t24,
      t26
    ] }), $[89] = t17, $[90] = t18, $[91] = t26, $[92] = t27) : t27 = $[92], t12 = t27;
  }
  const banners = t12;
  let t13;
  $[93] !== documentScrollElement ? (t13 = {
    documentScrollElement
  }, $[93] = documentScrollElement, $[94] = t13) : t13 = $[94];
  const portalElements = t13, showFormView = features.resizablePanes || !showInspector;
  let t14;
  $[95] !== activeViewNode || $[96] !== banners || $[97] !== documentScrollElement || $[98] !== footer || $[99] !== formViewHidden || $[100] !== inspectDialog || $[101] !== layoutCollapsed || $[102] !== margins || $[103] !== portalElement || $[104] !== portalElements || $[105] !== showFormView ? (t14 = showFormView && (0, import_jsx_runtime3.jsxs)(Flex, { height: "fill", direction: "column", width: "fill", flex: 2, children: [
    (0, import_jsx_runtime3.jsxs)(LegacyLayerProvider, { zOffset: "paneHeader", children: [
      banners,
      (0, import_jsx_runtime3.jsx)(DocumentPanelSubHeader, {})
    ] }),
    (0, import_jsx_runtime3.jsx)(DocumentBox, { flex: 2, children: (0, import_jsx_runtime3.jsx)(PortalProvider, { element: portalElement, __unstable_elements: portalElements, children: (0, import_jsx_runtime3.jsx)(BoundaryElementProvider, { element: documentScrollElement, children: (0, import_jsx_runtime3.jsxs)(VirtualizerScrollInstanceProvider, { scrollElement: documentScrollElement, containerElement: formContainerElement, children: [
      (0, import_jsx_runtime3.jsxs)(Scroller$4, { $disabled: layoutCollapsed || false, "data-testid": "document-panel-scroller", ref: setDocumentScrollElement, children: [
        (0, import_jsx_runtime3.jsx)(FormView, { hidden: formViewHidden, margins, ref: formContainerElement }),
        activeViewNode
      ] }),
      inspectDialog,
      (0, import_jsx_runtime3.jsx)("div", { "data-testid": "document-panel-portal", ref: setPortalElement })
    ] }) }) }) }),
    footer
  ] }), $[95] = activeViewNode, $[96] = banners, $[97] = documentScrollElement, $[98] = footer, $[99] = formViewHidden, $[100] = inspectDialog, $[101] = layoutCollapsed, $[102] = margins, $[103] = portalElement, $[104] = portalElements, $[105] = showFormView, $[106] = t14) : t14 = $[106];
  let t15;
  $[107] !== documentId || $[108] !== rootElement || $[109] !== schemaType || $[110] !== showInspector ? (t15 = showInspector && (0, import_jsx_runtime3.jsx)(BoundaryElementProvider, { element: rootElement, children: (0, import_jsx_runtime3.jsx)(DocumentInspectorPanel, { documentId, documentType: schemaType.name, flex: 1 }) }), $[107] = documentId, $[108] = rootElement, $[109] = schemaType, $[110] = showInspector, $[111] = t15) : t15 = $[111];
  let t16;
  return $[112] !== t14 || $[113] !== t15 ? (t16 = (0, import_jsx_runtime3.jsx)(PaneContent, { children: (0, import_jsx_runtime3.jsxs)(Flex, { height: "fill", children: [
    t14,
    t15
  ] }) }), $[112] = t14, $[113] = t15, $[114] = t16) : t16 = $[114], t16;
};
DocumentPanel.displayName = "DocumentPanel";
function _temp$w(release) {
...
var useHistoryRestoreAction = (t0) => {
  const $ = (0, import_compiler_runtime2.c)(26), {
    ...
    restore
  } = useDocumentOperation(id2, type2, release), {
    revisionNotFound
  } = useDocumentPane(), event = useDocumentOperationEvent(id2, type2), {
    navigateIntent
  } = useRouter(), prevEvent = (0, import_react3.useRef)(event), [isConfirmDialogOpen, setConfirmDialogOpen] = (0, import_react3.useState)(false), {
    t: t2
  } = useTranslation(structureLocaleNamespace);
  let t1;
  ...
  let t3, t4;
  $[4] !== event || $[5] !== id2 || $[6] !== navigateIntent || $[7] !== type2 ? (t3 = () => {
    !event || event === prevEvent.current || (event.type === "success" && event.op === "restore" && navigateIntent("edit", {
      id: id2,
      type: type2
    }), prevEvent.current = event);
  }, t4 = [event, id2, navigateIntent, type2], $[4] = event, $[5] = id2, $[6] = navigateIntent, $[7] = type2, $[8] = t3, $[9] = t4) : (t3 = $[8], t4 = $[9]), (0, import_react3.useEffect)(t3, t4);
  let t5;
...
function ConfirmDialog(props) {
  ...
  let t22;
  return $[6] !== cancelButtonIcon || $[7] !== confirmButtonIcon || $[8] !== message || $[9] !== onCancel || $[10] !== onConfirm || $[11] !== referenceElement || $[12] !== t0 || $[13] !== t1 || $[14] !== tone ? (t22 = (0, import_jsx_runtime3.jsx)(ConfirmPopover, { cancelButtonIcon, cancelButtonText: t0, confirmButtonIcon, confirmButtonText: t1, message, onCancel, onConfirm, open: true, referenceElement, tone, placement: "top", fallbackPlacements: POPOVER_FALLBACK_PLACEMENTS }), $[6] = cancelButtonIcon, $[7] = confirmButtonIcon, $[8] = message, $[9] = onCancel, $[10] = onConfirm, $[11] = referenceElement, $[12] = t0, $[13] = t1, $[14] = tone, $[15] = t22) : t22 = $[15], t22;
}
function ModalDialog(props) {
  const $ = (0, import_compiler_runtime2.c)(12), {
    dialog
  } = props, dialogId = (0, import_react3.useId)();
  let t0;
  $[0] !== dialog.footer ? (t0 = dialog.footer && (0, import_jsx_runtime3.jsx)(Box, { paddingX: 4, paddingY: 3, children: dialog.footer }), $[0] = dialog.footer, $[1] = t0) : t0 = $[1];
  const footer = t0, t1 = dialog.showCloseButton === false, t2 = dialog.width === void 0 ? 1 : DIALOG_WIDTH_TO_UI_WIDTH[dialog.width];
  let t3;
  $[2] !== dialog.content ? (t3 = (0, import_jsx_runtime3.jsx)(Box, { padding: 4, children: dialog.content }), $[2] = dialog.content, $[3] = t3) : t3 = $[3];
  let t4;
  return $[4] !== dialog.header || $[5] !== dialog.onClose || $[6] !== dialogId || $[7] !== footer || $[8] !== t1 || $[9] !== t2 || $[10] !== t3 ? (t4 = (0, import_jsx_runtime3.jsx)(LegacyLayerProvider, { zOffset: "fullscreen", children: (0, import_jsx_runtime3.jsx)(Dialog, { animate: true, __unstable_hideCloseButton: t1, footer, header: dialog.header, id: dialogId, onClose: dialog.onClose, onClickOutside: dialog.onClose, width: t2, children: t3 }) }), $[4] = dialog.header, $[5] = dialog.onClose, $[6] = dialogId, $[7] = footer, $[8] = t1, $[9] = t2, $[10] = t3, $[11] = t4) : t4 = $[11], t4;
}
function PopoverDialog(props) {
  ...
  let t0;
  $[0] !== dialog ? (t0 = (0, import_jsx_runtime3.jsx)(PopoverDialogContent, { dialog }), $[0] = dialog, $[1] = t0) : t0 = $[1];
  let t1;
  return $[2] !== referenceElement || $[3] !== t0 ? (t1 = (0, import_jsx_runtime3.jsx)(Popover, { content: t0, fallbackPlacements: POPOVER_FALLBACK_PLACEMENTS, open: true, placement: "top", portal: true, preventOverflow: true, referenceElement }), $[2] = referenceElement, $[3] = t0, $[4] = t1) : t1 = $[4], t1;
}
function PopoverDialogContent(props) {
  const $ = (0, import_compiler_runtime2.c)(6), {
    ...
    isTopLayer
  } = useLayer(), ref = (0, import_react3.useRef)(null);
  let t0;
  ...
  let t2;
  return $[4] !== content ? (t2 = (0, import_jsx_runtime3.jsx)("div", { ref, children: content }), $[4] = content, $[5] = t2) : t2 = $[5], t2;
}
function DocumentActionPortalProvider(props) {
  ...
  let t0;
  return $[0] !== children || $[1] !== portalElement ? (t0 = (0, import_jsx_runtime3.jsx)(PortalProvider, { element: portalElement, children }), $[0] = children, $[1] = portalElement, $[2] = t0) : t0 = $[2], t0;
}
function ActionStateDialog(props) {
  const $ = (0, import_compiler_runtime2.c)(17), {
    dialog,
    referenceElement: t0
  } = props, referenceElement = t0 === void 0 ? null : t0, modalId = (0, import_react3.useId)();
  if (dialog.type === "confirm") {
    let t12;
    return $[0] !== dialog || $[1] !== referenceElement ? (t12 = (0, import_jsx_runtime3.jsx)(ConfirmDialog, { dialog, referenceElement }), $[0] = dialog, $[1] = referenceElement, $[2] = t12) : t12 = $[2], t12;
  }
  if (dialog.type === "popover") {
    let t12;
    return $[3] !== dialog || $[4] !== referenceElement ? (t12 = (0, import_jsx_runtime3.jsx)(PopoverDialog, { dialog, referenceElement }), $[3] = dialog, $[4] = referenceElement, $[5] = t12) : t12 = $[5], t12;
  }
  if (dialog.type === "dialog" || !dialog.type) {
    let t12;
    return $[6] !== dialog ? (t12 = (0, import_jsx_runtime3.jsx)(DocumentActionPortalProvider, { children: (0, import_jsx_runtime3.jsx)(ModalDialog, { dialog }) }), $[6] = dialog, $[7] = t12) : t12 = $[7], t12;
  }
  if (dialog.type === "custom") {
    const t12 = dialog?.component;
    let t22;
    return $[8] !== t12 ? (t22 = (0, import_jsx_runtime3.jsx)(DocumentActionPortalProvider, { children: t12 }), $[8] = t12, $[9] = t22) : t22 = $[9], t22;
  }
  const unknownModal = dialog;
  console.warn(`Unsupported modal type ${unknownModal.type}`);
  let t1;
  $[10] !== unknownModal.content || $[11] !== unknownModal.type ? (t1 = unknownModal.content || (0, import_jsx_runtime3.jsxs)(Text, { size: 1, children: [
    "Unexpected modal type (",
    (0, import_jsx_runtime3.jsx)("code", { children: unknownModal.type }),
    ")"
  ] }), $[10] = unknownModal.content, $[11] = unknownModal.type, $[12] = t1) : t1 = $[12];
  let t2;
  return $[13] !== modalId || $[14] !== t1 || $[15] !== unknownModal.onClose ? (t2 = (0, import_jsx_runtime3.jsx)(Dialog2, { id: modalId, onClose: unknownModal.onClose, onClickOutside: unknownModal.onClose, width: 1, children: t1 }), $[13] = modalId, $[14] = t1, $[15] = unknownModal.onClose, $[16] = t2) : t2 = $[16], t2;
}
var ActionDialogWrapper = (0, import_react3.memo)(function(t0) {
  const $ = (0, import_compiler_runtime2.c)(9), {
    actionStates,
    children,
    referenceElement
  } = t0, [actionIndex, setActionIndex] = (0, import_react3.useState)(-1), currentAction = actionStates[actionIndex];
  let t1;
  ...
  const result = t2;
  let t3;
  $[3] !== currentAction || $[4] !== referenceElement ? (t3 = currentAction && currentAction.dialog && (0, import_jsx_runtime3.jsx)(LegacyLayerProvider, { zOffset: "paneFooter", children: (0, import_jsx_runtime3.jsx)(ActionStateDialog, { dialog: currentAction.dialog, referenceElement }) }), $[3] = currentAction, $[4] = referenceElement, $[5] = t3) : t3 = $[5];
  let t4;
  return $[6] !== result || $[7] !== t3 ? (t4 = (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
    t3,
    result
...
function ActionMenuButton(props) {
  const $ = (0, import_compiler_runtime2.c)(10), {
    actionStates,
    disabled
  } = props, idPrefix = (0, import_react3.useId)(), [referenceElement, setReferenceElement] = (0, import_react3.useState)(null);
  let t0;
  $[0] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t0 = {
    placement: "top-end",
    portal: true,
  ...
  $[1] !== actionStates || $[2] !== disabled || $[3] !== idPrefix || $[4] !== t2 ? (t1 = (t222) => {
    ...
    return (0, import_jsx_runtime3.jsx)(MenuButton, { id: `${idPrefix}-action-menu`, button: (0, import_jsx_runtime3.jsx)(ContextMenuButton, { "aria-label": t2("buttons.action-menu-button.aria-label"), disabled, "data-testid": "action-menu-button", tooltipProps: {
      content: t2("buttons.action-menu-button.tooltip")
    } }), menu: (0, import_jsx_runtime3.jsx)(Menu, { padding: 1, children: actionStates.map((actionState, idx) => (0, import_jsx_runtime3.jsx)(ActionMenuListItem, { actionState, disabled, index: idx, onAction: handleAction }, idx)) }), popover: popoverProps, ref: setReferenceElement });
  }, $[1] = actionStates, $[2] = disabled, $[3] = idPrefix, $[4] = t2, $[5] = t1) : t1 = $[5];
  const renderActionDialog = t1;
  let t22;
  return $[6] !== actionStates || $[7] !== referenceElement || $[8] !== renderActionDialog ? (t22 = (0, import_jsx_runtime3.jsx)(ActionDialogWrapper, { actionStates, referenceElement, children: renderActionDialog }), $[6] = actionStates, $[7] = referenceElement, $[8] = renderActionDialog, $[9] = t22) : t22 = $[9], t22;
}
...
function useChipScrollPosition(containerRef) {
  ...
  }, t1 = [containerRef], $[0] = containerRef, $[1] = t0, $[2] = t1) : (t0 = $[1], t1 = $[2]), (0, import_react3.useEffect)(t0, t1), showGradient;
}
function NonReleaseVersionsSelect(props) {
  const $ = (0, import_compiler_runtime2.c)(43), {
    ...
    t: t2
  } = useTranslation(), [nonReleaseDropdownOpen, setNonReleaseDropdownOpen] = (0, import_react3.useState)(false), [popoverReferenceElement, setPopoverReferenceElement] = (0, import_react3.useState)(null);
  let t0;
  ...
  const [selectedNonReleaseVersion, otherNonReleaseVersions] = t1, popoverRef = (0, import_react3.useRef)(null);
  let t22, t3;
  ...
  $[7] !== documentType || $[8] !== onCopyToDraftsNavigate || $[9] !== onSelectBundle || $[10] !== releases || $[11] !== releasesLoading || $[12] !== selectedNonReleaseVersion ? (t4 = selectedNonReleaseVersion && (() => {
    ...
    return (0, import_jsx_runtime3.jsx)(VersionChip$1, { selected: true, text: bundleId, tone: "default", onClick: () => onSelectBundle(bundleId), onCopyToDraftsNavigate, contextValues: {
  ...
  let t5;
  $[14] !== nonReleaseDropdownOpen || $[15] !== otherNonReleaseVersions.length || $[16] !== t2 ? (t5 = otherNonReleaseVersions.length > 0 ? (0, import_jsx_runtime3.jsx)(Tooltip, { content: t2("release.chip.tooltip.other-versions", {
    count: otherNonReleaseVersions.length
  }), fallbackPlacements: [], portal: true, placement: nonReleaseDropdownOpen ? "top" : "bottom", children: (0, import_jsx_runtime3.jsx)(Chip, { mode: "bleed", fontSize: 1, muted: true, selected: nonReleaseDropdownOpen, iconRight: nonReleaseDropdownOpen ? ChevronUpIcon : ChevronDownIcon, ref: setPopoverReferenceElement, onClick: () => setNonReleaseDropdownOpen(_temp$u), text: t2("release.chip.button.other-versions", {
    count: otherNonReleaseVersions.length
  ...
  if ($[18] !== documentType || $[19] !== onCopyToDraftsNavigate || $[20] !== onSelectBundle || $[21] !== otherNonReleaseVersions || $[22] !== releases || $[23] !== releasesLoading || $[24] !== selectedPerspective) {
    ...
    $[26] !== documentType || $[27] !== onCopyToDraftsNavigate || $[28] !== onSelectBundle || $[29] !== releases || $[30] !== releasesLoading || $[31] !== selectedPerspective ? (t72 = (nonReleaseVersionId) => {
      ...
      return (0, import_jsx_runtime3.jsx)(VersionChip$1, { selected: selectedPerspective === bundle, text: bundle, disabled: false, contextMenuPortal: false, tone: "default", onClick: () => onSelectBundle(bundle), onCopyToDraftsNavigate, contextValues: {
    ...
    t6 = $[25];
  let t7;
  $[33] !== t6 ? (t7 = (0, import_jsx_runtime3.jsx)(Container, { width: 1, children: (0, import_jsx_runtime3.jsx)(Flex, { width: 1, padding: 3, gap: 2, wrap: "wrap", children: t6 }) }), $[33] = t6, $[34] = t7) : t7 = $[34];
  let t8;
  $[35] !== nonReleaseDropdownOpen || $[36] !== popoverReferenceElement || $[37] !== t7 ? (t8 = (0, import_jsx_runtime3.jsx)(Popover2, { animate: false, open: nonReleaseDropdownOpen, portal: true, arrow: true, ref: popoverRef, placement: "bottom", referenceElement: popoverReferenceElement, zOffset: 10, content: t7 }), $[35] = nonReleaseDropdownOpen, $[36] = popoverReferenceElement, $[37] = t7, $[38] = t8) : t8 = $[38];
  let t9;
  return $[39] !== t4 || $[40] !== t5 || $[41] !== t8 ? (t9 = (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
    t4,
    t5,
    t8
...
var TooltipContent$1 = (t0) => {
  ...
  if (release.state === "archived") {
    ...
    let t22;
    return $[2] !== t1 ? (t22 = (0, import_jsx_runtime3.jsx)(Text, { size: 1, children: t1 }), $[2] = t1, $[3] = t22) : t22 = $[3], t22;
  }
  if (release.metadata.releaseType === "asap") {
    let t1;
    $[4] !== t2 ? (t1 = t2("release.type.asap"), $[4] = t2, $[5] = t1) : t1 = $[5];
    let t22;
    return $[6] !== t1 ? (t22 = (0, import_jsx_runtime3.jsx)(Text, { size: 1, children: t1 }), $[6] = t1, $[7] = t22) : t22 = $[7], t22;
  }
  if (release.metadata.releaseType === "scheduled") {
    const isActive = release.state === "active";
    let t1;
    return $[8] !== isActive || $[9] !== release || $[10] !== t2 ? (t1 = release.metadata.intendedPublishAt && (0, import_jsx_runtime3.jsx)(Text, { size: 1, children: isActive ? (0, import_jsx_runtime3.jsx)(Translate, { t: t2, i18nKey: "release.chip.tooltip.intended-for-date", values: {
      date: formatRelativeLocalePublishDate(release)
    } }) : (0, import_jsx_runtime3.jsx)(Translate, { t: t2, i18nKey: "release.chip.tooltip.scheduled-for-date", values: {
      date: formatRelativeLocalePublishDate(release)
  ...
  if (release.metadata.releaseType === "undecided") {
    ...
    let t22;
    return $[14] !== t1 ? (t22 = (0, import_jsx_runtime3.jsx)(Text, { size: 1, children: t1 }), $[14] = t1, $[15] = t22) : t22 = $[15], t22;
  }
  return null;
};
...
var DocumentPerspectiveList = (0, import_react3.memo)(function() {
  ...
  let t13;
  $[42] !== dateTimeFormat || $[43] !== editState?.published || $[44] !== t2 ? (t13 = (0, import_jsx_runtime3.jsx)(Text, { size: 1, children: editState?.published && editState?.published?._updatedAt ? (0, import_jsx_runtime3.jsx)(Translate, { t: t2, i18nKey: "release.chip.tooltip.published-date", values: {
    date: dateTimeFormat.format(new Date(editState?.published._updatedAt))
  } }) : (0, import_jsx_runtime3.jsx)(import_jsx_runtime3.Fragment, { children: t2("release.chip.tooltip.not-published") }) }), $[42] = dateTimeFormat, $[43] = editState?.published, $[44] = t2, $[45] = t13) : t13 = $[45];
  let t14;
  ...
  let t19;
  $[56] !== handleCopyToDraftsNavigate || $[57] !== isPublishSelected || $[58] !== isPublishedChipDisabled || $[59] !== t13 || $[60] !== t14 || $[61] !== t15 || $[62] !== t18 ? (t19 = (0, import_jsx_runtime3.jsx)(VersionChip$1, { tooltipContent: t13, disabled: isPublishedChipDisabled, onClick: t14, selected: isPublishSelected, text: t15, tone: "positive", onCopyToDraftsNavigate: handleCopyToDraftsNavigate, contextValues: t18 }), $[56] = handleCopyToDraftsNavigate, $[57] = isPublishSelected, $[58] = isPublishedChipDisabled, $[59] = t13, $[60] = t14, $[61] = t15, $[62] = t18, $[63] = t19) : t19 = $[63];
  let t20;
  $[64] !== dateTimeFormat || $[65] !== documentType || $[66] !== editState?.draft || $[67] !== editState?.id || $[68] !== editState?.published?._id || $[69] !== filteredReleases.notCurrentReleases || $[70] !== handleCopyToDraftsNavigate || $[71] !== handlePerspectiveChange || $[72] !== isDraftDisabled || $[73] !== isDraftModelEnabled || $[74] !== isDraftSelected || $[75] !== isLiveEdit || $[76] !== loading || $[77] !== t2 ? (t20 = isDraftModelEnabled && (0, import_jsx_runtime3.jsx)(VersionChip$1, { tooltipContent: (0, import_jsx_runtime3.jsx)(Text, { size: 1, children: editState?.draft ? (0, import_jsx_runtime3.jsx)(import_jsx_runtime3.Fragment, { children: editState?.draft._updatedAt ? (0, import_jsx_runtime3.jsx)(Translate, { t: t2, i18nKey: "release.chip.tooltip.edited-date", values: {
    date: dateTimeFormat.format(new Date(editState?.draft._updatedAt))
  } }) : (0, import_jsx_runtime3.jsx)(Translate, { t: t2, i18nKey: "release.chip.tooltip.created-date", values: {
    date: dateTimeFormat.format(new Date(editState?.draft._createdAt))
  } }) }) : (0, import_jsx_runtime3.jsx)(import_jsx_runtime3.Fragment, { children: t2(isLiveEdit ? "release.chip.tooltip.draft-disabled.live-edit" : "release.chip.tooltip.no-edits") }) }), selected: isDraftSelected, disabled: isDraftDisabled, text: t2("release.chip.draft"), tone: editState?.draft ? "caution" : "neutral", onClick: () => handlePerspectiveChange("drafts"), onCopyToDraftsNavigate: handleCopyToDraftsNavigate, contextValues: {
  ...
  let t23;
  $[98] !== documentType || $[99] !== filteredReleases.notCurrentReleases || $[100] !== handleCopyToDraftsNavigate || $[101] !== handlePerspectiveChange || $[102] !== loading || $[103] !== nonReleaseVersions || $[104] !== selectedPerspectiveName ? (t23 = (0, import_jsx_runtime3.jsx)(NonReleaseVersionsSelect, { nonReleaseVersions, selectedPerspective: selectedPerspectiveName, onSelectBundle: handlePerspectiveChange, onCopyToDraftsNavigate: handleCopyToDraftsNavigate, releases: filteredReleases.notCurrentReleases, releasesLoading: loading, documentType }), $[98] = documentType, $[99] = filteredReleases.notCurrentReleases, $[100] = handleCopyToDraftsNavigate, $[101] = handlePerspectiveChange, $[102] = loading, $[103] = nonReleaseVersions, $[104] = selectedPerspectiveName, $[105] = t23) : t23 = $[105];
  let t24;
  return $[106] !== t19 || $[107] !== t20 || $[108] !== t21 || $[109] !== t222 || $[110] !== t23 ? (t24 = (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
    t19,
    t20,
    t21,
    t222,
...
var HorizontalScroller = at(Card)((props) => {
...
var DocumentPanelHeader = (0, import_react3.memo)((0, import_react3.forwardRef)(function(_props, ref) {
  const $ = (0, import_compiler_runtime2.c)(41), {
    menuItems
  } = _props, {
    editState,
  ...
  } = useFieldActions(), [referenceElement, setReferenceElement] = (0, import_react3.useState)(null), scrollContainerRef = (0, import_react3.useRef)(null), showGradient = useChipScrollPosition(scrollContainerRef), telemetry = useTelemetry();
  let t0;
  ...
  let t4;
  $[13] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t4 = (0, import_jsx_runtime3.jsx)(DocumentHeaderTitle, {}), $[13] = t4) : t4 = $[13];
  const title = t4;
  let t5;
  $[14] !== BackLink2 || $[15] !== showBackButton || $[16] !== t3 ? (t5 = showBackButton && (0, import_jsx_runtime3.jsx)(Button2, { as: BackLink2, "data-as": "a", icon: ArrowLeftIcon, mode: "bleed", tooltipProps: {
    content: t3("pane-header.back-button.text")
  } }), $[14] = BackLink2, $[15] = showBackButton, $[16] = t3, $[17] = t5) : t5 = $[17];
  const backButton = t5;
  let t6;
  return $[18] !== BackLink2 || $[19] !== backButton || $[20] !== collapsed || $[21] !== connectionState || $[22] !== contextMenuNodes || $[23] !== editState || $[24] !== handleFocusPane || $[25] !== isMaximizedPane || $[26] !== menuButtonNodes || $[27] !== onPaneClose || $[28] !== onPaneSplit || $[29] !== onSetMaximizedPane || $[30] !== ref || $[31] !== referenceElement || $[32] !== schemaType || $[33] !== showGradient || $[34] !== showPaneGroupCloseButton || $[35] !== showSplitPaneButton || $[36] !== showSplitPaneCloseButton || $[37] !== t3 || $[38] !== tabIndex || $[39] !== unstable_languageFilter ? (t6 = (0, import_jsx_runtime3.jsx)(TooltipDelayGroupProvider, { children: collapsed ? (0, import_jsx_runtime3.jsx)(PaneHeader$1, { border: true, ref, loading: connectionState === "connecting" && !editState?.draft && !editState?.published, title, tabIndex, backButton }) : (0, import_jsx_runtime3.jsx)(Card, { hidden: collapsed, style: {
    lineHeight: 0
  }, borderBottom: true, children: (0, import_jsx_runtime3.jsxs)(Flex, { gap: 3, paddingY: 3, children: [
    (0, import_jsx_runtime3.jsx)(HorizontalScroller, { $showGradient: showGradient, children: (0, import_jsx_runtime3.jsx)(Flex, { flex: 1, gap: 1, overflow: "auto", paddingX: 3, "data-testid": "document-perspective-list", ref: scrollContainerRef, children: (0, import_jsx_runtime3.jsx)(DocumentPerspectiveList, {}) }) }),
    (0, import_jsx_runtime3.jsx)(Box, { flex: "none", paddingRight: 3, children: (0, import_jsx_runtime3.jsxs)(Flex, { align: "center", gap: 1, children: [
      unstable_languageFilter.length > 0 && (0, import_jsx_runtime3.jsx)(import_jsx_runtime3.Fragment, { children: unstable_languageFilter.map((LanguageFilterComponent, idx) => (0, import_jsx_runtime3.jsx)(LanguageFilterComponent, { schemaType }, `language-filter-${idx}`)) }),
      menuButtonNodes.map(_temp$s),
      editState && (0, import_jsx_runtime3.jsx)(RenderActionCollectionState, { group: "paneActions", children: (t7) => {
        const {
          states
        } = t7;
        return (0, import_jsx_runtime3.jsx)(DocumentPanelHeaderActionDialogDeferred, { contextMenuNodes, setReferenceElement, referenceElement, states });
      } }),
      showSplitPaneButton && (0, import_jsx_runtime3.jsx)(Button2, { "aria-label": t3("buttons.split-pane-button.aria-label"), icon: SplitVerticalIcon, mode: "bleed", onClick: onPaneSplit, tooltipProps: {
        content: t3("buttons.split-pane-button.tooltip")
      } }, "split-pane-button"),
      onSetMaximizedPane && (0, import_jsx_runtime3.jsx)(Button2, { "aria-label": t3(isMaximizedPane ? "buttons.focus-pane-button.aria-label.collapse" : "buttons.focus-pane-button.aria-label.focus"), icon: isMaximizedPane ? CollapseIcon : ExpandIcon, mode: "bleed", onClick: handleFocusPane, tooltipProps: {
      ...
      showSplitPaneCloseButton && (0, import_jsx_runtime3.jsx)(Button2, { icon: CloseIcon, mode: "bleed", onClick: onPaneClose, tooltipProps: {
        content: t3("buttons.split-pane-close-button.title")
      } }, "close-view-button"),
      showPaneGroupCloseButton && (0, import_jsx_runtime3.jsx)(Button2, { icon: CloseIcon, mode: "bleed", tooltipProps: {
...
var DocumentPanelHeaderActionDialogDeferred = (0, import_react3.memo)(function(props) {
  const $ = (0, import_compiler_runtime2.c)(7), {
    setReferenceElement,
    referenceElement,
    contextMenuNodes
  } = props, states = (0, import_react3.useDeferredValue)(props.states);
  let t0;
  $[0] !== states ? (t0 = states.filter(_temp2$d), $[0] = states, $[1] = t0) : t0 = $[1];
  let t1;
  return $[2] !== contextMenuNodes || $[3] !== referenceElement || $[4] !== setReferenceElement || $[5] !== t0 ? (t1 = (0, import_jsx_runtime3.jsx)(DocumentPanelHeaderActionDialog, { setReferenceElement, referenceElement, contextMenuNodes, states: t0 }), $[2] = contextMenuNodes, $[3] = referenceElement, $[4] = setReferenceElement, $[5] = t0, $[6] = t1) : t1 = $[6], t1;
});
var DocumentPanelHeaderActionDialog = (0, import_react3.memo)(function(props) {
  const $ = (0, import_compiler_runtime2.c)(8), {
    states,
    setReferenceElement,
    contextMenuNodes,
  ...
  $[0] !== contextMenuNodes || $[1] !== setReferenceElement || $[2] !== states ? (t0 = (t12) => {
    ...
    return (0, import_jsx_runtime3.jsx)("div", { ref: setReferenceElement, children: (0, import_jsx_runtime3.jsx)(PaneContextMenuButton, { nodes: contextMenuNodes, actionsNodes: states.length > 0 ? states.map((actionState, actionIndex) => (0, import_jsx_runtime3.jsx)(ActionMenuListItem, { actionState, disabled: !!actionState.disabled, index: actionIndex, onAction: handleAction }, actionState.label)) : void 0 }, "context-menu") });
  }, $[0] = contextMenuNodes, $[1] = setReferenceElement, $[2] = states, $[3] = t0) : t0 = $[3];
  const renderActionDialog = t0;
  let t1;
  return $[4] !== referenceElement || $[5] !== renderActionDialog || $[6] !== states ? (t1 = (0, import_jsx_runtime3.jsx)(ActionDialogWrapper, { actionStates: states, referenceElement, children: renderActionDialog }), $[4] = referenceElement, $[5] = renderActionDialog, $[6] = states, $[7] = t1) : t1 = $[7], t1;
});
function _temp$s(item) {
  return (0, import_jsx_runtime3.jsx)(PaneHeaderActionButton, { node: item }, item.key);
}
...
function SpacerButton(t0) {
  ...
  let t2;
  return $[1] !== size ? (t2 = (0, import_jsx_runtime3.jsx)(Button2, { "aria-hidden": true, disabled: true, size, style: t1, text: "-" }), $[1] = size, $[2] = t2) : t2 = $[2], t2;
}
var BADGE_TONES = {
  primary: "primary",
  success: "positive",
...
var DocumentBadgesInner = (0, import_react3.memo)(function(t0) {
  const $ = (0, import_compiler_runtime2.c)(4), {
    states
  } = t0;
  if (states.length === 0)
  ...
  let t2;
  return $[2] !== t1 ? (t2 = (0, import_jsx_runtime3.jsx)(Inline, { space: 1, children: t1 }), $[2] = t1, $[3] = t2) : t2 = $[3], t2;
});
var DocumentBadgesDeferred = (0, import_react3.memo)(function(props) {
  const $ = (0, import_compiler_runtime2.c)(2), states = (0, import_react3.useDeferredValue)(props.states);
  let t0;
  return $[0] !== states ? (t0 = (0, import_jsx_runtime3.jsx)(DocumentBadgesInner, { states }), $[0] = states, $[1] = t0) : t0 = $[1], t0;
});
function DocumentBadges() {
  ...
  if (!editState || !badges)
    return null;
  let t0;
  return $[0] !== badges || $[1] !== editState ? (t0 = (0, import_jsx_runtime3.jsx)(RenderBadgeCollectionState, { badges, badgeProps: editState, children: renderDocumentBadges }), $[0] = badges, $[1] = editState, $[2] = t0) : t0 = $[2], t0;
}
function _temp2$c(t0) {
  const {
    states
  } = t0;
  return (0, import_jsx_runtime3.jsx)(DocumentBadgesDeferred, { states });
}
function _temp$r(badge, index) {
  return (0, import_jsx_runtime3.jsx)(Tooltip, { content: badge.title, disabled: !badge.title, placement: "top", portal: true, children: (0, import_jsx_runtime3.jsx)(Badge, { fontSize: 1, mode: "outline", paddingX: 2, paddingY: 1, radius: 4, tone: badge.color ? BADGE_TONES[badge.color] : void 0, style: {
    whiteSpace: "nowrap"
...
var useDeleteAction = (t0) => {
  ...
  const bundleId = t1, {
    delete: deleteOp
  } = useDocumentOperation(id2, type2, bundleId), [isDeleting, setIsDeleting] = (0, import_react3.useState)(false), [isConfirmDialogOpen, setConfirmDialogOpen] = (0, import_react3.useState)(false), {
    t: t2
  } = useTranslation(structureLocaleNamespace);
  let t22;
  $[2] !== id2 ? (t22 = {
  ...
  const handle = t6;
  let t7;
  $[10] !== bundleId || $[11] !== id2 || $[12] !== type2 ? (t7 = {
    id: id2,
    type: type2,
    version: bundleId,
    permission: "delete"
  }, $[10] = bundleId, $[11] = id2, $[12] = type2, $[13] = t7) : t7 = $[13];
  ...
  bb0: {
    if (!isPermissionsLoading && !permissions?.granted) {
      ...
      let t102;
      $[16] !== currentUser ? (t102 = (0, import_jsx_runtime3.jsx)(InsufficientPermissionsMessage, { context: "delete-document", currentUser }), $[16] = currentUser, $[17] = t102) : t102 = $[17];
      let t112;
      $[18] !== t102 || $[19] !== t92 ? (t112 = {
        tone: "critical",
        icon: TrashIcon,
    ...
    let t13;
    $[30] !== draft?._id || $[31] !== handleConfirm || $[32] !== id2 || $[33] !== isConfirmDialogOpen || $[34] !== type2 ? (t13 = isConfirmDialogOpen && {
      type: "custom",
      component: (0, import_jsx_runtime3.jsx)(ConfirmDeleteDialogContainer, { action: "delete", id: draft?._id || id2, type: type2, onCancel: handleCancel, onConfirm: handleConfirm })
    }, $[30] = draft?._id, $[31] = handleConfirm, $[32] = id2, $[33] = isConfirmDialogOpen, $[34] = type2, $[35] = t13) : t13 = $[35];
    let t14;
...
function ConfirmDiscardDialog(t0) {
  const $ = (0, import_compiler_runtime2.c)(18), {
    ...
    t: t2
  } = useTranslation(structureLocaleNamespace), dialogId = `deletion-confirmation-${(0, import_react3.useId)()}`;
  let t1;
  ...
  let t5;
  $[10] !== t4 ? (t5 = (0, import_jsx_runtime3.jsx)(Text, { size: 1, children: t4 }), $[10] = t4, $[11] = t5) : t5 = $[11];
  let t6;
  return $[12] !== dialogId || $[13] !== onCancel || $[14] !== t1 || $[15] !== t3 || $[16] !== t5 ? (t6 = (0, import_jsx_runtime3.jsx)(Dialog2, { width: 1, id: dialogId, header: t1, footer: t3, onClose: onCancel, onClickOutside: onCancel, children: t5 }), $[12] = dialogId, $[13] = onCancel, $[14] = t1, $[15] = t3, $[16] = t5, $[17] = t6) : t6 = $[17], t6;
}
...
var useDiscardChangesAction = (t0) => {
  ...
  const bundleId = t1, {
    discardChanges
  } = useDocumentOperation(id2, type2, bundleId), [isConfirmDialogOpen, setConfirmDialogOpen] = (0, import_react3.useState)(false);
  let t2;
  $[2] !== bundleId || $[3] !== id2 || $[4] !== type2 ? (t2 = {
    id: id2,
    type: type2,
    version: bundleId,
    permission: "discardDraft"
  }, $[2] = bundleId, $[3] = id2, $[4] = type2, $[5] = t2) : t2 = $[5];
  ...
  bb0: {
    ...
    if (!isPermissionsLoading && !permissions?.granted) {
      ...
      let t82;
      $[12] !== currentUser ? (t82 = (0, import_jsx_runtime3.jsx)(InsufficientPermissionsMessage, { context: "discard-changes", currentUser }), $[12] = currentUser, $[13] = t82) : t82 = $[13];
      let t92;
      $[14] !== t72 || $[15] !== t82 ? (t92 = {
        tone: "critical",
        icon: ResetIcon,
    ...
    $[22] !== handleConfirm || $[23] !== isConfirmDialogOpen || $[24] !== published ? (t11 = isConfirmDialogOpen && {
      type: "custom",
      component: (0, import_jsx_runtime3.jsx)(ConfirmDiscardDialog, { onCancel: handleCancel, onConfirm: handleConfirm, publishedExists: !!published })
...
var useDuplicateAction = (t0) => {
  ...
  const bundleId = t1, {
    duplicate
  } = useDocumentOperation(id2, type2, bundleId), {
    navigateIntent
  } = useRouter(), [isDuplicating, setDuplicating] = (0, import_react3.useState)(false);
  let t2;
  $[2] !== id2 || $[3] !== release || $[4] !== type2 ? (t2 = {
    id: id2,
    type: type2,
    version: release,
    permission: "duplicate"
  }, $[2] = id2, $[3] = release, $[4] = type2, $[5] = t2) : t2 = $[5];
  ...
  let t32;
  $[6] !== documentStore.pair || $[7] !== duplicate || $[8] !== id2 || $[9] !== mapDocument || $[10] !== navigateIntent || $[11] !== type2 ? (t32 = async () => {
    const dupeId = v4_default();
    setDuplicating(true);
    const duplicateSuccess = firstValueFrom(documentStore.pair.operationEvents(id2, type2).pipe(filter(_temp$q)));
  ...
  }, $[6] = documentStore.pair, $[7] = duplicate, $[8] = id2, $[9] = mapDocument, $[10] = navigateIntent, $[11] = type2, $[12] = t32) : t32 = $[12];
  const handle = t32;
  let t4;
  bb0: {
    if (!isPermissionsLoading && !permissions?.granted) {
      ...
      let t62;
      $[15] !== currentUser ? (t62 = (0, import_jsx_runtime3.jsx)(InsufficientPermissionsMessage, { context: "duplicate-document", currentUser }), $[15] = currentUser, $[16] = t62) : t62 = $[16];
      let t72;
      $[17] !== t52 || $[18] !== t62 ? (t72 = {
        icon: CopyIcon,
        disabled: true,
...
function getDisabledReason(reason, publishedAt, t2) {
  return reason === "ALREADY_PUBLISHED" && publishedAt ? (0, import_jsx_runtime3.jsx)(AlreadyPublished, { publishedAt }) : t2(DISABLED_REASON_TITLE_KEY[reason]);
}
function AlreadyPublished(t0) {
  ...
  let t3;
  return $[4] !== t22 ? (t3 = (0, import_jsx_runtime3.jsx)(Text, { children: t22 }), $[4] = t22, $[5] = t3) : t3 = $[5], t3;
}
var usePublishAction = (props) => {
  const $ = (0, import_compiler_runtime2.c)(81), {
    ...
    release,
    version
  } = props, [publishState, setPublishState] = (0, import_react3.useState)(null);
  let t0;
  ...
  const bundleId = t0, {
    ...
    documentType,
    value
  } = useDocumentPane(), validationStatus = useValidationStatus(value._id, type2, !release), syncState = useSyncState(id2, type2), editState = useEditState(documentId, documentType), {
    t: t2
  } = useTranslation(structureLocaleNamespace);
  let t1;
  ...
  const hasValidationErrors = t22, [publishScheduled, setPublishScheduled] = (0, import_react3.useState)(false), isSyncing = syncState.isSyncing, isValidating = validationStatus.isValidating;
  let t3;
  $[7] !== id2 || $[8] !== type2 ? (t3 = {
    id: id2,
    type: type2,
    permission: "publish"
  }, $[7] = id2, $[8] = type2, $[9] = t3) : t3 = $[9];
  ...
  let t7;
  $[26] !== doPublish || $[27] !== hasValidationErrors || $[28] !== isSyncing || $[29] !== isValidating || $[30] !== publishScheduled || $[31] !== revision || $[32] !== validationStatus.isValidating || $[33] !== validationStatus.revision ? (t7 = [isSyncing, doPublish, hasValidationErrors, publishScheduled, validationStatus.revision, revision, isValidating, validationStatus.isValidating], $[26] = doPublish, $[27] = hasValidationErrors, $[28] = isSyncing, $[29] = isValidating, $[30] = publishScheduled, $[31] = revision, $[32] = validationStatus.isValidating, $[33] = validationStatus.revision, $[34] = t7) : t7 = $[34], (0, import_react3.useEffect)(t6, t7);
  let t8;
  ...
  let t9;
  $[38] !== changesOpen || $[39] !== currentPublishRevision || $[40] !== publishState ? (t9 = [changesOpen, publishState, currentPublishRevision], $[38] = changesOpen, $[39] = currentPublishRevision, $[40] = publishState, $[41] = t9) : t9 = $[41], (0, import_react3.useEffect)(t8, t9);
  ...
  bb0: {
    ...
    if (!isPermissionsLoading && !permissions?.granted) {
      ...
      let t132;
      $[61] !== currentUser ? (t132 = (0, import_jsx_runtime3.jsx)(InsufficientPermissionsMessage, { context: "publish-document", currentUser }), $[61] = currentUser, $[62] = t132) : t132 = $[62];
      let t142;
...
var useUnpublishAction = (t0) => {
  const $ = (0, import_compiler_runtime2.c)(22), {
    ...
    unpublish
  } = useDocumentOperation(id2, type2), [isConfirmDialogOpen, setConfirmDialogOpen] = (0, import_react3.useState)(false);
  let t1;
  $[0] !== id2 || $[1] !== type2 ? (t1 = {
    id: id2,
    type: type2,
    permission: "unpublish"
  }, $[0] = id2, $[1] = type2, $[2] = t1) : t1 = $[2];
  ...
  bb0: {
    if (isConfirmDialogOpen) {
      const t52 = draft?._id || id2;
      let t62;
      $[6] !== handleConfirm || $[7] !== t52 || $[8] !== type2 ? (t62 = {
        type: "dialog",
        onClose: handleCancel,
        content: (0, import_jsx_runtime3.jsx)(ConfirmDeleteDialogContainer, { id: t52, type: type2, action: "unpublish", onCancel: handleCancel, onConfirm: handleConfirm })
      }, $[6] = handleConfirm, $[7] = t52, $[8] = type2, $[9] = t62) : t62 = $[9], t4 = t62;
      break bb0;
    }
    t4 = null;
  }
  ...
  $[10] !== currentUser || $[11] !== dialog || $[12] !== isDraft || $[13] !== isPermissionsLoading || $[14] !== liveEdit || $[15] !== permissions?.granted || $[16] !== release || $[17] !== t2 || $[18] !== unpublish.disabled ? (t5 = () => release || isDraft || liveEdit ? null : !isPermissionsLoading && !permissions?.granted ? {
    ...
    icon: UnpublishIcon,
    label: "Unpublish",
    title: (0, import_jsx_runtime3.jsx)(InsufficientPermissionsMessage, { context: "unpublish-document", currentUser }),
    disabled: true
  } : {
    tone: "critical",
    icon: UnpublishIcon,
...
var DocumentStatusBarActionsInner = (0, import_react3.memo)(function(props) {
  ...
  bb0: {
    ...
    let t22;
    $[4] !== firstActionState.title ? (t22 = firstActionState.title && (0, import_jsx_runtime3.jsx)(Text, { size: 1, children: firstActionState.title }), $[4] = firstActionState.title, $[5] = t22) : t22 = $[5];
    let t32;
    $[6] !== firstActionState.shortcut ? (t32 = firstActionState.shortcut && (0, import_jsx_runtime3.jsx)(Hotkeys, { "data-testid": "document-status-bar-hotkeys", fontSize: 1, style: {
      marginTop: -4,
      marginBottom: -4
    }, keys: String(firstActionState.shortcut).split("+").map(_temp$p) }), $[6] = firstActionState.shortcut, $[7] = t32) : t32 = $[7];
    let t42;
    $[8] !== t22 || $[9] !== t32 ? (t42 = (0, import_jsx_runtime3.jsxs)(Flex, { style: t12, align: "center", gap: 3, children: [
      t22,
      t32
  ...
  let t4;
  $[22] !== disabled || $[23] !== firstActionState || $[24] !== showFirstActionButton || $[25] !== tooltipContent ? (t4 = showFirstActionButton && (0, import_jsx_runtime3.jsx)(LayerProvider, { zOffset: 200, children: (0, import_jsx_runtime3.jsx)(Tooltip, { disabled: !tooltipContent, content: tooltipContent, placement: "top", children: (0, import_jsx_runtime3.jsx)(Stack, { children: (0, import_jsx_runtime3.jsx)(Button2, { "data-testid": `action-${toLowerCaseNoSpaces(firstActionState.label)}`, disabled: disabled || !!firstActionState.disabled, icon: firstActionState.icon, onClick: firstActionState.onHandle, ref: setButtonElement, text: firstActionState.label, tone: firstActionState.tone || "primary" }) }) }) }), $[22] = disabled, $[23] = firstActionState, $[24] = showFirstActionButton, $[25] = tooltipContent, $[26] = t4) : t4 = $[26];
  let t5;
  $[27] !== disabled || $[28] !== sideMenuItems ? (t5 = sideMenuItems.length > 0 && (0, import_jsx_runtime3.jsx)(ActionMenuButton, { actionStates: sideMenuItems, disabled }), $[27] = disabled, $[28] = sideMenuItems, $[29] = t5) : t5 = $[29];
  let t6;
  $[30] !== buttonElement || $[31] !== firstActionState || $[32] !== showFirstActionButton ? (t6 = showFirstActionButton && firstActionState && firstActionState.dialog && (0, import_jsx_runtime3.jsx)(ActionStateDialog, { dialog: firstActionState.dialog, referenceElement: buttonElement }), $[30] = buttonElement, $[31] = firstActionState, $[32] = showFirstActionButton, $[33] = t6) : t6 = $[33];
  let t7;
  return $[34] !== t3 || $[35] !== t4 || $[36] !== t5 || $[37] !== t6 ? (t7 = (0, import_jsx_runtime3.jsxs)(Flex, { align: "center", gap: 1, children: [
    t3,
    t4,
    t5,
    t6
...
var DocumentStatusBarActions = (0, import_react3.memo)(function() {
  const $ = (0, import_compiler_runtime2.c)(1);
  let t0;
  return $[0] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t0 = (0, import_jsx_runtime3.jsx)(RenderActionCollectionState, { group: "default", children: _temp2$b }), $[0] = t0) : t0 = $[0], t0;
});
function RenderDocumentStatusBarActions(props) {
  ...
  let t2;
  return $[2] !== documentId || $[3] !== states || $[4] !== t1 ? (t2 = (0, import_jsx_runtime3.jsx)(DocumentStatusBarActionsInner, { disabled: t1, states }, documentId), $[2] = documentId, $[3] = states, $[4] = t1, $[5] = t2) : t2 = $[5], t2;
}
function _temp3$7(state2) {
  return state2.action ? state2.action !== useHistoryRestoreAction.action : true;
}
var HistoryStatusBarActions = (0, import_react3.memo)(function() {
  const $ = (0, import_compiler_runtime2.c)(1);
  let t0;
  return $[0] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t0 = (0, import_jsx_runtime3.jsx)(RenderActionCollectionState, { group: "default", children: _temp4$7 }), $[0] = t0) : t0 = $[0], t0;
});
function RenderHistoryStatusBarActions(t0) {
  ...
  let t4;
  return $[5] !== t2 || $[6] !== t3 ? (t4 = (0, import_jsx_runtime3.jsx)(DocumentStatusBarActionsInner, { disabled: t2, states: t3 }), $[5] = t2, $[6] = t3, $[7] = t4) : t4 = $[7], t4;
}
...
function _temp2$b(t0) {
  ...
  return (0, import_jsx_runtime3.jsx)(RenderDocumentStatusBarActions, { states });
}
function _temp4$7(t0) {
  const {
    states
  } = t0;
  return (0, import_jsx_runtime3.jsx)(RenderHistoryStatusBarActions, { states });
}
...
function getTimelineEventIconComponent(type2) {
  return TIMELINE_ICON_COMPONENTS[type2];
}
...
var FlipIcon = at(ChevronLeftIcon)`
...
function ExpandableTimelineItemButton(t0) {
  ...
  let t22;
  $[3] !== isExpanded2 ? (t22 = (0, import_jsx_runtime3.jsx)(FlipIcon, { "data-expanded": isExpanded2 }), $[3] = isExpanded2, $[4] = t22) : t22 = $[4];
  let t3;
  ...
  let t5;
  return $[10] !== handleExpandClick || $[11] !== t22 || $[12] !== t4 ? (t5 = (0, import_jsx_runtime3.jsx)(Button2, { mode: "bleed", icon: t22, tooltipProps: t4, onClick: handleExpandClick }), $[10] = handleExpandClick, $[11] = t22, $[12] = t4, $[13] = t5) : t5 = $[13], t5;
}
var StackWrapper = at(Stack)`
  max-width: 200px;
`;
var ListWrapper = at(Flex)`
...
function UserAvatarStack(t0) {
  ...
  if ($[0] !== userIds || $[1] !== withTooltip) {
    let t32;
    $[3] !== withTooltip ? (t32 = (userId) => (0, import_jsx_runtime3.jsx)(UserAvatar, { user: userId, withTooltip }, userId), $[3] = withTooltip, $[4] = t32) : t32 = $[4], t2 = userIds.map(t32), $[0] = userIds, $[1] = withTooltip, $[2] = t2;
  } else
    t2 = $[2];
  let t3;
  return $[5] !== maxLength || $[6] !== size || $[7] !== t2 ? (t3 = (0, import_jsx_runtime3.jsx)(AvatarStack, { maxLength, size, children: t2 }), $[5] = maxLength, $[6] = size, $[7] = t2, $[8] = t3) : t3 = $[8], t3;
}
var IconBox = at(Flex)((props) => {
...
var NameSkeleton = at(Skeleton)((props) => {
  const theme = getTheme_v2(props.theme);
  return rt`
    width: 6ch;
...
var UserLine = (t0) => {
  ...
  let t1;
  $[0] !== loading || $[1] !== user ? (t1 = (0, import_jsx_runtime3.jsx)(Box, { children: loading || !user ? (0, import_jsx_runtime3.jsx)(AvatarSkeleton$1, { animated: true }) : (0, import_jsx_runtime3.jsx)(UserAvatar, { user }) }), $[0] = loading, $[1] = user, $[2] = t1) : t1 = $[2];
  let t2;
  $[3] !== loading || $[4] !== user ? (t2 = (0, import_jsx_runtime3.jsx)(Box, { children: loading || !user?.displayName ? (0, import_jsx_runtime3.jsx)(Text, { size: 1, children: (0, import_jsx_runtime3.jsx)(NameSkeleton, { animated: true }) }) : (0, import_jsx_runtime3.jsx)(Text, { muted: true, size: 1, children: user.displayName }) }), $[3] = loading, $[4] = user, $[5] = t2) : t2 = $[5];
  let t3;
  return $[6] !== t1 || $[7] !== t2 || $[8] !== userId ? (t3 = (0, import_jsx_runtime3.jsxs)(Flex, { align: "center", gap: 2, padding: 1, children: [
    t1,
    t2
...
var TooltipContent = (t0) => {
  ...
  let t22;
  $[2] !== t1 ? (t22 = (0, import_jsx_runtime3.jsx)(Box, { padding: 1, paddingBottom: 2, children: (0, import_jsx_runtime3.jsx)(Text, { size: 1, weight: "medium", children: t1 }) }), $[2] = t1, $[3] = t22) : t22 = $[3];
  let t3;
  $[4] !== collaborators ? (t3 = collaborators.map(_temp$o), $[4] = collaborators, $[5] = t3) : t3 = $[5];
  let t4;
  return $[6] !== t22 || $[7] !== t3 ? (t4 = (0, import_jsx_runtime3.jsxs)(Stack, { paddingBottom: 1, children: [
    t22,
    t3
...
function TimelineItem(t0) {
  ...
  let t1;
  $[0] !== type2 ? (t1 = getTimelineEventIconComponent(type2), $[0] = type2, $[1] = t1) : t1 = $[1];
  ...
  const collaboratorsUsersIds = t3, isSelectable = type2 !== "delete";
  let t4;
  $[6] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t4 = {
    dateStyle: "medium",
    timeStyle: "short"
  ...
  let t9;
  $[17] !== authorUserIds ? (t9 = (0, import_jsx_runtime3.jsx)(UserAvatarStack, { maxLength: 3, userIds: authorUserIds, size: 2 }), $[17] = authorUserIds, $[18] = t9) : t9 = $[18];
  const t10 = TIMELINE_ITEM_EVENT_TONE[type2];
  let t11;
  $[19] !== IconComponent ? (t11 = IconComponent && (0, import_jsx_runtime3.jsx)(IconComponent, {}), $[19] = IconComponent, $[20] = t11) : t11 = $[20];
  let t12;
  $[21] !== t11 ? (t12 = (0, import_jsx_runtime3.jsx)(Text, { size: 0, children: t11 }), $[21] = t11, $[22] = t12) : t12 = $[22];
  let t13;
  $[23] !== t10 || $[24] !== t12 ? (t13 = (0, import_jsx_runtime3.jsx)(IconBox, { align: "center", justify: "center", $color: t10, children: t12 }), $[23] = t10, $[24] = t12, $[25] = t13) : t13 = $[25];
  let t14;
  $[26] !== t13 || $[27] !== t9 ? (t14 = (0, import_jsx_runtime3.jsxs)("div", { style: t8, children: [
    t9,
    t13
  ] }), $[26] = t13, $[27] = t9, $[28] = t14) : t14 = $[28];
  let t15;
  $[29] !== t2 || $[30] !== type2 ? (t15 = t2(TIMELINE_ITEM_I18N_KEY_MAPPING2[type2]) || (0, import_jsx_runtime3.jsx)("code", { children: type2 }), $[29] = t2, $[30] = type2, $[31] = t15) : t15 = $[31];
  let t16;
  $[32] !== t15 ? (t16 = (0, import_jsx_runtime3.jsx)(Text, { size: 1, weight: "medium", children: t15 }), $[32] = t15, $[33] = t16) : t16 = $[33];
  let t17;
  $[34] !== formattedTimestamp || $[35] !== timestamp || $[36] !== updatedTimeAgo ? (t17 = (0, import_jsx_runtime3.jsx)(Text, { as: "time", size: 1, muted: true, dateTime: timestamp, title: formattedTimestamp, children: updatedTimeAgo }), $[34] = formattedTimestamp, $[35] = timestamp, $[36] = updatedTimeAgo, $[37] = t17) : t17 = $[37];
  let t18;
  $[38] !== t16 || $[39] !== t17 ? (t18 = (0, import_jsx_runtime3.jsxs)(Stack, { space: 2, children: [
    t16,
    t17
  ] }), $[38] = t16, $[39] = t17, $[40] = t18) : t18 = $[40];
  let t19;
  $[41] !== collaboratorsUsersIds ? (t19 = collaboratorsUsersIds.length > 0 && (0, import_jsx_runtime3.jsx)(Flex, { flex: 1, justify: "flex-end", align: "center", children: (0, import_jsx_runtime3.jsx)(Tooltip, { placement: "top", content: (0, import_jsx_runtime3.jsx)(TooltipContent, { collaborators: collaboratorsUsersIds }), portal: true, children: (0, import_jsx_runtime3.jsx)(Box, { paddingLeft: 2, paddingY: 2, children: (0, import_jsx_runtime3.jsx)(UserAvatarStack, { maxLength: 3, userIds: collaboratorsUsersIds, size: 0, withTooltip: false }) }) }) }), $[41] = collaboratorsUsersIds, $[42] = t19) : t19 = $[42];
  let t20;
  $[43] !== t14 || $[44] !== t18 || $[45] !== t19 ? (t20 = (0, import_jsx_runtime3.jsxs)(Flex, { align: "center", gap: 3, children: [
    t14,
    t18,
    t19
  ] }), $[43] = t14, $[44] = t18, $[45] = t19, $[46] = t20) : t20 = $[46];
  let t21;
  $[47] !== chunk.id || $[48] !== handleClick || $[49] !== isSelected || $[50] !== t20 ? (t21 = (0, import_jsx_runtime3.jsx)(Card, { as: "button", onClick: handleClick, padding: 2, pressed: isSelected, radius: 2, "data-ui": "timelineItem", "data-testid": "timeline-item-button", "data-chunk-id": chunk.id, children: t20 }), $[47] = chunk.id, $[48] = handleClick, $[49] = isSelected, $[50] = t20, $[51] = t21) : t21 = $[51];
  let t222;
  return $[52] !== optionsMenu || $[53] !== t21 ? (t222 = (0, import_jsx_runtime3.jsxs)(Flex, { align: "center", gap: 1, children: [
    t21,
    optionsMenu
  ] }), $[52] = optionsMenu, $[53] = t21, $[54] = t222) : t222 = $[54], t222;
}
function _temp$o(userId) {
  return (0, import_jsx_runtime3.jsx)(UserLine, { userId }, userId);
}
  ...
  for (const chunk of chunks) {
    ...
    if (isNonPublishChunk(chunk)) {
      ...
      if (chunk.type === "editDraft" && previousPublish?.type === "publish") {
        Array.from(chunk.authors).forEach((id2) => {
          previousPublish.collaborators.add(id2);
...
var Timeline = (t0) => {
  const $ = (0, import_compiler_runtime2.c)(51), {
    ...
    onSelect,
    listMaxHeight: t1
  } = t0, listMaxHeight = t1 === void 0 ? "calc(100vh - 280px)" : t1, [mounted, setMounted] = (0, import_react3.useState)(false), {
    t: t2
  ...
  const [expandedParents, setExpandedParents] = (0, import_react3.useState)(t3);
  let t4, t5;
  ...
  }, t5 = [chunksWithMetadata, selectedChunkId], $[5] = chunksWithMetadata, $[6] = selectedChunkId, $[7] = t4, $[8] = t5) : (t4 = $[7], t5 = $[8]), (0, import_react3.useEffect)(t4, t5);
  let t6;
  ...
  let t8;
  $[18] !== filteredChunks || $[19] !== hasMoreChunks || $[20] !== onLoadMore ? (t8 = [filteredChunks, hasMoreChunks, onLoadMore], $[18] = filteredChunks, $[19] = hasMoreChunks, $[20] = onLoadMore, $[21] = t8) : t8 = $[21], (0, import_react3.useEffect)(t7, t8);
  let t9;
  ...
  $[29] !== expandedParents || $[30] !== filteredChunks.length || $[31] !== handleSelectChunk || $[32] !== hasMoreChunks || $[33] !== selectedChunkId ? (t12 = (chunk_4, t132) => {
    ...
    return (0, import_jsx_runtime3.jsxs)(Box, { paddingBottom: 1, paddingTop: activeIndex === 0 ? 1 : 0, paddingRight: 1, paddingLeft: isNonPublishChunk(chunk_4) && chunk_4.parentId ? 4 : 1, children: [
      (0, import_jsx_runtime3.jsx)(TimelineItem, { chunk: chunk_4, isSelected: selectedChunkId === chunk_4.id, onSelect: handleSelectChunk, collaborators: isPublishChunk(chunk_4) ? chunk_4.collaborators : void 0, optionsMenu: isPublishChunk(chunk_4) && chunk_4.children.length > 0 ? (0, import_jsx_runtime3.jsx)(ExpandableTimelineItemButton, { isExpanded: expandedParents.has(chunk_4.id), onExpand: handleExpandParent(chunk_4.id) }) : null }),
      activeIndex === filteredChunks.length - 1 && hasMoreChunks && (0, import_jsx_runtime3.jsx)(LoadingBlock, {})
    ] });
  ...
  let t13, t14;
  $[35] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t13 = () => setMounted(true), t14 = [], $[35] = t13, $[36] = t14) : (t13 = $[35], t14 = $[36]), (0, import_react3.useEffect)(t13, t14);
  const t15 = !selectedIndex || mounted;
  let t16;
  $[37] !== filteredChunks.length || $[38] !== t2 ? (t16 = filteredChunks.length === 0 && (0, import_jsx_runtime3.jsxs)(StackWrapper, { padding: 3, space: 3, children: [
    (0, import_jsx_runtime3.jsx)(Text, { size: 1, weight: "medium", children: t2("timeline.error.no-document-history-title") }),
    (0, import_jsx_runtime3.jsx)(Text, { muted: true, size: 1, children: t2("timeline.error.no-document-history-description") })
  ] }), $[37] = filteredChunks.length, $[38] = t2, $[39] = t16) : t16 = $[39];
  let t17;
  $[40] !== filteredChunks || $[41] !== listMaxHeight || $[42] !== onLoadMore || $[43] !== renderItem || $[44] !== selectedIndex || $[45] !== t2 ? (t17 = filteredChunks.length > 0 && (0, import_jsx_runtime3.jsx)(ListWrapper, { direction: "column", $maxHeight: listMaxHeight, id: TIMELINE_LIST_WRAPPER_ID$1, children: (0, import_jsx_runtime3.jsx)(CommandList, { activeItemDataAttr: "data-hovered", ariaLabel: t2("timeline.list.aria-label"), autoFocus: "list", initialIndex: selectedIndex, initialScrollAlign: "center", itemHeight: 57, items: filteredChunks, onEndReached: onLoadMore, onEndReachedIndexOffset: 20, overscan: 5, renderItem, wrapAround: false }) }), $[40] = filteredChunks, $[41] = listMaxHeight, $[42] = onLoadMore, $[43] = renderItem, $[44] = selectedIndex, $[45] = t2, $[46] = t17) : t17 = $[46];
  let t18;
  return $[47] !== t15 || $[48] !== t16 || $[49] !== t17 ? (t18 = (0, import_jsx_runtime3.jsxs)(Root$2, { $visible: t15, "data-ui": "timeline", children: [
    t16,
    t17
...
function TimelineError(t0) {
  ...
  let t1;
  $[0] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t1 = (0, import_jsx_runtime3.jsx)(TextWithTone, { tone: "critical", children: (0, import_jsx_runtime3.jsx)(ErrorOutlineIcon, {}) }), $[0] = t1) : t1 = $[0];
  let t22;
  ...
  let t3;
  $[4] !== t22 ? (t3 = (0, import_jsx_runtime3.jsx)(TextWithTone, { size: 1, tone: "critical", weight: "medium", children: t22 }), $[4] = t22, $[5] = t3) : t3 = $[5];
  let t4;
  ...
  let t5;
  $[9] !== t4 ? (t5 = (0, import_jsx_runtime3.jsx)(TextWithTone, { size: 1, tone: "critical", children: t4 }), $[9] = t4, $[10] = t5) : t5 = $[10];
  let t6;
  return $[11] !== t3 || $[12] !== t5 ? (t6 = (0, import_jsx_runtime3.jsxs)(Flex, { align: "flex-start", gap: 3, padding: 4, children: [
    t1,
    (0, import_jsx_runtime3.jsxs)(Stack, { space: 4, children: [
      t3,
      t5
    ] })
  ] }), $[11] = t3, $[12] = t5, $[13] = t6) : t6 = $[13], t6;
}
var Root$1 = at(Popover2)`
  overflow: hidden;
  overflow: clip;
`;
...
function TimelineMenu(t0) {
  ...
  bb0: {
    if (timelineError) {
      let t93;
      $[21] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t93 = (0, import_jsx_runtime3.jsx)(TimelineError, {}), $[21] = t93) : t93 = $[21], t8 = t93;
      break bb0;
    }
    if (mode === "rev") {
      let t93;
      $[22] !== chunks || $[23] !== handleLoadMore || $[24] !== hasMoreChunks || $[25] !== realRevChunk || $[26] !== selectRev ? (t93 = (0, import_jsx_runtime3.jsx)(Timeline, { chunks, hasMoreChunks, lastChunk: realRevChunk, onLoadMore: handleLoadMore, onSelect: selectRev }), $[22] = chunks, $[23] = handleLoadMore, $[24] = hasMoreChunks, $[25] = realRevChunk, $[26] = selectRev, $[27] = t93) : t93 = $[27], t8 = t93;
      break bb0;
    }
    let t92;
    ...
    let t102;
    $[31] !== filteredChunks || $[32] !== handleLoadMore || $[33] !== hasMoreChunks || $[34] !== selectSince || $[35] !== sinceTime ? (t102 = (0, import_jsx_runtime3.jsx)(Timeline, { chunks: filteredChunks, hasMoreChunks, lastChunk: sinceTime, onLoadMore: handleLoadMore, onSelect: selectSince }), $[31] = filteredChunks, $[32] = handleLoadMore, $[33] = hasMoreChunks, $[34] = selectSince, $[35] = sinceTime, $[36] = t102) : t102 = $[36], t8 = t102;
  }
  const content = t8;
  let revLabel, t9;
  if ($[37] !== chunk || $[38] !== t2) {
  ...
  let t17;
  $[48] !== open || $[49] !== t12 || $[50] !== t13 || $[51] !== t14 || $[52] !== t16 ? (t17 = (0, import_jsx_runtime3.jsx)(Flex, { width: "fill", children: (0, import_jsx_runtime3.jsx)(Button2, { "data-testid": t12, disabled: t13, mode: "ghost", onClick: t14, ref: setButton, selected: open, width: "fill", tooltipProps: null, justify: "space-between", style: t15, iconRight: ChevronDownIcon, text: t16 }) }), $[48] = open, $[49] = t12, $[50] = t13, $[51] = t14, $[52] = t16, $[53] = t17) : t17 = $[53];
  let t18;
  $[54] !== open || $[55] !== placement || $[56] !== t11 || $[57] !== t17 ? (t18 = (0, import_jsx_runtime3.jsx)(Root$1, { "data-testid": "timeline-menu", constrainSize: true, content: t11, "data-ui": "versionMenu", open, placement, matchReferenceWidth: true, portal: true, ref: setPopoverRef, children: t17 }), $[54] = open, $[55] = placement, $[56] = t11, $[57] = t17, $[58] = t18) : t18 = $[58];
  let t19;
  return $[59] !== portalElements || $[60] !== t18 ? (t19 = (0, import_jsx_runtime3.jsx)(PortalProvider, { __unstable_elements: portalElements, children: t18 }), $[59] = portalElements, $[60] = t18, $[61] = t19) : t19 = $[61], t19;
}
...
var StyledMotionPath = at(motion.path)`
  transform-origin: center;
`;
var Circle = (props) => {
  const $ = (0, import_compiler_runtime2.c)(2);
  let t0;
  return $[0] !== props ? (t0 = (0, import_jsx_runtime3.jsx)(motion.circle, { fill: "none", r: "8", cx: "12.5", cy: "12.5", strokeWidth: "1.2", ...props }), $[0] = props, $[1] = t0) : t0 = $[1], t0;
};
var Arrows = (props) => {
  const $ = (0, import_compiler_runtime2.c)(2);
  let t0;
  return $[0] !== props ? (t0 = (0, import_jsx_runtime3.jsx)(StyledMotionPath, { fill: "none", d: "M14 17.5619L11.5 20.5L14.5 23.0619M11 7.43811L13.5 4.50001L10.5 1.93811", ...props }), $[0] = props, $[1] = t0) : t0 = $[1], t0;
};
var Checkmark = (props) => {
  const $ = (0, import_compiler_runtime2.c)(2);
  let t0;
  return $[0] !== props ? (t0 = (0, import_jsx_runtime3.jsx)(motion.path, { d: "M9.5 12.1316L11.7414 14.5L16 10", ...props }), $[0] = props, $[1] = t0) : t0 = $[1], t0;
};
...
function AnimatedStatusIcon(props) {
  ...
  let t1, t2;
  $[0] !== status ? (t1 = (0, import_jsx_runtime3.jsx)(Arrows, { variants: arrows, initial: status, animate: status }), t2 = (0, import_jsx_runtime3.jsx)(Circle, { variants: circle, initial: status, animate: status }), $[0] = status, $[1] = t1, $[2] = t2) : (t1 = $[1], t2 = $[2]);
  let t3;
  $[3] !== t0 || $[4] !== t1 || $[5] !== t2 ? (t3 = (0, import_jsx_runtime3.jsxs)(RotateGroup, { "data-rotate": t0, children: [
    t1,
    t2
  ] }), $[3] = t0, $[4] = t1, $[5] = t2, $[6] = t3) : t3 = $[6];
  let t4;
  $[7] !== status ? (t4 = (0, import_jsx_runtime3.jsx)(Checkmark, { variants: checkmark, initial: status, animate: status }), $[7] = status, $[8] = t4) : t4 = $[8];
  let t5;
  return $[9] !== status || $[10] !== t3 || $[11] !== t4 ? (t5 = (0, import_jsx_runtime3.jsx)("svg", { width: "1em", height: "1em", viewBox: "0 0 25 25", fill: "none", stroke: "currentColor", strokeWidth: "1.2", "data-sanity-icon": "animated-status-icon", children: (0, import_jsx_runtime3.jsxs)(motion.g, { variants: root, initial: status, animate: status, children: [
    t3,
    t4
...
var DocumentStatusPulse = (props) => {
  ...
  let t0;
  $[0] !== status ? (t0 = (0, import_jsx_runtime3.jsx)(AnimatedStatusIcon, { status }), $[0] = status, $[1] = t0) : t0 = $[1];
  let t1;
  $[2] !== currentStatus.tone || $[3] !== t0 ? (t1 = (0, import_jsx_runtime3.jsx)(TextWithTone, { size: 1, tone: currentStatus.tone, children: t0 }), $[2] = currentStatus.tone, $[3] = t0, $[4] = t1) : t1 = $[4];
  let t22;
  $[5] !== currentStatus.i18nKey || $[6] !== t2 ? (t22 = t2(currentStatus.i18nKey), $[5] = currentStatus.i18nKey, $[6] = t2, $[7] = t22) : t22 = $[7];
  let t3;
  $[8] !== t22 ? (t3 = (0, import_jsx_runtime3.jsx)(Text, { muted: true, size: 1, children: t22 }), $[8] = t22, $[9] = t3) : t3 = $[9];
  let t4;
  return $[10] !== t1 || $[11] !== t3 ? (t4 = (0, import_jsx_runtime3.jsxs)(Flex, { align: "center", gap: 2, "data-testid": "pane-footer-document-status-pulse", children: [
    t1,
    t3
...
var ButtonSkeleton = () => {
  const $ = (0, import_compiler_runtime2.c)(2);
  let t0;
  $[0] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t0 = (0, import_jsx_runtime3.jsx)("div", { style: {
    margin: -5
  }, children: (0, import_jsx_runtime3.jsx)(AvatarSkeleton$1, { $size: 0, animated: true }) }), $[0] = t0) : t0 = $[0];
  let t1;
  return $[1] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t1 = (0, import_jsx_runtime3.jsxs)(Flex, { align: "center", gap: 3, paddingLeft: 1, paddingRight: 2, paddingY: 2, children: [
    t0,
    (0, import_jsx_runtime3.jsx)(Skeleton, { animated: true, style: {
      width: "80px",
      height: "15px"
    }, radius: 2 })
  ] }), $[1] = t1) : t1 = $[1], t1;
...
var DocumentStatusButton = (t0) => {
  ...
  let t6;
  $[3] !== author ? (t6 = author && (0, import_jsx_runtime3.jsx)("div", { style: {
    margin: -5
  }, children: (0, import_jsx_runtime3.jsx)(UserAvatar, { user: author, size: 0 }) }), $[3] = author, $[4] = t6) : t6 = $[4];
  let t7;
  $[5] !== t2 || $[6] !== translationKey ? (t7 = t2(translationKey), $[5] = t2, $[6] = translationKey, $[7] = t7) : t7 = $[7];
  let t8;
  $[8] !== relativeTime || $[9] !== t7 ? (t8 = (0, import_jsx_runtime3.jsxs)(Text, { muted: true, size: 1, children: [
    t7,
    " ",
    relativeTime
  ] }), $[8] = relativeTime, $[9] = t7, $[10] = t8) : t8 = $[10];
  let t9;
  $[11] !== t6 || $[12] !== t8 ? (t9 = (0, import_jsx_runtime3.jsxs)(Flex, { align: "center", flex: "none", gap: 3, children: [
    t6,
    t8
  ] }), $[11] = t6, $[12] = t8, $[13] = t9) : t9 = $[13];
  let t10;
  return $[14] !== t5 || $[15] !== t9 ? (t10 = (0, import_jsx_runtime3.jsx)(MotionButton, { "data-testid": "pane-footer-document-status", animate: t22, initial: t3, exit: t4, mode: "bleed", onClick: t5, padding: 2, muted: true, children: t9 }), $[14] = t5, $[15] = t9, $[16] = t10) : t10 = $[16], t10;
};
var FallbackStatus = () => {
  const $ = (0, import_compiler_runtime2.c)(6), {
    editState
  ...
  if (!status)
    return null;
  let t1;
  return $[3] !== status.timestamp || $[4] !== status.translationKey ? (t1 = (0, import_jsx_runtime3.jsx)(DocumentStatusButton, { author: "", translationKey: status.translationKey, timestamp: status.timestamp }), $[3] = status.timestamp, $[4] = status.translationKey, $[5] = t1) : t1 = $[5], t1;
};
var EventsStatus = () => {
  const $ = (0, import_compiler_runtime2.c)(8), {
    events,
  ...
  if (!event && loading) {
    let t02;
    return $[0] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t02 = (0, import_jsx_runtime3.jsx)(ButtonSkeleton, {}), $[0] = t02) : t02 = $[0], t02;
  }
  if (!event) {
    let t02;
    return $[1] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t02 = (0, import_jsx_runtime3.jsx)(FallbackStatus, {}), $[1] = t02) : t02 = $[1], t02;
  }
  ...
  let t3;
  return $[4] !== event.author || $[5] !== event.timestamp || $[6] !== t2 ? (t3 = (0, import_jsx_runtime3.jsx)(DocumentStatusButton, { author: t0, translationKey: t2, timestamp: event.timestamp }), $[4] = event.author, $[5] = event.timestamp, $[6] = t2, $[7] = t3) : t3 = $[7], t3;
};
var TimelineStatus = () => {
  const $ = (0, import_compiler_runtime2.c)(10), {
    timelineStore
  ...
  let t3;
  return $[6] !== author || $[7] !== event.endTimestamp || $[8] !== t2 ? (t3 = (0, import_jsx_runtime3.jsx)(DocumentStatusButton, { author, translationKey: t2, timestamp: event.endTimestamp }), $[6] = author, $[7] = event.endTimestamp, $[8] = t2, $[9] = t3) : t3 = $[9], t3;
};
...
function DocumentStatusLine() {
  const $ = (0, import_compiler_runtime2.c)(18), {
    ...
    editState,
    value
  } = useDocumentPane(), [status, setStatus] = (0, import_react3.useState)(null), eventsEnabled = useSource().beta?.eventsAPI?.documents, syncState = useSyncState(documentId, documentType, editState?.release), lastUpdated = value?._updatedAt;
  let t0;
  ...
  let t1;
  $[3] !== lastUpdated || $[4] !== status || $[5] !== syncState.isSyncing ? (t1 = [status, lastUpdated, syncState.isSyncing], $[3] = lastUpdated, $[4] = status, $[5] = syncState.isSyncing, $[6] = t1) : t1 = $[6], (0, import_react3.useEffect)(t0, t1);
  let t2;
  $[7] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t2 = () => {
    setStatus(null);
  }, $[7] = t2) : t2 = $[7];
  let t3;
  $[8] !== documentId ? (t3 = [documentId], $[8] = documentId, $[9] = t3) : t3 = $[9], (0, import_react3.useLayoutEffect)(t2, t3);
  let t4;
  $[10] !== syncState.isSyncing ? (t4 = () => {
    syncState.isSyncing && setStatus("syncing");
  }, $[10] = syncState.isSyncing, $[11] = t4) : t4 = $[11];
  let t5;
  $[12] !== lastUpdated || $[13] !== syncState.isSyncing ? (t5 = [syncState.isSyncing, lastUpdated], $[12] = lastUpdated, $[13] = syncState.isSyncing, $[14] = t5) : t5 = $[14], (0, import_react3.useLayoutEffect)(t4, t5);
  let t6;
  return $[15] !== eventsEnabled || $[16] !== status ? (t6 = (0, import_jsx_runtime3.jsx)(AnimatePresence, { children: status ? (0, import_jsx_runtime3.jsx)(MotionBox, { paddingLeft: 2, animate: {
    opacity: 1
  }, initial: {
    opacity: 0
  }, exit: {
    opacity: 0
  }, children: (0, import_jsx_runtime3.jsx)(DocumentStatusPulse, { status: status || void 0 }) }) : (0, import_jsx_runtime3.jsx)(import_jsx_runtime3.Fragment, { children: eventsEnabled ? (0, import_jsx_runtime3.jsx)(EventsStatus, {}) : (0, import_jsx_runtime3.jsx)(TimelineStatus, {}) }) }), $[15] = eventsEnabled, $[16] = status, $[17] = t6) : t6 = $[17], t6;
}
...
function RevisionStatusLine() {
  const $ = (0, import_compiler_runtime2.c)(9), {
    displayed,
    revisionNotFound
  } = useDocumentPane(), events = (0, import_react3.useContext)(EventsContext), revision = events?.revision, revisionEvent = events?.events.find((ev) => ev.id === revision?.revisionId), {
    t: t2
  } = useTranslation(), date = revisionEvent?.timestamp || displayed?._updatedAt || displayed?._createdAt, t0 = "revision", t1 = date ? (0, import_jsx_runtime3.jsx)(Translate, { t: t2, i18nKey: "document-status.revision-from", values: {
  ...
  const message = t22;
  let t3;
  $[2] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t3 = (0, import_jsx_runtime3.jsx)(Box, { flex: "none", children: (0, import_jsx_runtime3.jsx)(Text, { size: 1, children: (0, import_jsx_runtime3.jsx)(RestoreIcon, {}) }) }), $[2] = t3) : t3 = $[2];
  let t4;
  $[3] !== message || $[4] !== revisionNotFound || $[5] !== t2 ? (t4 = revisionNotFound ? (0, import_jsx_runtime3.jsx)(Translate, { t: t2, i18nKey: "document-status.revision-not-found" }) : message.text, $[3] = message, $[4] = revisionNotFound, $[5] = t2, $[6] = t4) : t4 = $[6];
  let t5;
  return $[7] !== t4 ? (t5 = (0, import_jsx_runtime3.jsx)(import_jsx_runtime3.Fragment, { children: (0, import_jsx_runtime3.jsxs)(Flex, { flex: 1, gap: 3, padding: 2, children: [
    t3,
    (0, import_jsx_runtime3.jsx)(Box, { flex: 1, children: (0, import_jsx_runtime3.jsx)(StatusText, { size: 1, textOverflow: "ellipsis", children: t4 }) })
  ] }) }), $[7] = t4, $[8] = t5) : t5 = $[8], t5;
}
function useResizeObserver(t0) {
  ...
  }), t2 = [element, onResize], $[0] = element, $[1] = onResize, $[2] = t1, $[3] = t2) : (t1 = $[2], t2 = $[3]), (0, import_react3.useLayoutEffect)(t1, t2);
}
...
function DocumentStatusBar(props) {
  const $ = (0, import_compiler_runtime2.c)(22), {
    ...
    title
  } = useDocumentTitle(), CreateLinkedActions = useSanityCreateConfig().components?.documentLinkedActions, showingRevision = !!params.rev, [collapsed, setCollapsed] = (0, import_react3.useState)(null), [rootElement, setRootElement] = (0, import_react3.useState)(null);
  let t1;
  ...
  if (createLinkMetadata && isSanityCreateLinked(createLinkMetadata) && CreateLinkedActions) {
    let t42;
    $[3] !== CreateLinkedActions || $[4] !== createLinkMetadata || $[5] !== onDocumentChange || $[6] !== title ? (t42 = (0, import_jsx_runtime3.jsx)(CreateLinkedActions, { metadata: createLinkMetadata, panelPortalElementId: DOCUMENT_PANEL_PORTAL_ELEMENT, onDocumentChange, documentTitle: title }), $[3] = CreateLinkedActions, $[4] = createLinkMetadata, $[5] = onDocumentChange, $[6] = title, $[7] = t42) : t42 = $[7], actions = t42;
  } else if (showingRevision) {
    let t42;
    $[8] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t42 = (0, import_jsx_runtime3.jsx)(HistoryStatusBarActions, {}), $[8] = t42) : t42 = $[8], actions = t42;
  } else {
    let t42;
    $[9] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t42 = (0, import_jsx_runtime3.jsx)(DocumentStatusBarActions, {}), $[9] = t42) : t42 = $[9], actions = t42;
  }
  ...
  let t8;
  $[12] !== actions || $[13] !== actionsBoxRef || $[14] !== collapsed || $[15] !== shouldRender || $[16] !== showingRevision ? (t8 = shouldRender && (0, import_jsx_runtime3.jsxs)(Flex, { align: "stretch", gap: 1, justify: "space-between", paddingLeft: showingRevision ? 0 : 1, paddingRight: showingRevision ? 0 : 1, children: [
    (0, import_jsx_runtime3.jsxs)(Flex, { align: "center", flex: 1, gap: collapsed ? 2 : 3, wrap: "wrap", paddingRight: 3, children: [
      (0, import_jsx_runtime3.jsxs)(Flex, { align: "center", children: [
        showingRevision ? (0, import_jsx_runtime3.jsx)(RevisionStatusLine, {}) : (0, import_jsx_runtime3.jsx)(DocumentStatusLine, {}),
        (0, import_jsx_runtime3.jsx)(SpacerButton, {})
      ] }),
      (0, import_jsx_runtime3.jsx)(DocumentBadges, {})
    ] }),
    (0, import_jsx_runtime3.jsxs)(Flex, { align: "flex-start", justify: "flex-end", ref: actionsBoxRef, style: {
      flexShrink: 0,
      marginLeft: "auto"
    }, children: [
      (0, import_jsx_runtime3.jsx)(SpacerButton, {}),
  ...
  let t9;
  return $[18] !== t4 || $[19] !== t7 || $[20] !== t8 ? (t9 = (0, import_jsx_runtime3.jsx)(AnimatedCard, { initial: t5, animate: t6, tone: t7, radius: 3, ref: setRootElement, sizing: "border", padding: 2, children: t8 }, t4), $[18] = t4, $[19] = t7, $[20] = t8, $[21] = t9) : t9 = $[21], t9;
}
var KeyboardShortcutResponder = (0, import_react3.memo)(function(props) {
  const $ = (0, import_compiler_runtime2.c)(26);
  let actionsBoxElement, activeIndex, children, id2, onActionStart, onKeyDown, rest, rootRef, states, t0;
  $[0] !== props ? ({
    actionsBoxElement,
    activeIndex,
    as: t0,
    ...
    states,
    ...rest
  } = props, $[0] = props, $[1] = actionsBoxElement, $[2] = activeIndex, $[3] = children, $[4] = id2, $[5] = onActionStart, $[6] = onKeyDown, $[7] = rest, $[8] = rootRef, $[9] = states, $[10] = t0) : (actionsBoxElement = $[1], activeIndex = $[2], children = $[3], id2 = $[4], onActionStart = $[5], onKeyDown = $[6], rest = $[7], rootRef = $[8], states = $[9], t0 = $[10]);
  ...
  let t2;
  $[15] !== actionsBoxElement || $[16] !== activeAction ? (t2 = activeAction && activeAction.dialog && (0, import_jsx_runtime3.jsx)(LegacyLayerProvider, { zOffset: "paneFooter", children: (0, import_jsx_runtime3.jsx)(ActionStateDialog, { dialog: activeAction.dialog, referenceElement: actionsBoxElement }) }), $[15] = actionsBoxElement, $[16] = activeAction, $[17] = t2) : t2 = $[17];
  let t3;
  return $[18] !== As || $[19] !== children || $[20] !== handleKeyDown || $[21] !== id2 || $[22] !== rest || $[23] !== rootRef || $[24] !== t2 ? (t3 = (0, import_jsx_runtime3.jsxs)(As, { id: id2, onKeyDown: handleKeyDown, tabIndex: -1, ...rest, ref: rootRef, children: [
    children,
    t2
  ] }), $[18] = As, $[19] = children, $[20] = handleKeyDown, $[21] = id2, $[22] = rest, $[23] = rootRef, $[24] = t2, $[25] = t3) : t3 = $[25], t3;
});
var DocumentActionShortcuts = (0, import_react3.memo)((props) => {
  const $ = (0, import_compiler_runtime2.c)(12);
  ...
  const as = t0 === void 0 ? "div" : t0, [activeIndex, setActiveIndex] = (0, import_react3.useState)(-1);
  let t1;
  ...
  let t2;
  return $[6] !== actionsBoxElement || $[7] !== activeIndex || $[8] !== as || $[9] !== children || $[10] !== rest ? (t2 = (0, import_jsx_runtime3.jsx)(RenderActionCollectionState, { children: (t3) => {
    const {
      states
    } = t3;
    return (0, import_jsx_runtime3.jsx)(KeyboardShortcutResponder, { ...rest, activeIndex, actionsBoxElement, as, onActionStart, states, children });
...
var HiddenCheckmarkIcon = () => {
  const $ = (0, import_compiler_runtime2.c)(1);
  let t0;
  return $[0] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t0 = (0, import_jsx_runtime3.jsx)(CheckmarkIcon, { style: {
    visibility: "hidden"
  } }), $[0] = t0) : t0 = $[0], t0;
};
...
function getMenuItems(params) {
  const inspectorItems = getInspectorItems(params), items2 = [
...
function DocumentLayoutError(props) {
  ...
  let t1;
  $[2] !== t2 || $[3] !== t0 ? (t1 = (0, import_jsx_runtime3.jsx)(Translate, { t: t2, i18nKey: "panes.document-pane.document-unknown-type.title", values: t0 }), $[2] = t2, $[3] = t0, $[4] = t1) : t1 = $[4];
  let t22;
  $[5] !== documentType || $[6] !== t2 ? (t22 = documentType && (0, import_jsx_runtime3.jsx)(Text, { as: "p", children: (0, import_jsx_runtime3.jsx)(Translate, { t: t2, i18nKey: "panes.document-pane.document-unknown-type.text", values: {
    documentType
  } }) }), $[5] = documentType, $[6] = t2, $[7] = t22) : t22 = $[7];
  let t3;
  $[8] !== documentType || $[9] !== t2 ? (t3 = !documentType && (0, import_jsx_runtime3.jsx)(Text, { as: "p", children: t2("panes.document-pane.document-unknown-type.without-schema.text") }), $[8] = documentType, $[9] = t2, $[10] = t3) : t3 = $[10];
  let t4;
  $[11] !== value ? (t4 = isDev && value && (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
    (0, import_jsx_runtime3.jsx)(Text, { as: "p", children: "Here is the JSON representation of the document:" }),
    (0, import_jsx_runtime3.jsx)(Card, { padding: 3, overflow: "auto", radius: 2, shadow: 1, tone: "inherit", children: (0, import_jsx_runtime3.jsx)(Code, { language: "json", size: [1, 1, 2], children: JSON.stringify(value, null, 2) }) })
  ] }), $[11] = value, $[12] = t4) : t4 = $[12];
  let t5;
  $[13] !== t22 || $[14] !== t3 || $[15] !== t4 ? (t5 = (0, import_jsx_runtime3.jsxs)(Stack, { space: 4, children: [
    t22,
    t3,
    t4
  ] }), $[13] = t22, $[14] = t3, $[15] = t4, $[16] = t5) : t5 = $[16];
  let t6;
  return $[17] !== currentMinWidth || $[18] !== minWidth || $[19] !== paneKey || $[20] !== t1 || $[21] !== t5 ? (t6 = (0, import_jsx_runtime3.jsx)(ErrorPane, { currentMinWidth, flex: 2.5, minWidth, paneKey, title: t1, tone: "caution", children: t5 }), $[17] = currentMinWidth, $[18] = minWidth, $[19] = paneKey, $[20] = t1, $[21] = t5, $[22] = t6) : t6 = $[22], t6;
}
...
function DocumentLayoutFooter(t0) {
  ...
  let t3;
  $[4] !== createLinkMetadata || $[5] !== setActionsBoxElement ? (t3 = (0, import_jsx_runtime3.jsx)(TooltipDelayGroupProvider, { children: (0, import_jsx_runtime3.jsx)(DocumentStatusBar, { actionsBoxRef: setActionsBoxElement, createLinkMetadata }) }), $[4] = createLinkMetadata, $[5] = setActionsBoxElement, $[6] = t3) : t3 = $[6];
  let t4;
  $[7] !== setFooterElement || $[8] !== t3 ? (t4 = (0, import_jsx_runtime3.jsx)(PaneFooter, { ref: setFooterElement, padding: 1, children: t3 }), $[7] = setFooterElement, $[8] = t3, $[9] = t4) : t4 = $[9];
  let t5;
  $[10] !== t4 || $[11] !== zOffsets.portal ? (t5 = (0, import_jsx_runtime3.jsx)(DialogProvider, { position: DIALOG_PROVIDER_POSITION$1, zOffset: zOffsets.portal, children: t4 }), $[10] = t4, $[11] = zOffsets.portal, $[12] = t5) : t5 = $[12];
  let t6;
  return $[13] !== portalElements || $[14] !== t5 ? (t6 = (0, import_jsx_runtime3.jsx)(PortalProvider, { __unstable_elements: portalElements, children: t5 }), $[13] = portalElements, $[14] = t5, $[15] = t6) : t6 = $[15], t6;
}
var EMPTY_ARRAY$1 = [];
...
var StyledChangeConnectorRoot = at(ChangeConnectorRoot)`
  flex: 1;
  display: flex;
...
function DocumentLayout() {
  const $ = (0, import_compiler_runtime2.c)(82), {
    ...
    collapsed: layoutCollapsed
  } = usePaneLayout(), zOffsets = useZIndex(), [rootElement, setRootElement] = (0, import_react3.useState)(null), [footerElement, setFooterElement] = (0, import_react3.useState)(null), [headerElement, setHeaderElement] = (0, import_react3.useState)(null), [actionsBoxElement, setActionsBoxElement] = (0, import_react3.useState)(null), [documentPanelPortalElement, setDocumentPanelPortalElement] = (0, import_react3.useState)(null);
  let t0;
  ...
  if (!schemaType) {
    let t92;
    return $[29] !== currentMinWidth || $[30] !== documentType || $[31] !== minWidth || $[32] !== paneKey || $[33] !== value ? (t92 = (0, import_jsx_runtime3.jsx)(DocumentLayoutError, { currentMinWidth, documentType, minWidth, paneKey, value }), $[29] = currentMinWidth, $[30] = documentType, $[31] = minWidth, $[32] = paneKey, $[33] = value, $[34] = t92) : t92 = $[34], t92;
  }
  let t9;
  $[35] !== documentId || $[36] !== documentType || $[37] !== inspectors2 ? (t9 = inspectors2.length > 0 && (0, import_jsx_runtime3.jsx)(DocumentInspectorMenuItemsResolver, { documentId, documentType, inspectors: inspectors2, onMenuItems: setInspectorMenuItems }), $[35] = documentId, $[36] = documentType, $[37] = inspectors2, $[38] = t9) : t9 = $[38];
  let t10;
  $[39] !== documentId || $[40] !== documentType || $[41] !== fieldActions || $[42] !== schemaType ? (t10 = fieldActions.length > 0 && schemaType && (0, import_jsx_runtime3.jsx)(FieldActionsResolver, { actions: fieldActions, documentId, documentType, onActions: setRootFieldActionNodes, path: EMPTY_ARRAY$1, schemaType }), $[39] = documentId, $[40] = documentType, $[41] = fieldActions, $[42] = schemaType, $[43] = t10) : t10 = $[43];
  let t11;
  $[44] !== menuItems ? (t11 = (0, import_jsx_runtime3.jsx)(DocumentPanelHeader, { ref: setHeaderElement, menuItems }), $[44] = menuItems, $[45] = t11) : t11 = $[45];
  ...
  let t16;
  $[46] !== documentPanelPortalElement ? (t16 = (0, import_jsx_runtime3.jsx)(DocumentLayoutFooter, { documentPanelPortalElement, setFooterElement, setActionsBoxElement }), $[46] = documentPanelPortalElement, $[47] = t16) : t16 = $[47];
  let t17;
  $[48] !== inspectOpen || $[49] !== rootElement || $[50] !== t14 || $[51] !== t15 || $[52] !== t16 ? (t17 = (0, import_jsx_runtime3.jsx)(DocumentPanel, { footerHeight: t14, headerHeight: t15, isInspectOpen: inspectOpen, rootElement, setDocumentPanelPortalElement, footer: t16 }), $[48] = inspectOpen, $[49] = rootElement, $[50] = t14, $[51] = t15, $[52] = t16, $[53] = t17) : t17 = $[53];
  let t18;
  $[54] !== onConnectorSetFocus || $[55] !== onHistoryOpen || $[56] !== t13 || $[57] !== t17 ? (t18 = (0, import_jsx_runtime3.jsx)(StyledChangeConnectorRoot, { "data-testid": "change-connector-root", isReviewChangesOpen: t13, onOpenReviewChanges: onHistoryOpen, onSetFocus: onConnectorSetFocus, children: t17 }), $[54] = onConnectorSetFocus, $[55] = onHistoryOpen, $[56] = t13, $[57] = t17, $[58] = t18) : t18 = $[58];
  let t19;
  $[59] !== t12 || $[60] !== t18 ? (t19 = (0, import_jsx_runtime3.jsx)(Flex, { direction: "column", flex: 1, height: t12, children: t18 }), $[59] = t12, $[60] = t18, $[61] = t19) : t19 = $[61];
  let t20;
  $[62] !== t19 || $[63] !== zOffsets.paneDialog ? (t20 = (0, import_jsx_runtime3.jsx)(DialogProvider, { position: DIALOG_PROVIDER_POSITION, zOffset: zOffsets.paneDialog, children: t19 }), $[62] = t19, $[63] = zOffsets.paneDialog, $[64] = t20) : t20 = $[64];
  let t21;
  $[65] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t21 = (0, import_jsx_runtime3.jsx)(DocumentOperationResults, {}), $[65] = t21) : t21 = $[65];
  let t222;
  $[66] !== actionsBoxElement || $[67] !== currentMinWidth || $[68] !== handleKeyUp || $[69] !== minWidth || $[70] !== paneKey || $[71] !== t11 || $[72] !== t20 ? (t222 = (0, import_jsx_runtime3.jsxs)(DocumentActionShortcuts, { actionsBoxElement, as: Pane, currentMinWidth, "data-testid": "document-pane", flex: 2.5, id: paneKey, minWidth, onKeyUp: handleKeyUp, rootRef: setRootElement, children: [
    t11,
    t20,
    t21
  ] }), $[66] = actionsBoxElement, $[67] = currentMinWidth, $[68] = handleKeyUp, $[69] = minWidth, $[70] = paneKey, $[71] = t11, $[72] = t20, $[73] = t222) : t222 = $[73];
  let t23;
  $[74] !== rootFieldActionNodes || $[75] !== t222 ? (t23 = (0, import_jsx_runtime3.jsx)(DocumentActionsProvider, { children: (0, import_jsx_runtime3.jsx)(FieldActionsProvider, { actions: rootFieldActionNodes, path: EMPTY_ARRAY$1, children: t222 }) }), $[74] = rootFieldActionNodes, $[75] = t222, $[76] = t23) : t23 = $[76];
  let t24;
  return $[77] !== t10 || $[78] !== t23 || $[79] !== t9 || $[80] !== value ? (t24 = (0, import_jsx_runtime3.jsxs)(GetFormValueProvider, { value, children: [
    t9,
    t10,
    t23
...
var useDocumentLastRev = (documentId, documentType) => {
  const $ = (0, import_compiler_runtime2.c)(11), historyStore = useHistoryStore(), [lastRevisionDocument, setLastRevisionDocument] = (0, import_react3.useState)(null), [loading, setLoading] = (0, import_react3.useState)(false);
  let t0;
  ...
  }, t2 = [documentId, lastNonDeletedRevId, historyStore], $[3] = documentId, $[4] = historyStore, $[5] = lastNonDeletedRevId, $[6] = t1, $[7] = t2) : (t1 = $[6], t2 = $[7]), (0, import_react3.useEffect)(t1, t2);
  let t3;
...
function useDocumentPaneInspector(t0) {
  ...
  const [inspectorName, setInspectorName] = (0, import_react3.useState)(t2), inspectParamRef = (0, import_react3.useRef)(params.inspect);
  let t3, t4;
  $[6] !== params.inspect ? (t3 = () => {
    inspectParamRef.current !== params.inspect && (inspectParamRef.current = params.inspect, setInspectorName(params.inspect || null));
  }, t4 = [params.inspect], $[6] = params.inspect, $[7] = t3, $[8] = t4) : (t3 = $[7], t4 = $[8]), (0, import_react3.useEffect)(t3, t4);
  let t5;
...
function usePreviewUrl(value) {
  ...
  $[1] !== value ? (t1 = () => {
    subject.next(value);
  }, t2 = [subject, value], $[1] = value, $[2] = t1, $[3] = t2) : (t1 = $[2], t2 = $[3]), (0, import_react3.useEffect)(t1, t2);
  let t3;
...
function DocumentPaneProvider(props) {
  ...
  const {
    ...
    inspectOpen,
    handleLegacyInspectClose
  } = useDocumentPaneInspector(t13), [isDeleting, setIsDeleting] = (0, import_react3.useState)(false), {
    lastRevisionDocument
  ...
  }, t37 = [documentId, documentType, schemaType, onChange, setDocumentMeta], $[118] = documentId, $[119] = documentType, $[120] = onChange, $[121] = schemaType, $[122] = setDocumentMeta, $[123] = t36, $[124] = t37) : (t36 = $[123], t37 = $[124]), (0, import_react3.useEffect)(t36, t37);
  let t38;
  ...
  const documentPane = t42, pathRef = (0, import_react3.useRef)(void 0);
  let t43, t44;
  ...
  }, t44 = [formStateRef, onProgrammaticFocus, paneRouter, params, ready, enhancedObjectDialogEnabled], $[193] = enhancedObjectDialogEnabled, $[194] = formStateRef, $[195] = onProgrammaticFocus, $[196] = paneRouter, $[197] = params, $[198] = ready, $[199] = t43, $[200] = t44) : (t43 = $[199], t44 = $[200]), (0, import_react3.useEffect)(t43, t44);
  let t45;
  return $[201] !== children || $[202] !== documentPane ? (t45 = (0, import_jsx_runtime3.jsx)(DocumentPaneContext.Provider, { value: documentPane, children }), $[201] = children, $[202] = documentPane, $[203] = t45) : t45 = $[203], t45;
}
...
var DocumentEventsPane = (props) => {
  ...
  let t13;
  $[30] !== historyStoreProps || $[31] !== historyVersion || $[32] !== props ? (t13 = historyVersion ? (0, import_jsx_runtime3.jsx)(PerspectiveProvider, { selectedPerspectiveName: historyVersion, excludedPerspectives: EMPTY_ARRAY$z, children: (0, import_jsx_runtime3.jsx)(DocumentPaneProvider, { ...props, historyStore: historyStoreProps }) }) : (0, import_jsx_runtime3.jsx)(DocumentPaneProvider, { ...props, historyStore: historyStoreProps }), $[30] = historyStoreProps, $[31] = historyVersion, $[32] = props, $[33] = t13) : t13 = $[33];
  let t14;
  return $[34] !== t13 || $[35] !== value ? (t14 = (0, import_jsx_runtime3.jsx)(EventsProvider, { value, children: t13 }), $[34] = t13, $[35] = value, $[36] = t14) : t14 = $[36], t14;
};
function _temp$i(e2) {
...
var DocumentPaneWithLegacyTimelineStore = (props) => {
  const $ = (0, import_compiler_runtime2.c)(20), {
    pane: pane2
  } = props, paneRouter = usePaneRouter(), options = usePaneOptions(pane2.options, paneRouter.params), params = paneRouter.params || EMPTY_PARAMS$2, [timelineError, setTimelineError] = (0, import_react3.useState)(null);
  let t0;
  ...
  let t7;
  return $[17] !== historyStoreProps || $[18] !== props ? (t7 = (0, import_jsx_runtime3.jsx)(DocumentPaneProvider, { ...props, historyStore: historyStoreProps }), $[17] = historyStoreProps, $[18] = props, $[19] = t7) : t7 = $[19], t7;
};
...
function DocumentPerspectiveProvider(t0) {
  ...
  if (scheduledDraft) {
    let t1;
    return $[0] !== children || $[1] !== excludedPerspectives || $[2] !== scheduledDraft ? (t1 = (0, import_jsx_runtime3.jsx)(PerspectiveProvider, { selectedPerspectiveName: scheduledDraft, excludedPerspectives, children }), $[0] = children, $[1] = excludedPerspectives, $[2] = scheduledDraft, $[3] = t1) : t1 = $[3], t1;
  }
  return children;
}
var DocumentPaneProviderWrapper = (0, import_react3.memo)((props) => {
  ...
  let t1;
  $[3] !== props || $[4] !== source.beta?.eventsAPI?.documents ? (t1 = source.beta?.eventsAPI?.documents ? (0, import_jsx_runtime3.jsx)(DocumentEventsPane, { ...props }) : (0, import_jsx_runtime3.jsx)(DocumentPaneWithLegacyTimelineStore, { ...props }), $[3] = props, $[4] = source.beta?.eventsAPI?.documents, $[5] = t1) : t1 = $[5];
  let t2;
  return $[6] !== handleSetScheduledDraftPerspective || $[7] !== t1 ? (t2 = (0, import_jsx_runtime3.jsx)(DocumentPerspectiveProvider, { children: (0, import_jsx_runtime3.jsx)(SingleDocReleaseProvider, { onSetScheduledDraftPerspective: handleSetScheduledDraftPerspective, children: t1 }) }), $[6] = handleSetScheduledDraftPerspective, $[7] = t1, $[8] = t2) : t2 = $[8], t2;
});
...
function useResetHistoryParams() {
  const $ = (0, import_compiler_runtime2.c)(10), {
    ...
    selectedPerspectiveName
  } = usePerspective(), isMounted = (0, import_react3.useRef)(false);
  let t1;
  ...
  const updateHistoryParams = (0, import_react3.useEffectEvent)(t1);
  let t2;
  ...
  let t3;
  $[6] !== selectedPerspectiveName ? (t3 = [selectedPerspectiveName], $[6] = selectedPerspectiveName, $[7] = t3) : t3 = $[7], (0, import_react3.useEffect)(t2, t3);
  let t4, t5;
  $[8] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t4 = () => (isMounted.current = true, () => {
    isMounted.current = false;
  }), t5 = [], $[8] = t4, $[9] = t5) : (t4 = $[8], t5 = $[9]), (0, import_react3.useEffect)(t4, t5);
}
var DocumentPane = (0, import_react3.memo)(function(props) {
  const $ = (0, import_compiler_runtime2.c)(5), {
    name: parentSourceName
  } = useSource(), t0 = props.pane.source || parentSourceName;
  let t1;
  $[0] !== props ? (t1 = (0, import_jsx_runtime3.jsx)(CopyPasteProvider, { children: (0, import_jsx_runtime3.jsx)(DocumentPaneInner, { ...props }) }), $[0] = props, $[1] = t1) : t1 = $[1];
  let t2;
  return $[2] !== t0 || $[3] !== t1 ? (t2 = (0, import_jsx_runtime3.jsx)(SourceProvider, { name: t0, children: t1 }), $[2] = t0, $[3] = t1, $[4] = t2) : t2 = $[4], t2;
});
function DocumentPaneInner(props) {
  ...
  if (options.type === "*" && !isLoaded) {
    ...
    let t62;
    return $[20] !== paneKey || $[21] !== t522 ? (t62 = (0, import_jsx_runtime3.jsx)(LoadingPane, { flex: 2.5, minWidth: 320, paneKey, title: t522 }), $[20] = paneKey, $[21] = t522, $[22] = t62) : t62 = $[22], t62;
  }
  if (!documentType) {
    let t522;
    ...
    let t82;
    $[28] !== t5 || $[29] !== t62 ? (t82 = (0, import_jsx_runtime3.jsx)(Stack, { space: 4, children: (0, import_jsx_runtime3.jsx)(Text, { as: "p", children: (0, import_jsx_runtime3.jsx)(Translate, { t: t5, i18nKey: "panes.document-pane.document-not-found.text", values: t62, components: t72 }) }) }), $[28] = t5, $[29] = t62, $[30] = t82) : t82 = $[30];
    let t92;
    return $[31] !== paneKey || $[32] !== t522 || $[33] !== t82 ? (t92 = (0, import_jsx_runtime3.jsx)(ErrorPane, { flex: 2.5, minWidth: 320, paneKey, title: t522, children: t82 }), $[31] = paneKey, $[32] = t522, $[33] = t82, $[34] = t92) : t92 = $[34], t92;
  }
  const t52 = `${documentType}-${options.id}-${selectedPerspectiveName || ""}`;
  let t6;
  $[35] !== DocumentLayout2 || $[36] !== options.id || $[37] !== options.type ? (t6 = (0, import_jsx_runtime3.jsx)(DocumentLayout2, { documentId: options.id, documentType: options.type }), $[35] = DocumentLayout2, $[36] = options.id, $[37] = options.type, $[38] = t6) : t6 = $[38];
  let t7;
  $[39] !== options.id || $[40] !== options.type || $[41] !== t6 ? (t7 = (0, import_jsx_runtime3.jsx)(CommentsWrapper, { documentId: options.id, documentType: options.type, children: t6 }), $[39] = options.id, $[40] = options.type, $[41] = t6, $[42] = t7) : t7 = $[42];
  let t8;
  $[43] !== options.id || $[44] !== options.type || $[45] !== t7 ? (t8 = (0, import_jsx_runtime3.jsx)(DiffViewDocumentLayout, { documentId: options.id, documentType: options.type, children: t7 }), $[43] = options.id, $[44] = options.type, $[45] = t7, $[46] = t8) : t8 = $[46];
  let t9;
  $[47] !== ReferenceChildLink2 || $[48] !== activePath || $[49] !== handleEditReference || $[50] !== t8 || $[51] !== templatePermissions ? (t9 = (0, import_jsx_runtime3.jsx)(ReferenceInputOptionsProvider, { EditReferenceLinkComponent: ReferenceChildLink2, onEditReference: handleEditReference, initialValueTemplateItems: templatePermissions, activePath, children: t8 }), $[47] = ReferenceChildLink2, $[48] = activePath, $[49] = handleEditReference, $[50] = t8, $[51] = templatePermissions, $[52] = t9) : t9 = $[52];
  let t10;
  return $[53] !== providerProps || $[54] !== t52 || $[55] !== t9 ? (t10 = (0, import_jsx_runtime3.jsx)(DocumentPaneProviderWrapper, { ...providerProps, children: t9 }, t52), $[53] = providerProps, $[54] = t52, $[55] = t9, $[56] = t10) : t10 = $[56], t10;
}
function _temp$g(t0) {
  const {
    children
  } = t0;
  return (0, import_jsx_runtime3.jsx)("code", { children });
}
...
var BackLink = (0, import_react3.forwardRef)(function(props, ref) {
  const $ = (0, import_compiler_runtime2.c)(9), {
    routerPanesState,
    groupIndex
  } = (0, import_react3.useContext)(PaneRouterContext);
  let t0;
  ...
  const state2 = t1;
  let t2;
  return $[5] !== props || $[6] !== ref || $[7] !== state2 ? (t2 = (0, import_jsx_runtime3.jsx)(StateLink, { ...props, ref, state: state2 }), $[5] = props, $[6] = ref, $[7] = state2, $[8] = t2) : t2 = $[8], t2;
});
var ChildLink = (0, import_react3.forwardRef)(function(props, ref) {
  const $ = (0, import_compiler_runtime2.c)(19);
  ...
  if ($[5] !== childId || $[6] !== childParameters || $[7] !== childPayload || $[8] !== groupIndex || $[9] !== routerPanesState) {
    ...
    t0 = $[10];
  let t1;
  return $[15] !== ref || $[16] !== rest || $[17] !== t0 ? (t1 = (0, import_jsx_runtime3.jsx)(StateLink, { ...rest, ref, state: t0 }), $[15] = ref, $[16] = rest, $[17] = t0, $[18] = t1) : t1 = $[18], t1;
});
var ParameterizedLink = (0, import_react3.forwardRef)(function(props, ref) {
  const $ = (0, import_compiler_runtime2.c)(20), {
  ...
  const nextState = t4;
  let t5;
  return $[16] !== nextState || $[17] !== ref || $[18] !== rest ? (t5 = (0, import_jsx_runtime3.jsx)(StateLink, { ref, ...rest, state: nextState }), $[16] = nextState, $[17] = ref, $[18] = rest, $[19] = t5) : t5 = $[19], t5;
});
var ReferenceChildLink = (0, import_react3.forwardRef)(function(t0, ref) {
  const $ = (0, import_compiler_runtime2.c)(24);
  ...
  let t6;
  return $[17] !== children || $[18] !== ref || $[19] !== rest || $[20] !== t1 || $[21] !== t2 || $[22] !== t5 ? (t6 = (0, import_jsx_runtime3.jsx)(ChildLink, { ...rest, ref, childId: t1, childPayload: t2, childParameters: t5, children }), $[17] = children, $[18] = ref, $[19] = rest, $[20] = t1, $[21] = t2, $[22] = t5, $[23] = t6) : t6 = $[23], t6;
});
var emptyArray = [];
function PaneRouterProvider(props) {
  ...
  const ctx = t14;
  let t15;
  return $[57] !== children || $[58] !== ctx ? (t15 = (0, import_jsx_runtime3.jsx)(PaneRouterContext.Provider, { value: ctx, children }), $[57] = children, $[58] = ctx, $[59] = t15) : t15 = $[59], t15;
}
...
function UnknownPane(props) {
  ...
  let t22;
  $[4] !== t1 ? (t22 = (0, import_jsx_runtime3.jsx)(PaneHeader$1, { title: t1 }), $[4] = t1, $[5] = t22) : t22 = $[5];
  let t3;
  $[6] !== t2 || $[7] !== type2 ? (t3 = (0, import_jsx_runtime3.jsx)(PaneContent, { children: (0, import_jsx_runtime3.jsx)(Box, { padding: 4, children: typeof type2 == "string" ? (0, import_jsx_runtime3.jsx)(Text, { as: "p", muted: true, children: (0, import_jsx_runtime3.jsx)(Translate, { t: t2, i18nKey: "panes.unknown-pane-type.unknown-type.text", values: {
    type: type2
  } }) }) : (0, import_jsx_runtime3.jsx)(Text, { as: "p", muted: true, children: (0, import_jsx_runtime3.jsx)(Translate, { t: t2, i18nKey: "panes.unknown-pane-type.missing-type.text" }) }) }) }), $[6] = t2, $[7] = type2, $[8] = t3) : t3 = $[8];
  let t4;
  return $[9] !== isSelected || $[10] !== paneKey || $[11] !== t22 || $[12] !== t3 ? (t4 = (0, import_jsx_runtime3.jsxs)(Pane, { id: paneKey, selected: isSelected, children: [
    t22,
    t3
  ] }), $[9] = isSelected, $[10] = paneKey, $[11] = t22, $[12] = t3, $[13] = t4) : t4 = $[13], t4;
}
var paneMap = {
  component: (0, import_react3.lazy)(() => import("./index2-XIKL555L.js")),
  document: (0, import_react3.lazy)(() => Promise.resolve().then(function() {
    return pane$1;
  })),
  documentList: (0, import_react3.lazy)(() => Promise.resolve().then(function() {
    return pane;
  })),
  list: (0, import_react3.lazy)(() => import("./index3-23WPZGNO.js"))
};
var StructureToolPane = (0, import_react3.memo)(function(props) {
  const $ = (0, import_compiler_runtime2.c)(25), {
    active,
    childItemId,
    groupIndex,
  ...
  let t0;
  $[0] !== paneKey || $[1] !== path || $[2] !== selected ? (t0 = (0, import_jsx_runtime3.jsx)(LoadingPane, { paneKey, path, selected }), $[0] = paneKey, $[1] = path, $[2] = selected, $[3] = t0) : t0 = $[3];
  const t1 = childItemId || "";
  let t2;
  $[4] !== PaneComponent || $[5] !== active || $[6] !== index || $[7] !== itemId || $[8] !== maximized || $[9] !== onSetMaximizedPane || $[10] !== pane2 || $[11] !== paneKey || $[12] !== selected || $[13] !== t1 ? (t2 = (0, import_jsx_runtime3.jsx)(PaneComponent, { childItemId: t1, index, itemId, isActive: active, isSelected: selected, paneKey, pane: pane2, maximized, onSetMaximizedPane }), $[4] = PaneComponent, $[5] = active, $[6] = index, $[7] = itemId, $[8] = maximized, $[9] = onSetMaximizedPane, $[10] = pane2, $[11] = paneKey, $[12] = selected, $[13] = t1, $[14] = t2) : t2 = $[14];
  let t3;
  $[15] !== t0 || $[16] !== t2 ? (t3 = (0, import_jsx_runtime3.jsx)(import_react3.Suspense, { fallback: t0, children: t2 }), $[15] = t0, $[16] = t2, $[17] = t3) : t3 = $[17];
  let t4;
  return $[18] !== groupIndex || $[19] !== index || $[20] !== params || $[21] !== payload || $[22] !== siblingIndex || $[23] !== t3 ? (t4 = (0, import_jsx_runtime3.jsx)(PaneRouterProvider, { flatIndex: index, index: groupIndex, params, payload, siblingIndex, children: t3 }), $[18] = groupIndex, $[19] = index, $[20] = params, $[21] = payload, $[22] = siblingIndex, $[23] = t3, $[24] = t4) : t4 = $[24], t4;
}, ({
  params: prevParams = {},
...
function DocTitle(props) {
  ...
  if (!schemaType) {
    ...
    let t12;
    return $[3] !== t02 ? (t12 = (0, import_jsx_runtime3.jsx)("code", { children: t02 }), $[3] = t02, $[4] = t12) : t12 = $[4], t12;
  }
  let t0;
  $[5] !== t2 || $[6] !== title ? (t0 = title || (0, import_jsx_runtime3.jsx)("span", { style: {
    color: "var(--card-muted-fg-color)"
  }, children: t2("doc-title.fallback.text") }), $[5] = t2, $[6] = title, $[7] = t0) : t0 = $[7];
  let t1;
  return $[8] !== t0 ? (t1 = (0, import_jsx_runtime3.jsx)(import_jsx_runtime3.Fragment, { children: t0 }), $[8] = t0, $[9] = t1) : t1 = $[9], t1;
}
var ChevronWrapper = at(Box)`
  margin-left: auto;
`;
var CrossDatasetReferencesDetails = at.details`
  flex: none;
...
`;
var CrossDatasetReferencesSummary = at.summary`
  list-style: none;
...
var OtherReferenceCount = (props) => {
  ...
  let t1;
  $[3] !== t0 ? (t1 = (0, import_jsx_runtime3.jsx)(Text, { size: 1, muted: true, children: t0 }), $[3] = t0, $[4] = t1) : t1 = $[4];
  let t22;
  $[5] !== t2 ? (t22 = t2("confirm-delete-dialog.other-reference-count.tooltip"), $[5] = t2, $[6] = t22) : t22 = $[6];
  let t3;
  $[7] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t3 = (0, import_jsx_runtime3.jsx)(Text, { size: 1, muted: true, children: (0, import_jsx_runtime3.jsx)(InfoOutlineIcon, {}) }), $[7] = t3) : t3 = $[7];
  let t4;
  $[8] !== t22 ? (t4 = (0, import_jsx_runtime3.jsx)(Tooltip, { portal: true, placement: "top", content: t22, children: t3 }), $[8] = t22, $[9] = t4) : t4 = $[9];
  let t5;
  return $[10] !== t1 || $[11] !== t4 ? (t5 = (0, import_jsx_runtime3.jsx)(Box, { padding: 2, children: (0, import_jsx_runtime3.jsxs)(Inline, { space: 2, children: [
    t1,
    t4
...
function PaneItemPreview(props) {
  ...
  let t3;
  $[9] !== isLoading || $[10] !== presence || $[11] !== versionsInfo.draft || $[12] !== versionsInfo.published || $[13] !== versionsInfo.versions ? (t3 = isLoading ? null : (0, import_jsx_runtime3.jsx)(TooltipDelayGroupProvider, { children: (0, import_jsx_runtime3.jsxs)(Flex, { align: "center", gap: 3, children: [
    presence && presence.length > 0 && (0, import_jsx_runtime3.jsx)(DocumentPreviewPresence, { presence }),
    (0, import_jsx_runtime3.jsx)(DocumentStatusIndicator, { draft: versionsInfo.draft, published: versionsInfo.published, versions: versionsInfo.versions })
  ] }) }), $[9] = isLoading, $[10] = presence, $[11] = versionsInfo.draft, $[12] = versionsInfo.published, $[13] = versionsInfo.versions, $[14] = t3) : t3 = $[14];
  const status = t3;
  let t4;
  $[15] !== versionsInfo.draft || $[16] !== versionsInfo.published || $[17] !== versionsInfo.versions ? (t4 = (0, import_jsx_runtime3.jsx)(DocumentStatus, { draft: versionsInfo.draft, published: versionsInfo.published, versions: versionsInfo.versions }), $[15] = versionsInfo.draft, $[16] = versionsInfo.published, $[17] = versionsInfo.versions, $[18] = t4) : t4 = $[18];
  const tooltip = t4;
  let t5;
  ...
  let t6;
  return $[23] !== icon || $[24] !== isLoading || $[25] !== layout || $[26] !== status || $[27] !== t5 || $[28] !== tooltip ? (t6 = (0, import_jsx_runtime3.jsx)(SanityDefaultPreview, { ...t5, isPlaceholder: isLoading, icon, layout, status, tooltip }), $[23] = icon, $[24] = isLoading, $[25] = layout, $[26] = status, $[27] = t5, $[28] = tooltip, $[29] = t6) : t6 = $[29], t6;
}
var EMPTY_ARRAY = [];
function ReferencePreviewLink(props) {
  ...
  let t2;
  $[2] !== ReferenceChildLink2 || $[3] !== type2?.name || $[4] !== value?._id ? (t2 = function(linkProps) {
    return (0, import_jsx_runtime3.jsx)(ReferenceChildLink2, { documentId: value?._id, documentType: type2?.name, parentRefPath: EMPTY_ARRAY, ...linkProps });
  }, $[2] = ReferenceChildLink2, $[3] = type2?.name, $[4] = value?._id, $[5] = t2) : t2 = $[5];
  const t3 = t2, t4 = type2?.icon, t5 = documentPresence?.length > 0 ? documentPresence : EMPTY_ARRAY;
  let t6;
  $[6] !== documentPreviewStore || $[7] !== t4 || $[8] !== t5 || $[9] !== type2 || $[10] !== value ? (t6 = (0, import_jsx_runtime3.jsx)(PaneItemPreview, { documentPreviewStore, icon: t4, layout: "default", presence: t5, schemaType: type2, value }), $[6] = documentPreviewStore, $[7] = t4, $[8] = t5, $[9] = type2, $[10] = value, $[11] = t6) : t6 = $[11];
  let t7;
  return $[12] !== onClick || $[13] !== t3 || $[14] !== t6 ? (t7 = (0, import_jsx_runtime3.jsx)(PreviewCard, { __unstable_focusRing: true, as: t3, "data-as": "a", onClick, radius: 2, children: t6 }), $[12] = onClick, $[13] = t3, $[14] = t6, $[15] = t7) : t7 = $[15], t7;
}
var EllipsisText = at(Text)`
...
var VersionItemPreview = (t0) => {
  ...
  let t10;
  $[27] !== tone ? (t10 = (0, import_jsx_runtime3.jsx)(Text, { size: 1, children: (0, import_jsx_runtime3.jsx)(ReleaseAvatarIcon, { tone }) }), $[27] = tone, $[28] = t10) : t10 = $[28];
  let t11;
  $[29] !== getVersionBadgeText ? (t11 = getVersionBadgeText(), $[29] = getVersionBadgeText, $[30] = t11) : t11 = $[30];
  let t12;
  $[31] !== t11 ? (t12 = (0, import_jsx_runtime3.jsx)(EllipsisText, { size: 1, weight: "medium", textOverflow: "ellipsis", children: t11 }), $[31] = t11, $[32] = t12) : t12 = $[32];
  let t13;
  $[33] !== t10 || $[34] !== t12 ? (t13 = (0, import_jsx_runtime3.jsxs)(Flex, { align: "center", gap: 2, paddingY: 2, paddingRight: 3, paddingLeft: 2, children: [
    t10,
    t12
  ] }), $[33] = t10, $[34] = t12, $[35] = t13) : t13 = $[35];
  let t14;
  $[36] !== t13 || $[37] !== tone ? (t14 = (0, import_jsx_runtime3.jsx)(Card, { border: true, radius: "full", children: (0, import_jsx_runtime3.jsx)(Card, { radius: "full", tone, style: t9, children: t13 }) }), $[36] = t13, $[37] = tone, $[38] = t14) : t14 = $[38];
  let t15;
  return $[39] !== previewIsLoading || $[40] !== schemaType.icon || $[41] !== t14 || $[42] !== t7 ? (t15 = (0, import_jsx_runtime3.jsx)(SanityDefaultPreview, { ...t7, isPlaceholder: previewIsLoading, icon: t8, layout: "default", status: t14 }), $[39] = previewIsLoading, $[40] = schemaType.icon, $[41] = t14, $[42] = t7, $[43] = t15) : t15 = $[43], t15;
};
var VersionsPreviewList = (t0) => {
  ...
  let t2;
  $[3] !== documentVersions || $[4] !== schemaType ? (t2 = documentVersions?.map((version) => (0, import_jsx_runtime3.jsx)(VersionItemPreview, { versionId: version, schemaType }, version)), $[3] = documentVersions, $[4] = schemaType, $[5] = t2) : t2 = $[5];
  let t3;
  return $[6] !== t2 ? (t3 = (0, import_jsx_runtime3.jsx)(Card, { border: true, padding: 1, radius: 2, children: (0, import_jsx_runtime3.jsx)(Stack, { children: t2 }) }), $[6] = t2, $[7] = t3) : t3 = $[7], t3;
};
function ConfirmDeleteDialogBody(t0) {
  ...
  $[0] !== onReferenceLinkClick || $[1] !== schema || $[2] !== t2 ? (t1 = (item) => {
    const type2 = schema.get(item._type);
    return type2 ? (0, import_jsx_runtime3.jsx)(ReferencePreviewLink, { type: type2, value: item, onClick: onReferenceLinkClick }) : (0, import_jsx_runtime3.jsx)(Box, { padding: 2, children: (0, import_jsx_runtime3.jsx)(SanityDefaultPreview, { icon: UnknownIcon, title: t2("confirm-delete-dialog.preview-item.preview-unavailable.title"), subtitle: t2("confirm-delete-dialog.preview-item.preview-unavailable.subtitle", {
      documentId: item._id
    }), layout: "default" }) });
  }, $[0] = onReferenceLinkClick, $[1] = schema, $[2] = t2, $[3] = t1) : t1 = $[3];
  const renderPreviewItem = t1;
  let t22;
  $[4] !== action || $[5] !== documentTitle || $[6] !== documentType || $[7] !== documentVersions || $[8] !== t2 ? (t22 = () => (0, import_jsx_runtime3.jsxs)(Stack, { space: 4, children: [
    (0, import_jsx_runtime3.jsx)(Text, { as: "p", size: 1, children: (0, import_jsx_runtime3.jsx)(Translate, { t: t2, i18nKey: "confirm-delete-dialog.confirmation.text", context: action, components: {
      DocumentTitle: () => (0, import_jsx_runtime3.jsx)("strong", { children: documentTitle })
    } }) }),
    action === "delete" && (0, import_jsx_runtime3.jsx)(VersionsPreviewList, { documentType, documentVersions })
  ...
  let t10;
  $[24] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t10 = (0, import_jsx_runtime3.jsx)(Card, { borderTop: true, padding: 1 }), $[24] = t10) : t10 = $[24];
  let t11;
  $[25] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t11 = (0, import_jsx_runtime3.jsx)(Text, { "aria-hidden": "true", size: 1, children: (0, import_jsx_runtime3.jsx)(WarningOutlineIcon, {}) }), $[25] = t11) : t11 = $[25];
  let t12;
  ...
  let t14;
  $[30] !== t2 || $[31] !== t12 || $[32] !== t13 ? (t14 = (0, import_jsx_runtime3.jsxs)("div", { children: [
    t10,
    (0, import_jsx_runtime3.jsx)(Card, { padding: 3, radius: 2, tone: "caution", flex: "none", children: (0, import_jsx_runtime3.jsxs)(Flex, { children: [
      t11,
      (0, import_jsx_runtime3.jsx)(Box, { flex: 1, marginLeft: 3, children: (0, import_jsx_runtime3.jsx)(Text, { size: 1, children: (0, import_jsx_runtime3.jsx)(Translate, { i18nKey: "confirm-delete-dialog.referring-document-count.text", components: t12, t: t2, values: t13 }) }) })
    ] }) })
  ...
  let t16;
  $[36] !== action || $[37] !== t2 || $[38] !== t15 ? (t16 = (0, import_jsx_runtime3.jsx)(Box, { flex: "none", children: (0, import_jsx_runtime3.jsx)(Text, { size: 1, children: (0, import_jsx_runtime3.jsx)(Translate, { i18nKey: "confirm-delete-dialog.referring-documents-descriptor.text", t: t2, context: action, components: t15 }) }) }), $[36] = action, $[37] = t2, $[38] = t15, $[39] = t16) : t16 = $[39];
  let t17;
  $[40] !== internalReferences || $[41] !== renderPreviewItem ? (t17 = internalReferences.totalCount > 0 && (0, import_jsx_runtime3.jsxs)(Stack, { as: "ul", space: 2, "data-testid": "internal-references", children: [
    internalReferences?.references.map((item_0) => (0, import_jsx_runtime3.jsx)(Box, { as: "li", children: renderPreviewItem(item_0) }, item_0._id)),
    internalReferences.totalCount > internalReferences.references.length && (0, import_jsx_runtime3.jsx)(Box, { as: "li", padding: 3, children: (0, import_jsx_runtime3.jsx)(OtherReferenceCount, { ...internalReferences }) })
  ] }), $[40] = internalReferences, $[41] = renderPreviewItem, $[42] = t17) : t17 = $[42];
  let t18;
  $[43] !== crossDatasetReferences || $[44] !== datasetSubtitle || $[45] !== documentId || $[46] !== internalReferences.totalCount || $[47] !== normalizedDatasetNames.length || $[48] !== t2 || $[49] !== toast ? (t18 = crossDatasetReferences.totalCount > 0 && (0, import_jsx_runtime3.jsxs)(CrossDatasetReferencesDetails, { "data-testid": "cross-dataset-references", style: {
    borderTop: internalReferences.totalCount > 0 ? "1px solid var(--card-shadow-outline-color)" : void 0
  }, children: [
    (0, import_jsx_runtime3.jsx)(CrossDatasetReferencesSummary, { children: (0, import_jsx_runtime3.jsx)(Card, { as: "a", marginTop: internalReferences.totalCount > 0 ? 2 : 0, radius: 2, shadow: 1, paddingY: 1, children: (0, import_jsx_runtime3.jsxs)(Flex, { align: "center", gap: 3, paddingX: 3, paddingY: 1, children: [
      (0, import_jsx_runtime3.jsx)(Text, { size: 1, children: (0, import_jsx_runtime3.jsx)(DocumentsIcon, {}) }),
      (0, import_jsx_runtime3.jsxs)(Stack, { space: 2, children: [
        (0, import_jsx_runtime3.jsx)(Text, { textOverflow: "ellipsis", size: 1, children: t2("confirm-delete-dialog.cdr-summary.title", {
          count: normalizedDatasetNames.length,
          documentCount: t2("confirm-delete-dialog.cdr-summary.document-count", {
            count: crossDatasetReferences.totalCount
          })
        }) }),
        (0, import_jsx_runtime3.jsx)(Text, { title: datasetSubtitle, textOverflow: "ellipsis", size: 1, muted: true, children: datasetSubtitle })
      ] }),
      (0, import_jsx_runtime3.jsx)(ChevronWrapper, { children: (0, import_jsx_runtime3.jsx)(Text, { muted: true, size: 1, children: (0, import_jsx_runtime3.jsx)(ChevronDownIcon, {}) }) })
    ] }) }) }),
    (0, import_jsx_runtime3.jsxs)(Box, { overflow: "auto", paddingTop: 2, children: [
      (0, import_jsx_runtime3.jsxs)(Table$1, { children: [
        (0, import_jsx_runtime3.jsx)("thead", { children: (0, import_jsx_runtime3.jsxs)("tr", { children: [
          (0, import_jsx_runtime3.jsx)("th", { children: (0, import_jsx_runtime3.jsx)(Text, { muted: true, size: 1, style: {
            minWidth: "5rem"
          }, weight: "medium", children: t2("confirm-delete-dialog.cdr-table.project-id.label") }) }),
          (0, import_jsx_runtime3.jsx)("th", { children: (0, import_jsx_runtime3.jsx)(Text, { muted: true, size: 1, weight: "medium", children: t2("confirm-delete-dialog.cdr-table.dataset.label") }) }),
          (0, import_jsx_runtime3.jsx)("th", { children: (0, import_jsx_runtime3.jsx)(Text, { muted: true, size: 1, weight: "medium", children: t2("confirm-delete-dialog.cdr-table.document-id.label") }) })
        ] }) }),
        (0, import_jsx_runtime3.jsx)("tbody", { children: crossDatasetReferences.references.filter(_temp$e).map((t192, index) => {
          const {
            projectId,
            datasetName,
            documentId: referenceId
          } = t192;
          return (0, import_jsx_runtime3.jsxs)("tr", { children: [
            (0, import_jsx_runtime3.jsx)("td", { children: (0, import_jsx_runtime3.jsx)(Text, { size: 1, children: projectId }) }),
            (0, import_jsx_runtime3.jsx)("td", { children: (0, import_jsx_runtime3.jsx)(Text, { size: 1, children: datasetName || "unavailable" }) }),
            (0, import_jsx_runtime3.jsx)("td", { children: (0, import_jsx_runtime3.jsxs)(DocumentIdFlex, { align: "center", gap: 2, justify: "flex-end", children: [
              (0, import_jsx_runtime3.jsx)(Text, { textOverflow: "ellipsis", size: 1, children: referenceId || "unavailable" }),
              referenceId && (0, import_jsx_runtime3.jsx)(Button2, { mode: "bleed", icon: CopyIcon, tooltipProps: {
      ...
      (0, import_jsx_runtime3.jsx)(OtherReferenceCount, { ...crossDatasetReferences })
    ] })
  ...
  let t19;
  $[51] !== t17 || $[52] !== t18 ? (t19 = (0, import_jsx_runtime3.jsx)(Card, { radius: 2, shadow: 1, flex: "auto", padding: 1, children: (0, import_jsx_runtime3.jsxs)(Flex, { direction: "column", children: [
    t17,
    t18
  ...
  let t21;
  $[56] !== action || $[57] !== t2 || $[58] !== t20 ? (t21 = (0, import_jsx_runtime3.jsx)(Box, { flex: "none", children: (0, import_jsx_runtime3.jsx)(Text, { size: 1, children: (0, import_jsx_runtime3.jsx)(Translate, { i18nKey: "confirm-delete-dialog.referential-integrity-disclaimer.text", t: t2, context: action, components: t20 }) }) }), $[56] = action, $[57] = t2, $[58] = t20, $[59] = t21) : t21 = $[59];
  let t222;
  return $[60] !== t14 || $[61] !== t16 || $[62] !== t19 || $[63] !== t21 || $[64] !== t9 ? (t222 = (0, import_jsx_runtime3.jsxs)(Flex, { direction: "column", gap: 4, children: [
    t9,
    t14,
    t16,
    t19,
...
function ConfirmDeleteDialog(t0) {
  const $ = (0, import_compiler_runtime2.c)(51), {
    ...
    datasetNames,
    hasUnknownDatasetNames
  } = useReferringDocuments(id2);
  let t22;
  $[0] !== id2 || $[1] !== type2 ? (t22 = {
    _id: id2,
    _type: type2
  }, $[0] = id2, $[1] = type2, $[2] = t22) : t22 = $[2];
  const t3 = t22;
  let t4;
  $[3] !== t3 ? (t4 = (0, import_jsx_runtime3.jsx)(DocTitle, { document: t3 }), $[3] = t3, $[4] = t4) : t4 = $[4];
  const documentTitle = t4, showConfirmButton = !isLoading;
  let t5;
  $[5] !== id2 ? (t5 = getPublishedId(id2), $[5] = id2, $[6] = t5) : t5 = $[6];
  let t6;
  $[7] !== t5 ? (t6 = {
    documentId: t5
  }, $[7] = t5, $[8] = t6) : t6 = $[8];
  ...
  let t13;
  $[29] !== action || $[30] !== crossDatasetReferences || $[31] !== datasetNames || $[32] !== documentTitle || $[33] !== documentVersions || $[34] !== hasUnknownDatasetNames || $[35] !== id2 || $[36] !== internalReferences || $[37] !== isLoading || $[38] !== onCancel || $[39] !== projectIds || $[40] !== t2 || $[41] !== totalCount || $[42] !== type2 || $[43] !== versionsLoading ? (t13 = (0, import_jsx_runtime3.jsx)(DialogBody, { children: crossDatasetReferences && internalReferences && !isLoading && !versionsLoading ? (0, import_jsx_runtime3.jsx)(ConfirmDeleteDialogBody, { crossDatasetReferences, internalReferences, documentTitle, isLoading, totalCount, action, projectIds, datasetNames, hasUnknownDatasetNames, onReferenceLinkClick: onCancel, documentId: id2, documentType: type2, documentVersions }) : (0, import_jsx_runtime3.jsx)(LoadingContainer, { "data-testid": "loading-container", children: (0, import_jsx_runtime3.jsx)(LoadingBlock, { showText: true, title: t2("confirm-delete-dialog.loading.text") }) }) }), $[29] = action, $[30] = crossDatasetReferences, $[31] = datasetNames, $[32] = documentTitle, $[33] = documentVersions, $[34] = hasUnknownDatasetNames, $[35] = id2, $[36] = internalReferences, $[37] = isLoading, $[38] = onCancel, $[39] = projectIds, $[40] = t2, $[41] = totalCount, $[42] = type2, $[43] = versionsLoading, $[44] = t13) : t13 = $[44];
  let t14;
  return $[45] !== dialogId || $[46] !== onCancel || $[47] !== t12 || $[48] !== t13 || $[49] !== t8 ? (t14 = (0, import_jsx_runtime3.jsx)(Dialog2, { width: 1, id: dialogId, header: t8, footer: t12, onClose: onCancel, onClickOutside: onCancel, children: t13 }), $[45] = dialogId, $[46] = onCancel, $[47] = t12, $[48] = t13, $[49] = t8, $[50] = t14) : t14 = $[50], t14;
}
function ConfirmDeleteDialogContainer(props) {
  const $ = (0, import_compiler_runtime2.c)(6), {
    t: t2
  } = useTranslation(structureLocaleNamespace), id2 = (0, import_react3.useId)(), [error, setError] = (0, import_react3.useState)(null);
  let t0;
  $[0] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t0 = () => setError(null), $[0] = t0) : t0 = $[0];
  const handleRetry = t0;
  let t1;
  return $[1] !== error || $[2] !== id2 || $[3] !== props || $[4] !== t2 ? (t1 = error ? (0, import_jsx_runtime3.jsx)(Dialog2, { id: `dialog-error-${id2}`, "data-testid": "confirm-delete-error-dialog", header: t2("confirm-delete-dialog.error.title.text"), footer: {
    confirmButton: {
      text: t2("confirm-delete-dialog.error.retry-button.text"),
      onClick: handleRetry,
      tone: "default"
    }
  }, onClose: props.onCancel, children: (0, import_jsx_runtime3.jsx)(Box, { padding: 4, children: (0, import_jsx_runtime3.jsx)(Text, { size: 1, children: t2("confirm-delete-dialog.error.message.text") }) }) }) : (0, import_jsx_runtime3.jsx)(ErrorBoundary, { onCatch: setError, children: (0, import_jsx_runtime3.jsx)(ConfirmDeleteDialog, { ...props }) }), $[1] = error, $[2] = id2, $[3] = props, $[4] = t2, $[5] = t1) : t1 = $[5], t1;
}
var IntentButton = (0, import_react3.forwardRef)(function(props, ref) {
  const $ = (0, import_compiler_runtime2.c)(10);
  ...
  let t0;
  $[3] !== intent ? (t0 = (0, import_react3.forwardRef)(function(linkProps, linkRef) {
    return (0, import_jsx_runtime3.jsx)(IntentLink, { ...linkProps, intent: intent.type, params: intent.params, ref: linkRef, searchParams: intent.searchParams });
  }), $[3] = intent, $[4] = t0) : t0 = $[4];
  const Link2 = t0;
  let t1;
  return $[5] !== Link2 || $[6] !== props.disabled || $[7] !== ref || $[8] !== restProps ? (t1 = props.disabled ? (0, import_jsx_runtime3.jsx)(Button2, { ...restProps, as: "a", role: "link", "aria-disabled": "true" }) : (0, import_jsx_runtime3.jsx)(Button2, { ...restProps, as: Link2, "data-as": "a", ref }), $[5] = Link2, $[6] = props.disabled, $[7] = ref, $[8] = restProps, $[9] = t1) : t1 = $[9], t1;
});
function InsufficientPermissionsMessageTooltip(t0) {
  ...
  if (!reveal) {
    let t12;
    return $[0] !== children ? (t12 = (0, import_jsx_runtime3.jsx)(import_jsx_runtime3.Fragment, { children }), $[0] = children, $[1] = t12) : t12 = $[1], t12;
  }
  let t1;
  $[2] !== context || $[3] !== currentUser || $[4] !== loading || $[5] !== t2 ? (t1 = loading ? t2("insufficient-permissions-message-tooltip.loading-text") : (0, import_jsx_runtime3.jsx)(InsufficientPermissionsMessage, { context, currentUser }), $[2] = context, $[3] = currentUser, $[4] = loading, $[5] = t2, $[6] = t1) : t1 = $[6];
  let t22;
  $[7] !== children ? (t22 = (0, import_jsx_runtime3.jsx)("div", { children }), $[7] = children, $[8] = t22) : t22 = $[8];
  let t3;
  return $[9] !== t1 || $[10] !== t22 ? (t3 = (0, import_jsx_runtime3.jsx)(Tooltip, { content: t1, portal: true, children: t22 }), $[9] = t1, $[10] = t22, $[11] = t3) : t3 = $[11], t3;
}
var POPOVER_PROPS = {
  constrainSize: true,
  placement: "bottom",
...
function PaneHeaderCreateButton(t0) {
  ...
  if (nothingGranted) {
    ...
    let t52;
    $[10] !== t42 ? (t52 = (0, import_jsx_runtime3.jsx)(Button2, { "aria-label": t42, icon: AddIcon, "data-testid": "action-intent-button", disabled: true, mode: "bleed", tooltipProps: null }), $[10] = t42, $[11] = t52) : t52 = $[11];
    let t62;
    return $[12] !== isTemplatePermissionsLoading || $[13] !== t52 ? (t62 = (0, import_jsx_runtime3.jsx)(InsufficientPermissionsMessageTooltip, { context: "create-document-type", reveal: true, loading: isTemplatePermissionsLoading, children: t52 }), $[12] = isTemplatePermissionsLoading, $[13] = t52, $[14] = t62) : t62 = $[14], t62;
  }
  if (templateItems.length === 1) {
    ...
    let t10;
    $[26] !== disabled || $[27] !== intent || $[28] !== t52.title || $[29] !== t72 || $[30] !== t9 ? (t10 = (0, import_jsx_runtime3.jsx)(IntentButton, { "aria-label": t62, icon: t72, intent, mode: "bleed", disabled, "data-testid": "action-intent-button", tooltipProps: t9 }), $[26] = disabled, $[27] = intent, $[28] = t52.title, $[29] = t72, $[30] = t9, $[31] = t10) : t10 = $[31];
    let t11;
    return $[32] !== disabled || $[33] !== isTemplatePermissionsLoading || $[34] !== t10 ? (t11 = (0, import_jsx_runtime3.jsx)(InsufficientPermissionsMessageTooltip, { reveal: disabled, loading: isTemplatePermissionsLoading, context: "create-document-type", children: t10 }), $[32] = disabled, $[33] = isTemplatePermissionsLoading, $[34] = t10, $[35] = t11) : t11 = $[35], t11;
  }
  let t4;
  $[36] !== t2 ? (t4 = t2("pane-header.create-new-button.tooltip"), $[36] = t2, $[37] = t4) : t4 = $[37];
  let t5;
  $[38] !== t4 ? (t5 = (0, import_jsx_runtime3.jsx)(Button2, { icon: AddIcon, mode: "bleed", "data-testid": "multi-action-intent-button", tooltipProps: {
    content: t4
  } }), $[38] = t4, $[39] = t5) : t5 = $[39];
  let t6;
  if ($[40] !== getI18nText || $[41] !== isTemplatePermissionsLoading || $[42] !== permissionsById || $[43] !== selectedReleaseId || $[44] !== t2 || $[45] !== templateItems || $[46] !== templates) {
    ...
    $[48] !== getI18nText || $[49] !== isTemplatePermissionsLoading || $[50] !== permissionsById || $[51] !== selectedReleaseId || $[52] !== t2 || $[53] !== templates ? (t72 = (item, itemIndex) => {
      ...
      if (!template || !intent_0)
        return null;
      const Link2 = (0, import_react3.forwardRef)((linkProps, linkRef) => disabled_0 ? (0, import_jsx_runtime3.jsx)("button", { type: "button", disabled: true, ...linkProps, ref: linkRef }) : (0, import_jsx_runtime3.jsx)(IntentLink, { ...linkProps, intent: intent_0.type, params: intent_0.params, searchParams: intent_0.searchParams, ref: linkRef }));
      ...
      return (0, import_jsx_runtime3.jsx)(InsufficientPermissionsMessageTooltip, { context: "create-document-type", reveal: disabled_0, loading: isTemplatePermissionsLoading, children: (0, import_jsx_runtime3.jsx)(MenuItem2, { as: Link2, "data-as": disabled_0 ? "button" : "a", text: title, "aria-label": disabled_0 ? t2("pane-header.disabled-created-button.aria-label") : title, disabled: disabled_0, "data-testid": `action-intent-button-${itemIndex}` }) }, item.id);
    ...
    t6 = $[47];
  let t7;
  $[55] !== t6 ? (t7 = (0, import_jsx_runtime3.jsx)(Menu, { children: t6 }), $[55] = t6, $[56] = t7) : t7 = $[56];
  let t8;
  return $[57] !== t5 || $[58] !== t7 ? (t8 = (0, import_jsx_runtime3.jsx)(MenuButton, { button: t5, id: "create-menu", menu: t7, popover: POPOVER_PROPS }), $[57] = t5, $[58] = t7, $[59] = t8) : t8 = $[59], t8;
}
...
var PaneHeaderActions = (0, import_react3.memo)(function(props) {
  const $ = (0, import_compiler_runtime2.c)(28), {
  ...
  let t10;
  $[18] !== combinedInitialValueTemplates ? (t10 = (0, import_jsx_runtime3.jsx)(PaneHeaderCreateButton, { templateItems: combinedInitialValueTemplates }), $[18] = combinedInitialValueTemplates, $[19] = t10) : t10 = $[19];
  let t11;
  $[20] !== actionNodes ? (t11 = actionNodes.map(_temp4$3), $[20] = actionNodes, $[21] = t11) : t11 = $[21];
  let t12;
  $[22] !== contextMenuNodes ? (t12 = contextMenuNodes.length > 0 && (0, import_jsx_runtime3.jsx)(PaneContextMenuButton, { nodes: contextMenuNodes }), $[22] = contextMenuNodes, $[23] = t12) : t12 = $[23];
  let t13;
  return $[24] !== t10 || $[25] !== t11 || $[26] !== t12 ? (t13 = (0, import_jsx_runtime3.jsxs)(Flex, { gap: 1, children: [
    t10,
    t11,
    t12
...
function _temp4$3(node) {
  return (0, import_jsx_runtime3.jsx)(PaneHeaderActionButton, { node }, node.key);
}
function MissingSchemaType(props) {
  ...
  let t22;
  $[3] !== t2 || $[4] !== t1 ? (t22 = (0, import_jsx_runtime3.jsx)("em", { children: (0, import_jsx_runtime3.jsx)(Translate, { t: t2, i18nKey: "pane-item.missing-schema-type.title", components: t0, values: t1 }) }), $[3] = t2, $[4] = t1, $[5] = t22) : t22 = $[5];
  let t3;
  $[6] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t3 = {
    Code: "code"
  }, $[6] = t3) : t3 = $[6];
  ...
  let t5;
  $[9] !== t2 || $[10] !== t4 ? (t5 = (0, import_jsx_runtime3.jsx)(Translate, { t: t2, i18nKey: "pane-item.missing-schema-type.subtitle", components: t3, values: t4 }), $[9] = t2, $[10] = t4, $[11] = t5) : t5 = $[11];
  let t6;
  return $[12] !== layout || $[13] !== t22 || $[14] !== t5 ? (t6 = (0, import_jsx_runtime3.jsx)(SanityDefaultPreview, { title: t22, subtitle: t5, media: _temp$a, layout }), $[12] = layout, $[13] = t22, $[14] = t5, $[15] = t6) : t6 = $[15], t6;
}
function _temp$a() {
  return (0, import_jsx_runtime3.jsx)(WarningOutlineIcon, {});
}
...
function PaneItem(props) {
  ...
  } = usePaneRouter(), documentPresence = useDocumentPresence(id2), hasSchemaType = !!(schemaType && schemaType.name && schema.get(schemaType.name)), [clicked, setClicked] = (0, import_react3.useState)(false);
  let t1;
  bb0: {
    if (value && isSanityDocument(value)) {
      if (!schemaType || !hasSchemaType) {
        let t24;
        $[0] !== value ? (t24 = (0, import_jsx_runtime3.jsx)(MissingSchemaType, { value }), $[0] = value, $[1] = t24) : t24 = $[1], t1 = t24;
        break bb0;
      }
      let t23;
      $[2] !== icon || $[3] !== schemaType ? (t23 = getIconWithFallback(icon, schemaType, DocumentIcon), $[2] = icon, $[3] = schemaType, $[4] = t23) : t23 = $[4];
      let t33;
      $[5] !== documentPresence || $[6] !== documentPreviewStore || $[7] !== layout || $[8] !== schemaType || $[9] !== sortOrder || $[10] !== t23 || $[11] !== value ? (t33 = (0, import_jsx_runtime3.jsx)(PaneItemPreview, { documentPreviewStore, icon: t23, layout, schemaType, sortOrder, value, presence: documentPresence }), $[5] = documentPresence, $[6] = documentPreviewStore, $[7] = layout, $[8] = schemaType, $[9] = sortOrder, $[10] = t23, $[11] = value, $[12] = t33) : t33 = $[12], t1 = t33;
      break bb0;
    }
    let t22;
    $[13] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t22 = {
    ...
    let t32;
    $[14] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t32 = (0, import_jsx_runtime3.jsx)(Box, { style: t22, children: (0, import_jsx_runtime3.jsx)(Text, { muted: true, size: 1, children: (0, import_jsx_runtime3.jsx)(ChevronRightIcon, {}) }) }), $[14] = t32) : t32 = $[14];
    let t42;
    $[15] !== icon || $[16] !== schemaType ? (t42 = getIconWithFallback(icon, schemaType, FolderIcon), $[15] = icon, $[16] = schemaType, $[17] = t42) : t42 = $[17];
    let t52;
    $[18] !== t42 || $[19] !== title ? (t52 = (0, import_jsx_runtime3.jsx)(SanityDefaultPreview, { status: t32, icon: t42, layout: "compact", title }), $[18] = t42, $[19] = title, $[20] = t52) : t52 = $[20], t1 = t52;
  }
  const preview = t1;
  let t2;
  ...
  let t4;
  $[23] !== selected ? (t4 = [selected], $[23] = selected, $[24] = t4) : t4 = $[24], (0, import_react3.useEffect)(t3, t4);
  const [preloading, setPreload] = (0, import_react3.useState)(false), timeoutRef = (0, import_react3.useRef)(null);
  let t5;
  $[25] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t5 = () => {
    timeoutRef.current = setTimeout(() => (0, import_react3.startTransition)(() => setPreload(true)), 400);
  }, $[25] = t5) : t5 = $[25];
  const handleMouseEnter = t5;
  let t6;
  $[26] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t6 = () => {
    timeoutRef.current && clearTimeout(timeoutRef.current), (0, import_react3.startTransition)(() => setPreload(false));
  }, $[26] = t6) : t6 = $[26];
  const handleMouseLeave = t6, t7 = `pane-item-${title}`, t8 = ChildLink2, t9 = selected || clicked;
  let t10;
  $[27] !== id2 || $[28] !== preloading || $[29] !== schemaType || $[30] !== value ? (t10 = preloading && schemaType?.name && value && isSanityDocument(value) && (0, import_jsx_runtime3.jsx)(PreloadDocumentPane, { documentId: id2, documentType: schemaType.name }), $[27] = id2, $[28] = preloading, $[29] = schemaType, $[30] = value, $[31] = t10) : t10 = $[31];
  let t11;
  return $[32] !== id2 || $[33] !== margin || $[34] !== marginBottom || $[35] !== marginTop || $[36] !== pressed || $[37] !== preview || $[38] !== t10 || $[39] !== t7 || $[40] !== t8 || $[41] !== t9 ? (t11 = (0, import_jsx_runtime3.jsxs)(PreviewCard, { "data-testid": t7, __unstable_focusRing: true, as: t8, childId: id2, "data-as": "a", margin, marginBottom, marginTop, onClick: handleClick, onMouseEnter: handleMouseEnter, onMouseLeave: handleMouseLeave, pressed, radius: 2, selected: t9, sizing: "border", tabIndex: -1, tone: "inherit", children: [
    preview,
    t10
  ] }), $[32] = id2, $[33] = margin, $[34] = marginBottom, $[35] = marginTop, $[36] = pressed, $[37] = preview, $[38] = t10, $[39] = t7, $[40] = t8, $[41] = t9, $[42] = t11) : t11 = $[42], t11;
}
...
var RenderActionCollectionState = (0, import_react3.memo)((props) => {
  const $ = (0, import_compiler_runtime2.c)(4), {
    children,
    group
  } = props, states = (0, import_react3.useContext)(DocumentActionsStateContext);
  if (states === null)
...
var RenderBadgeCollectionState = (0, import_react3.memo)((props) => {
  const $ = (0, import_compiler_runtime2.c)(4), {
    badges,
    children,
    badgeProps
  ...
  let t0;
  return $[0] !== badgeProps || $[1] !== badges || $[2] !== children ? (t0 = (0, import_jsx_runtime3.jsx)(GetHookCollectionState, { hooks: badges, args: badgeProps, children }), $[0] = badgeProps, $[1] = badges, $[2] = children, $[3] = t0) : t0 = $[3], t0;
});
...
function LoadingView(props) {
  ...
  let t0;
  $[0] !== layout ? (t0 = SKELETON_ITEMS.map((num) => (0, import_jsx_runtime3.jsx)(SanityDefaultPreview, { isPlaceholder: true, layout }, num)), $[0] = layout, $[1] = t0) : t0 = $[1];
  let t1;
  return $[2] !== t0 ? (t1 = (0, import_jsx_runtime3.jsx)(Stack, { paddingX: 3, paddingY: 2, paddingTop: 0, space: 1, children: t0 }), $[2] = t0, $[3] = t1) : t1 = $[3], t1;
}
function DocumentListPaneContent(props) {
  const $ = (0, import_compiler_runtime2.c)(67), {
    ...
    collapsed,
    index
  } = usePane(), [shouldRender, setShouldRender] = (0, import_react3.useState)(!collapsed), {
    t: t2
  } = useTranslation(structureLocaleNamespace);
  let t0;
  ...
  let t22;
  $[5] !== collapsed || $[6] !== items2 ? (t22 = [collapsed, items2], $[5] = collapsed, $[6] = items2, $[7] = t22) : t22 = $[7], (0, import_react3.useEffect)(t1, t22);
  let t3;
  $[8] !== childItemId || $[9] !== hasMaxItems || $[10] !== isActive || $[11] !== isLazyLoading || $[12] !== items2.length || $[13] !== layout || $[14] !== schema || $[15] !== showIcons || $[16] !== sortOrder || $[17] !== t2 ? (t3 = (item, t42) => {
    const {
      activeIndex
    } = t42, publishedId = getPublishedId(item._id), isSelected = childItemId === publishedId, pressed = !isActive && isSelected, selected = isActive && isSelected, isLastItem = activeIndex === items2.length - 1, showSpinner = isLastItem && isLazyLoading, showMaxItemsMessage = isLastItem && hasMaxItems;
    return (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
      (0, import_jsx_runtime3.jsx)(PaneItem, { icon: showIcons ? void 0 : false, id: publishedId, layout, marginBottom: 1, pressed, schemaType: schema.get(item._type), selected, sortOrder, value: item }),
      showSpinner && (0, import_jsx_runtime3.jsx)(LoadingBlock, {}),
      showMaxItemsMessage && (0, import_jsx_runtime3.jsx)(Box, { marginY: 1, paddingX: 3, paddingY: 4, children: (0, import_jsx_runtime3.jsx)(Text, { align: "center", muted: true, size: 1, children: t2("panes.document-list-pane.max-items.text", {
        limit: FULL_LIST_LIMIT
      }) }) })
    ] });
  }, $[8] = childItemId, $[9] = hasMaxItems, $[10] = isActive, $[11] = isLazyLoading, $[12] = items2.length, $[13] = layout, $[14] = schema, $[15] = showIcons, $[16] = sortOrder, $[17] = t2, $[18] = t3) : t3 = $[18];
  const renderItem = t3;
  let t4;
  bb0: {
    if (hasSearchQuery) {
      ...
      let t63;
      $[21] !== t53 ? (t63 = (0, import_jsx_runtime3.jsx)(Flex, { align: "center", direction: "column", height: "fill", justify: "center", children: (0, import_jsx_runtime3.jsx)(Container, { width: 1, children: (0, import_jsx_runtime3.jsx)(Box, { paddingX: 4, paddingY: 5, children: (0, import_jsx_runtime3.jsx)(Text, { align: "center", muted: true, children: t53 }) }) }) }), $[21] = t53, $[22] = t63) : t63 = $[22], t4 = t63;
      break bb0;
    }
    let t52;
    ...
    let t62;
    $[26] !== t52 ? (t62 = (0, import_jsx_runtime3.jsx)(Flex, { align: "center", direction: "column", height: "fill", justify: "center", children: (0, import_jsx_runtime3.jsx)(Container, { width: 1, children: (0, import_jsx_runtime3.jsx)(Box, { paddingX: 4, paddingY: 5, children: (0, import_jsx_runtime3.jsx)(Text, { align: "center", muted: true, children: t52 }) }) }) }), $[26] = t52, $[27] = t62) : t62 = $[27], t4 = t62;
  }
  ...
  bb1: {
    ...
    if (error) {
      ...
      let t73;
      $[30] !== t63 ? (t73 = (0, import_jsx_runtime3.jsx)(Heading, { as: "h3", children: t63 }), $[30] = t63, $[31] = t73) : t73 = $[31];
      let t82;
      $[32] !== error || $[33] !== t2 ? (t82 = isDev ? (0, import_jsx_runtime3.jsx)(Translate, { t: t2, i18nKey: "panes.document-list-pane.error.text.dev", values: {
        error: error.message
      }, components: {
        Code: _temp$9
      } }) : t2(isOnline ? "panes.document-list-pane.error.text" : "panes.document-list-pane.error.text.offline"), $[32] = error, $[33] = t2, $[34] = t82) : t82 = $[34];
      let t9;
      $[35] !== t82 ? (t9 = (0, import_jsx_runtime3.jsx)(Text, { as: "p", children: t82 }), $[35] = t82, $[36] = t9) : t9 = $[36];
      const t10 = isOnline && canRetry ? onRetry : void 0;
      let t11;
      $[37] !== error || $[38] !== isRetrying || $[39] !== t10 ? (t11 = (0, import_jsx_runtime3.jsx)(ErrorActions, { error, eventId: null, onRetry: t10, isRetrying }), $[37] = error, $[38] = isRetrying, $[39] = t10, $[40] = t11) : t11 = $[40];
      let t12;
      $[41] !== autoRetry || $[42] !== canRetry || $[43] !== isRetrying || $[44] !== retryCount || $[45] !== t2 ? (t12 = canRetry ? (0, import_jsx_runtime3.jsx)(Text, { as: "p", muted: true, size: 1, children: isRetrying ? t2("panes.document-list-pane.error.retrying", {
        count: retryCount
      ...
      let t13;
      $[47] !== t11 || $[48] !== t12 || $[49] !== t73 || $[50] !== t9 ? (t13 = (0, import_jsx_runtime3.jsx)(Flex, { align: "center", direction: "column", height: "fill", justify: "center", children: (0, import_jsx_runtime3.jsx)(Container, { width: 1, children: (0, import_jsx_runtime3.jsxs)(Stack, { paddingX: 4, paddingY: 5, space: 4, children: [
        t73,
        t9,
        t11,
        t12
    ...
    if (isConnected && !isLoading && items2.length === 0) {
      t5 = noDocumentsContent;
      break bb1;
    }
    if (loadingVariant === "initial" && isLoading) {
      let t63;
      $[52] !== layout ? (t63 = (0, import_jsx_runtime3.jsx)(Delay, { ms: 300, children: (0, import_jsx_runtime3.jsx)(LoadingView, { layout }) }), $[52] = layout, $[53] = t63) : t63 = $[53], t5 = t63;
      break bb1;
    }
    ...
    let t72;
    $[54] !== handleEndReached || $[55] !== items2 || $[56] !== key || $[57] !== paneTitle || $[58] !== renderItem || $[59] !== searchInputElement ? (t72 = (0, import_jsx_runtime3.jsx)(CommandListBox, { children: (0, import_jsx_runtime3.jsx)(CommandList, { activeItemDataAttr: "data-hovered", ariaLabel: paneTitle, canReceiveFocus: true, inputElement: searchInputElement, itemHeight: 51, items: items2, onEndReached: handleEndReached, onlyShowSelectionWhenActive: true, overscan: 10, paddingBottom: 1, paddingX: 3, renderItem, wrapAround: false }, key) }), $[54] = handleEndReached, $[55] = items2, $[56] = key, $[57] = paneTitle, $[58] = renderItem, $[59] = searchInputElement, $[60] = t72) : t72 = $[60];
    let t8;
    $[61] !== t62 || $[62] !== t72 ? (t8 = (0, import_jsx_runtime3.jsx)(RootBox, { overflow: "hidden", height: "fill", $opacity: t62, children: t72 }), $[61] = t62, $[62] = t72, $[63] = t8) : t8 = $[63], t5 = t8;
  }
  const mainContent = t5, t6 = layoutCollapsed || loadingVariant === "initial" ? "hidden" : "auto";
  let t7;
  return $[64] !== mainContent || $[65] !== t6 ? (t7 = (0, import_jsx_runtime3.jsx)(PaneContent, { "data-testid": "document-list-pane", overflow: t6, children: mainContent }), $[64] = mainContent, $[65] = t6, $[66] = t7) : t7 = $[66], t7;
}
function _temp$9(t0) {
  const {
    children
...
function getFieldTypeByName(type2, fieldName) {
  if (!("fields" in type2))
    return;
  const fieldType = type2.fields.find((field) => field.name === fieldName);
...
function listenSearchQuery(options) {
  ...
  return merge(welcome$, mutationAndReconnect$.pipe(throttleTime(1e3, asyncScheduler, {
    ...
    const types = getSearchableTypes(schema, staticTypeNames || []).filter((type2) => typeNames.includes(type2.name) ? (getExtendedProjection(type2, sort.by, true), true) : false), search = createSearch(types, client, {
      filter: groqFilter,
      params,
...
function useDocumentList(opts) {
  ...
  const typeNameFromFilter = t0, [t1] = (0, import_react3.useState)(_temp$8), [onRetry$, onRetry] = t1, [t2] = (0, import_react3.useState)(_temp2$4), [onFetchFullList$, onLoadFullList] = t2, t3 = searchQuery || "", t4 = sortOrder || DEFAULT_ORDERING;
  let t5;
  ...
  let t6;
  return $[18] !== autoRetry_0 || $[19] !== canRetry_0 || $[20] !== connected || $[21] !== error_0 || $[22] !== fromCache || $[23] !== isLoading || $[24] !== isLoadingFullList || $[25] !== isRetrying || $[26] !== items2 || $[27] !== onLoadFullList || $[28] !== onRetry || $[29] !== retryCount_0 ? (t6 = {
    error: error_0,
    onRetry,
    isLoading,
    items: items2,
    ...
    onLoadFullList,
    isLoadingFullList
  }, $[18] = autoRetry_0, $[19] = canRetry_0, $[20] = connected, $[21] = error_0, $[22] = fromCache, $[23] = isLoading, $[24] = isLoadingFullList, $[25] = isRetrying, $[26] = items2, $[27] = onLoadFullList, $[28] = onRetry, $[29] = retryCount_0, $[30] = t6) : t6 = $[30], t6;
}
...
`;
var AnimatedSpinnerIcon = at(SpinnerIcon)`
  animation: ${rotate} 500ms linear infinite;
`;
var SubtleSpinnerIcon = at(SpinnerIcon)`
  animation: ${rotate} 1500ms linear infinite;
  opacity: 0.4;
`;
var DelayedSubtleSpinnerIcon = at(SpinnerIcon)`
  animation:
    ${rotate} 1500ms linear infinite,
    ${fadeIn} 1000ms linear;
  opacity: 0.4;
`;
var DocumentListPane = (0, import_react3.memo)(function(props) {
  ...
  const typeName = t0, showIcons = displayOptions?.showIcons !== false, {
    ...
    title
  } = useI18nText(pane2), [searchQuery, setSearchQuery] = (0, import_react3.useState)(""), [searchInputValue, setSearchInputValue] = (0, import_react3.useState)(""), [searchInputElement, setSearchInputElement] = (0, import_react3.useState)(null);
  let t1;
  ...
  const handleSearchKeyDown = t8, [enableSearchSpinner, setEnableSearchSpinner] = (0, import_react3.useState)();
  let t10, t9;
  $[21] !== enableSearchSpinner || $[22] !== isLoading || $[23] !== paneKey ? (t9 = () => {
    !enableSearchSpinner && !isLoading && setEnableSearchSpinner(paneKey);
  }, t10 = [enableSearchSpinner, isLoading, paneKey], $[21] = enableSearchSpinner, $[22] = isLoading, $[23] = paneKey, $[24] = t10, $[25] = t9) : (t10 = $[24], t9 = $[25]), (0, import_react3.useEffect)(t9, t10);
  let t11;
  $[26] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t11 = () => {
    handleClearSearch(), setEnableSearchSpinner();
  }, $[26] = t11) : t11 = $[26];
  let t12;
  $[27] !== paneKey ? (t12 = [paneKey, handleClearSearch], $[27] = paneKey, $[28] = t12) : t12 = $[28], (0, import_react3.useEffect)(t11, t12);
  let t13;
  bb1: {
  ...
  let t20;
  $[34] !== handleQueryChange || $[35] !== searchInputValue || $[36] !== t15 || $[37] !== t16 || $[38] !== t18 || $[39] !== t19 || $[40] !== textInputIcon ? (t20 = (0, import_jsx_runtime3.jsx)(Box, { paddingX: 3, paddingBottom: 3, children: (0, import_jsx_runtime3.jsx)(TextInput, { "aria-label": t15, autoComplete: "off", border: false, clearButton: t16, fontSize: t17, icon: textInputIcon, iconRight: t18, onChange: handleQueryChange, onClear: handleClearSearch, onKeyDown: handleSearchKeyDown, padding: 2, placeholder: t19, radius: 2, ref: setSearchInputElement, spellCheck: false, value: searchInputValue }) }), $[34] = handleQueryChange, $[35] = searchInputValue, $[36] = t15, $[37] = t16, $[38] = t18, $[39] = t19, $[40] = textInputIcon, $[41] = t20) : t20 = $[41];
  const t21 = !!typeName, t222 = items2.length === FULL_LIST_LIMIT, t23 = !!searchQuery, t24 = loadingVariant === "subtle";
  let t25;
  $[42] !== autoRetry || $[43] !== canRetry || $[44] !== childItemId || $[45] !== connected || $[46] !== error || $[47] !== isActive || $[48] !== isLoading || $[49] !== isLoadingFullList || $[50] !== isRetrying || $[51] !== items2 || $[52] !== layout || $[53] !== loadingVariant || $[54] !== onLoadFullList || $[55] !== onRetry || $[56] !== paneKey || $[57] !== retryCount || $[58] !== searchInputElement || $[59] !== showIcons || $[60] !== sortOrder || $[61] !== t21 || $[62] !== t222 || $[63] !== t23 || $[64] !== t24 || $[65] !== title ? (t25 = (0, import_jsx_runtime3.jsx)(DocumentListPaneContent, { childItemId, error, filterIsSimpleTypeConstraint: t21, hasMaxItems: t222, hasSearchQuery: t23, isActive, isLazyLoading: isLoadingFullList, isLoading, autoRetry, canRetry, retryCount, isRetrying, isConnected: connected, items: items2, layout, muted: t24, loadingVariant, onEndReached: onLoadFullList, onRetry, paneTitle: title, searchInputElement, showIcons, sortOrder }, paneKey), $[42] = autoRetry, $[43] = canRetry, $[44] = childItemId, $[45] = connected, $[46] = error, $[47] = isActive, $[48] = isLoading, $[49] = isLoadingFullList, $[50] = isRetrying, $[51] = items2, $[52] = layout, $[53] = loadingVariant, $[54] = onLoadFullList, $[55] = onRetry, $[56] = paneKey, $[57] = retryCount, $[58] = searchInputElement, $[59] = showIcons, $[60] = sortOrder, $[61] = t21, $[62] = t222, $[63] = t23, $[64] = t24, $[65] = title, $[66] = t25) : t25 = $[66];
  let t26;
  return $[67] !== t20 || $[68] !== t25 ? (t26 = (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
    t20,
    t25
...
var PaneHeader = (0, import_react3.memo)((t0) => {
  const $ = (0, import_compiler_runtime2.c)(27), {
    contentAfter,
    index,
  ...
  let t10;
  $[13] !== actionHandlers || $[14] !== initialValueTemplates || $[15] !== menuItemGroups || $[16] !== menuItems ? (t10 = (0, import_jsx_runtime3.jsx)(PaneHeaderActions, { initialValueTemplateItems: initialValueTemplates, actionHandlers, menuItemGroups, menuItems }), $[13] = actionHandlers, $[14] = initialValueTemplates, $[15] = menuItemGroups, $[16] = menuItems, $[17] = t10) : t10 = $[17];
  let t11;
  $[18] !== features.backButton || $[19] !== index ? (t11 = features.backButton && index > 0 && (0, import_jsx_runtime3.jsx)(Button2, { as: BackLink, "data-as": "a", icon: ArrowLeftIcon, mode: "bleed", tooltipProps: {
    content: "Back"
  } }), $[18] = features.backButton, $[19] = index, $[20] = t11) : t11 = $[20];
  let t12;
  return $[21] !== contentAfter || $[22] !== t10 || $[23] !== t11 || $[24] !== tabIndex || $[25] !== title ? (t12 = (0, import_jsx_runtime3.jsx)(TooltipDelayGroupProvider, { children: (0, import_jsx_runtime3.jsx)(PaneHeader$1, { actions: t10, backButton: t11, contentAfter, tabIndex, title }) }), $[21] = contentAfter, $[22] = t10, $[23] = t11, $[24] = tabIndex, $[25] = title, $[26] = t12) : t12 = $[26], t12;
});
...
function DocumentSheetListSelect(props) {
  const {
    ...
    selectedAnchor,
    setSelectedAnchor
  } = table.options.meta || {}, handleOnClick = (0, import_react3.useCallback)((e2) => {
    if (e2.shiftKey && selectedAnchor !== null && selectedAnchor !== void 0) {
      const shiftClickIndex = row.index, lowerIndex = shiftClickIndex < selectedAnchor ? shiftClickIndex : selectedAnchor, upperIndex = shiftClickIndex < selectedAnchor ? selectedAnchor : shiftClickIndex, additionalSelectedRows = table.getRowModel().flatRows.slice(lowerIndex, upperIndex + 1).map(({
        id: id2
      }) => id2), currentSelectedRows = table.getSelectedRowModel().rows.map(({
        id: id_0
      }) => id_0);
...
var useDocumentSheetListContext = () => {
  const context = (0, import_react3.useContext)(DocumentSheetListContext);
  if (context === void 0)
...
function DocumentSheetListProvider(t0) {
  const $ = (0, import_compiler_runtime2.c)(49), {
    children,
    table
  } = t0, [selectedAnchorCellDetails, setSelectedAnchorCellDetails] = (0, import_react3.useState)(null);
  let t1;
  $[0] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t1 = [], $[0] = t1) : t1 = $[0];
  const [selectedRangeCellIndexes, setSelectedRangeCellIndexes] = (0, import_react3.useState)(t1);
  let t2;
  ...
  }), t12 = [handleAnchorClick, handleAnchorKeydown, selectedAnchorCellDetails], $[29] = handleAnchorClick, $[30] = handleAnchorKeydown, $[31] = selectedAnchorCellDetails, $[32] = t11, $[33] = t12) : (t11 = $[32], t12 = $[33]), (0, import_react3.useEffect)(t11, t12);
  let t13;
  ...
  const value = t16;
  let t17;
  return $[46] !== children || $[47] !== value ? (t17 = (0, import_jsx_runtime3.jsx)(DocumentSheetListContext.Provider, { value, children }), $[46] = children, $[47] = value, $[48] = t17) : t17 = $[48], t17;
}
...
`;
var PinnedDataCell = at(DataCell)`
  position: sticky;
  z-index: 2;
`;
function SheetListCellInner(props) {
  const {
    ...
    row,
    fieldType
  } = props, cellId = `cell-${column.id}-${row.index}`, [renderValue, setRenderValue] = (0, import_react3.useState)(() => getValue()), [isDirty, setIsDirty] = (0, import_react3.useState)(false), inputRef = (0, import_react3.useRef)(null), {
    focusAnchorCell,
    resetFocusSelection,
    setSelectedAnchorCell,
    getStateByCellId,
    submitFocusedCell
  } = useDocumentSheetListContext(), cellState = getStateByCellId(column.id, row.index), handleOnFocus = (0, import_react3.useCallback)(() => {
  ...
  }, handleOnEnterDown = (0, import_react3.useCallback)((event_0) => {
    const {
      key
    } = event_0;
  ...
  }, handlePaste = (0, import_react3.useCallback)((event_2) => {
  ...
  }, [column.id, patchDocument, row.id]), handleCopy = (0, import_react3.useCallback)(() => navigator.clipboard.writeText(renderValue.toString()), [renderValue]);
  (0, import_react3.useEffect)(() => ((cellState === "selectedAnchor" || cellState === "focused") && document.addEventListener("keydown", handleOnEnterDown), (cellState === "selectedAnchor" || cellState === "selectedRange") && document.addEventListener("paste", handlePaste), cellState === "selectedAnchor" && document.addEventListener("copy", handleCopy), () => {
  ...
  return fieldType.name === "boolean" ? (0, import_jsx_runtime3.jsxs)(Select, { ...inputProps, onChange: () => null, radius: 0, style: {
    boxShadow: "none",
    border: getBorderStyle(),
    padding: 0
  }, value: JSON.stringify(renderValue), children: [
    (0, import_jsx_runtime3.jsx)("option", { value: "True", children: "True" }),
    (0, import_jsx_runtime3.jsx)("option", { value: "False", children: "False" })
  ] }) : (0, import_jsx_runtime3.jsx)(TextInput, { ...inputProps, size: 0, radius: 0, border: false, style: {
    border: getBorderStyle(),
    padding: "22px 16px"
...
function SheetListCell(cell) {
  ...
  return (0, import_jsx_runtime3.jsx)(Cell, { style: {
...
var PreviewCell = (props) => {
  const {
    ...
    row,
    schemaType
  } = props, previewStateObservable = (0, import_react3.useMemo)(() => getPreviewStateObservable$1(documentPreviewStore, schemaType, row.original._id), [documentPreviewStore, row.original._id, schemaType]), versionsInfo = useDocumentVersionInfo(row.original._id), {
    snapshot,
    isLoading
  ...
  if (isLoading)
    return (0, import_jsx_runtime3.jsx)(Text, { size: 1, muted: true, children: "Loading..." });
  const displayValue = snapshot?.title ?? "Untitled";
  return (0, import_jsx_runtime3.jsxs)(Flex, { align: "center", gap: 3, children: [
    (0, import_jsx_runtime3.jsx)(DocumentStatusIndicator, { draft: versionsInfo.draft, published: versionsInfo.published, versions: void 0 }),
    (0, import_jsx_runtime3.jsx)(Text, { size: 1, children: displayValue })
  ] });
};
...
var getColsFromSchemaType = (schemaType, parentalField) => schemaType.fields.reduce((tableColumns, field) => {
  ...
  if (SUPPORTED_FIELDS.includes(type2.name)) {
    const nextCol = columnHelper.accessor(
      ...
      parentalField ? `${parentalField}.${field.name}` : field.name,
      {
        ...
        enableHiding: true,
        cell: (info) => (0, import_jsx_runtime3.jsx)(SheetListCellInner, { ...info, fieldType: type2 })
      }
    );
    return [...tableColumns, nextCol];
  }
  return type2.name === "object" && isObjectSchemaType(type2) && !parentalField ? [...tableColumns, columnHelper.group({
    header: name,
    columns: getColsFromSchemaType(type2, field.name)
  })] : tableColumns;
}, []);
...
function useDocumentSheetColumns(documentSchemaType) {
  const documentPreviewStore = useDocumentPreviewStore(), columns = (0, import_react3.useMemo)(() => documentSchemaType ? [columnHelper.display({
    id: "selected",
    enableHiding: false,
    header: (info) => (0, import_jsx_runtime3.jsxs)(Box, { children: [
      (0, import_jsx_runtime3.jsx)(Checkbox, { style: {
        paddingLeft: 4
    ...
    enableHiding: false,
    id: "Preview",
    cell: (info_0) => (0, import_jsx_runtime3.jsx)(PreviewCell, { ...info_0, documentPreviewStore, schemaType: documentSchemaType })
  }), ...getColsFromSchemaType(documentSchemaType)] : [], [documentPreviewStore, documentSchemaType]), [initialColumnsVisibility] = (0, import_react3.useMemo)(() => flatColumns(columns).reduce(([accCols, countAllowedVisible], column) => {
...
function ColumnsControl({
  ...
  const {
    t: t2
  } = useTranslation(), isVisibleLimitReached = table.getVisibleLeafColumns().filter((col) => col.getCanHide()).length >= VISIBLE_COLUMN_LIMIT, setInitialColumns = (0, import_react3.useCallback)(() => {
  ...
  return (0, import_jsx_runtime3.jsx)(MenuButton, { button: (0, import_jsx_runtime3.jsx)(Button2, { mode: "bleed", text: t2("sheet-list.edit-columns") }), id: "columns-control", menu: (0, import_jsx_runtime3.jsx)(Menu, { padding: 3, paddingTop: 4, style: {
    width: 240
  }, children: (0, import_jsx_runtime3.jsxs)(Flex, { direction: "column", height: "fill", gap: 3, children: [
    (0, import_jsx_runtime3.jsx)(Text, { weight: "semibold", size: 1, children: t2("sheet-list.select-fields") }),
    (0, import_jsx_runtime3.jsx)(Flex, { style: {
      flex: "1 1 auto",
      maxHeight: 320,
      overflowY: "scroll"
    }, children: (0, import_jsx_runtime3.jsx)(Stack, { children: table.getAllLeafColumns().filter((column_1) => column_1.getCanHide()).map((column_2) => {
      const columnId = column_2.id.replace(/ /g, "-");
      return (0, import_jsx_runtime3.jsxs)(Flex, { marginY: 2, align: "center", children: [
        (0, import_jsx_runtime3.jsx)(Checkbox, { readOnly: getColumnVisibilityDisabled(column_2), checked: column_2.getIsVisible(), onChange: handleColumnOnChange(column_2), id: `col-visibility-${columnId}`, style: {
          display: "block"
        } }),
        (0, import_jsx_runtime3.jsx)(Box, { flex: 1, paddingLeft: 3, children: (0, import_jsx_runtime3.jsx)(Text, { size: 1, children: (0, import_jsx_runtime3.jsx)("label", { htmlFor: `col-visibility-${columnId}`, children: column_2.columnDef.header?.toString() }) }) })
      ] }, column_2.id);
    }) }) }),
    (0, import_jsx_runtime3.jsx)(Button2, { width: "fill", mode: "ghost", text: t2("sheet-list.reset-columns"), onClick: setInitialColumns })
  ] }) }), placement: "bottom", popover: {
    portal: true
  } });
}
var SearchContainer = at(Flex)`
  flex-shrink: 0;
`;
function DocumentSheetListFilter() {
  ...
  let t1;
  $[0] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t1 = (0, import_jsx_runtime3.jsx)(SearchHeader, {}), $[0] = t1) : t1 = $[0];
  let t2;
  $[1] !== filtersVisible ? (t2 = filtersVisible && (0, import_jsx_runtime3.jsx)(Filters, { showTypeFilter: false }), $[1] = filtersVisible, $[2] = t2) : t2 = $[2];
  let t3;
  return $[3] !== t2 ? (t3 = (0, import_jsx_runtime3.jsxs)(SearchContainer, { children: [
    t1,
    t2
  ] }), $[3] = t2, $[4] = t3) : t3 = $[4], t3;
}
...
`;
var PinnedHeader = at(Header)`
  position: sticky;
  z-index: 2;
`;
var HoverMenu = at.div`
  visibility: hidden;
...
function DocumentSheetListHeader(props) {
  const {
    ...
    t: t2
  } = useTranslation(), isPinned = header.column.getIsPinned(), headerTitle = headerGroup.depth > 0 && !header.column.parent ? null : (0, import_jsx_runtime3.jsx)(Text, { size: 1, weight: "semibold", textOverflow: "ellipsis", children: flexRender(header.column.columnDef.header, header.getContext()) }), HeaderTag = isPinned ? PinnedHeader : Header, canShowHeaderMenu = header.column.getCanHide() && (headerGroup.depth === 0 ? !header.column.columns.length : header.column.parent), borderWidth = isPinned && header.column.getIsLastColumn("left") ? 2 : 1;
  return (0, import_jsx_runtime3.jsx)(HeaderTag, { style: {
    left: header.column.getStart("left") ?? void 0,
    borderRight: `${borderWidth}px solid var(--card-border-color)`
  }, "data-testid": `header-${header.id}`, width: header.getSize(), children: (0, import_jsx_runtime3.jsxs)(Flex, { justify: "space-between", marginX: 2, align: "baseline", children: [
    (0, import_jsx_runtime3.jsx)(Tooltip, { delay: 500, content: headerTitle, children: (0, import_jsx_runtime3.jsx)(Box, { style: {
      boxSizing: "border-box"
    }, marginLeft: 3, marginRight: 3, children: headerTitle }) }),
    canShowHeaderMenu && (0, import_jsx_runtime3.jsx)(HoverMenu, { children: (0, import_jsx_runtime3.jsx)(MenuButton, { button: (0, import_jsx_runtime3.jsx)(Button2, { tooltipProps: {
      content: "Open field menu"
    }, mode: "bleed", icon: EllipsisHorizontalIcon, "data-testid": "field-menu-button" }), id: "field menu", popover: {
      placement: "bottom-end"
    }, menu: (0, import_jsx_runtime3.jsx)(Menu, { children: (0, import_jsx_runtime3.jsx)(MenuItem2, { text: t2("sheet-list.hide-field"), icon: CloseIcon, onClick: () => header.column.toggleVisibility() }) }) }) })
  ] }) }, header.id);
}
function DocumentSheetListPaginator({
  table
}) {
  return (0, import_jsx_runtime3.jsx)(TooltipDelayGroupProvider, { children: (0, import_jsx_runtime3.jsxs)(Flex, { gap: 3, align: "center", children: [
    (0, import_jsx_runtime3.jsx)(Button2, { onClick: () => table.setPageIndex(0), disabled: !table.getCanPreviousPage(), icon: DoubleChevronLeftIcon, tooltipProps: {
      content: "Go to first page"
    } }),
    (0, import_jsx_runtime3.jsx)(Button2, { onClick: () => table.previousPage(), disabled: !table.getCanPreviousPage(), icon: ChevronLeftIcon, tooltipProps: {
      content: "Go to previous page"
    } }),
    (0, import_jsx_runtime3.jsxs)(Text, { style: {
      whiteSpace: "nowrap"
    }, children: [
    ...
    (0, import_jsx_runtime3.jsx)(Button2, { onClick: () => table.nextPage(), disabled: !table.getCanNextPage(), icon: ChevronRightIcon, tooltipProps: {
      content: "Go to next page"
    } }),
    (0, import_jsx_runtime3.jsx)(Button2, { onClick: () => table.setPageIndex(table.getPageCount() - 1), disabled: !table.getCanNextPage(), icon: DoubleChevronRightIcon, tooltipProps: {
      content: "Go to last page"
    } }),
    (0, import_jsx_runtime3.jsx)("select", { value: table.getState().pagination.pageSize, onChange: (e2) => {
      table.setPageSize(Number(e2.target.value));
    }, children: [25, 50, 100].map((pageSize) => (0, import_jsx_runtime3.jsx)("option", { value: pageSize, children: pageSize }, pageSize)) })
  ] }) });
}
...
function documentsReducer(state2, action) {
  switch (action.type) {
    ...
    case "DOCUMENT_UPDATED": {
      const updatedDocument = action.payload, id2 = updatedDocument._id, nextDocument = {
        // Add existing document data
        ...state2.documents[id2],
...
function useDocumentSheetListStore(t0) {
  ...
  const [state2, dispatch] = (0, import_react3.useReducer)(documentsReducer, t3), [isLoading, setIsLoading] = (0, import_react3.useState)(client !== null), [error, setError] = (0, import_react3.useState)(null);
  let t4;
  ...
  }, t8 = [handleListenerEvent, listener$], $[15] = handleListenerEvent, $[16] = listener$, $[17] = t7, $[18] = t8) : (t7 = $[17], t8 = $[18]), (0, import_react3.useEffect)(t7, t8);
  let t9;
  $[19] !== state2.documents ? (t9 = Object.keys(state2.documents).reduce((acc, key) => {
    const document2 = state2.documents[key], isDraft = document2._id === getDraftId(document2._id), id2 = isDraft ? document2._id : getDraftId(document2._id);
    return acc[id2] && !isDraft || (acc[id2] = document2), acc;
...
function useDocumentSheetList(t0) {
  ...
  const items2 = map2, t1 = `_type == "${typeName}"`;
  let t2;
  $[2] !== t1 ? (t2 = {
    filter: t1
  }, $[2] = t1, $[3] = t2) : t2 = $[3];
  ...
  if ($[4] !== data || $[5] !== items2) {
    let t42;
    $[7] !== items2 ? (t42 = (doc) => items2.has(getPublishedId(doc._id)), $[7] = items2, $[8] = t42) : t42 = $[8], t3 = data.filter(t42), $[4] = data, $[5] = items2, $[6] = t3;
  } else
    t3 = $[6];
  const documents = t3;
  let t4;
...
var PaneContainer$1 = at(Flex)`
  height: 100%;
`;
var TableContainer = at.div`
...
function DocumentSheetListPaneInner({
  ...
  }), [selectedAnchor, setSelectedAnchor] = (0, import_react3.useState)(null), totalRows = state2.result.hits.length, table = useReactTable({
    data,
    columns,
  ...
  (0, import_react3.useEffect)(() => (dispatch({
    type: "TERMS_TYPE_ADD",
  ...
  const renderRow = (0, import_react3.useCallback)((row_0) => (0, import_jsx_runtime3.jsx)(Box, { as: "tr", paddingY: 2, style: {
    display: "flex",
    width: "100%"
  }, children: row_0.getVisibleCells().map((cell) => (0, import_jsx_runtime3.jsx)(SheetListCell, { ...cell }, row_0.original._id + cell.id)) }, row_0.original._id + row_0.id), []), rowsCount = `Total: ${totalRows} rows, showing ${rows.length} rows`;
  return (0, import_jsx_runtime3.jsxs)(PaneContainer$1, { direction: "column", paddingX: 3, "data-testid": "document-sheet-list-pane", children: [
    (0, import_jsx_runtime3.jsxs)(Flex, { direction: "row", align: "center", paddingY: 3, paddingX: 1, justify: "space-between", children: [
      (0, import_jsx_runtime3.jsxs)(Flex, { direction: "row", align: "center", children: [
        (0, import_jsx_runtime3.jsx)(DocumentSheetListFilter, {}),
        (0, import_jsx_runtime3.jsx)(Text, { size: 0, muted: true, children: rowsCount })
      ] }),
      (0, import_jsx_runtime3.jsx)(ColumnsControl, { table })
    ] }),
    (0, import_jsx_runtime3.jsx)(TableContainer, { children: (0, import_jsx_runtime3.jsx)(DocumentSheetListProvider, { table, children: (0, import_jsx_runtime3.jsxs)(Table, { children: [
      (0, import_jsx_runtime3.jsx)("thead", { children: table.getHeaderGroups().map((headerGroup) => (0, import_jsx_runtime3.jsx)(Box, { as: "tr", children: headerGroup.headers.map((header) => (0, import_jsx_runtime3.jsx)(DocumentSheetListHeader, { header, headerGroup }, header.id)) }, headerGroup.id)) }),
      (0, import_jsx_runtime3.jsx)("tbody", { children: table.getRowModel().rows.map(renderRow) })
    ] }) }) }),
    (0, import_jsx_runtime3.jsx)(Flex, { justify: "flex-end", padding: 3, gap: 4, paddingY: 5, children: (0, import_jsx_runtime3.jsx)(DocumentSheetListPaginator, { table }) })
  ] });
}
function DocumentSheetListPane(props) {
  ...
  let t1;
  return $[4] !== props || $[5] !== schemaType ? (t1 = (0, import_jsx_runtime3.jsx)(SearchProvider, { children: (0, import_jsx_runtime3.jsx)(DocumentSheetListPaneInner, { ...props, documentSchemaType: schemaType }) }), $[4] = props, $[5] = schemaType, $[6] = t1) : t1 = $[6], t1;
}
...
function useShallowUnique(value) {
  const [previous, setPrevious] = (0, import_react3.useState)(value);
  return (0, import_shallow_equals.default)(previous, value) ? previous : (setPrevious(value), value);
}
var PaneContainer = (0, import_react3.memo)(function(props) {
  const $ = (0, import_compiler_runtime2.c)(36), {
    index,
    isSelected,
    pane: pane2,
  ...
  let t6;
  $[9] !== isSheetListLayout || $[10] !== layout || $[11] !== props || $[12] !== sortOrderRaw ? (t6 = isSheetListLayout ? (0, import_jsx_runtime3.jsx)(DocumentSheetListPane, { ...props }, props.pane.id) : (0, import_jsx_runtime3.jsx)(DocumentListPane, { ...props, sortOrder: sortOrderRaw, layout }), $[9] = isSheetListLayout, $[10] = layout, $[11] = props, $[12] = sortOrderRaw, $[13] = t6) : t6 = $[13];
  ...
  let t10;
  $[18] !== index || $[19] !== initialValueTemplates || $[20] !== menuItemGroups || $[21] !== menuItemsWithSelectedState || $[22] !== setLayout || $[23] !== setSortOrder || $[24] !== title ? (t10 = (0, import_jsx_runtime3.jsx)(PaneHeader, { index, initialValueTemplates, menuItemGroups, menuItems: menuItemsWithSelectedState, setLayout, setSortOrder, title }), $[18] = index, $[19] = initialValueTemplates, $[20] = menuItemGroups, $[21] = menuItemsWithSelectedState, $[22] = setLayout, $[23] = setSortOrder, $[24] = title, $[25] = t10) : t10 = $[25];
  let t11;
  $[26] !== isSelected || $[27] !== paneKey || $[28] !== paneLayout || $[29] !== t10 || $[30] !== t8 || $[31] !== t9 ? (t11 = (0, import_jsx_runtime3.jsxs)(Pane, { "data-ui": "DocumentListPane", id: paneKey, minWidth: 320, ...t8, selected: isSelected, children: [
    t9,
    t10,
    paneLayout
  ] }), $[26] = isSelected, $[27] = paneKey, $[28] = paneLayout, $[29] = t10, $[30] = t8, $[31] = t9, $[32] = t11) : t11 = $[32];
  let t12;
  return $[33] !== t11 || $[34] !== t7 ? (t12 = (0, import_jsx_runtime3.jsx)(SourceProvider, { name: t7, children: t11 }), $[33] = t11, $[34] = t7, $[35] = t12) : t12 = $[35], t12;
});
...
var Scroller$3 = at(ScrollContainer)`
  height: 100%;
  overflow: auto;
  position: relative;
  scroll-behavior: smooth;
...
function ChangesInspector(t0) {
  const $ = (0, import_compiler_runtime2.c)(39), {
    ...
    selectedReleaseId
  } = usePerspective(), [scrollRef, setScrollRef] = (0, import_react3.useState)(null), rev = useTimelineSelector(timelineStore, _temp$5), diff = useTimelineSelector(timelineStore, _temp2$2), onOlderRevision = useTimelineSelector(timelineStore, _temp3$1), selectionState = useTimelineSelector(timelineStore, _temp4$1), sinceTime = useTimelineSelector(timelineStore, _temp5), loading = selectionState === "loading", isComparingCurrent = !onOlderRevision, {
    t: structureT
  } = useTranslation(structureLocaleNamespace);
  let t1;
  ...
  if (selectedReleaseId) {
    let t22;
    return $[6] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t22 = (0, import_jsx_runtime3.jsx)(Flex, { "data-testid": "review-changes-pane", direction: "column", height: "fill", children: (0, import_jsx_runtime3.jsx)(Card, { flex: 1, padding: 2, paddingTop: 0, children: (0, import_jsx_runtime3.jsx)(TimelineError, { versionError: true }) }) }), $[6] = t22) : t22 = $[6], t22;
  }
  let t2;
  $[7] !== structureT ? (t2 = structureT("changes.from.label"), $[7] = structureT, $[8] = t2) : t2 = $[8];
  let t3;
  $[9] !== t2 ? (t3 = (0, import_jsx_runtime3.jsx)(Text, { size: 1, muted: true, children: t2 }), $[9] = t2, $[10] = t3) : t3 = $[10];
  let t4;
  $[11] !== sinceTime ? (t4 = (0, import_jsx_runtime3.jsx)(TimelineMenu, { mode: "since", chunk: sinceTime, placement: "bottom-start" }), $[11] = sinceTime, $[12] = t4) : t4 = $[12];
  let t5;
  $[13] !== structureT ? (t5 = structureT("changes.to.label"), $[13] = structureT, $[14] = t5) : t5 = $[14];
  let t6;
  $[15] !== t5 ? (t6 = (0, import_jsx_runtime3.jsx)(Text, { size: 1, muted: true, children: t5 }), $[15] = t5, $[16] = t6) : t6 = $[16];
  let t7;
  $[17] !== rev ? (t7 = (0, import_jsx_runtime3.jsx)(TimelineMenu, { chunk: rev, mode: "rev", placement: "bottom-end" }), $[17] = rev, $[18] = t7) : t7 = $[18];
  let t8;
  $[19] !== t3 || $[20] !== t4 || $[21] !== t6 || $[22] !== t7 ? (t8 = (0, import_jsx_runtime3.jsx)(Box, { padding: 3, children: (0, import_jsx_runtime3.jsxs)(Grid$1, { paddingX: 2, paddingBottom: 2, children: [
    t3,
    t4,
    t6,
    t7
  ...
  let t9;
  $[24] !== diff || $[25] !== documentContext || $[26] !== loading || $[27] !== schemaType || $[28] !== showChanges || $[29] !== timelineError ? (t9 = showChanges && (0, import_jsx_runtime3.jsx)(Content$1, { diff, documentContext, error: timelineError, loading, schemaType }), $[24] = diff, $[25] = documentContext, $[26] = loading, $[27] = schemaType, $[28] = showChanges, $[29] = timelineError, $[30] = t9) : t9 = $[30];
  let t10;
  $[31] !== t9 ? (t10 = (0, import_jsx_runtime3.jsx)(Scroller$3, { "data-ui": "Scroller", ref: setScrollRef, children: (0, import_jsx_runtime3.jsx)(Box, { flex: 1, paddingX: 3, height: "fill", children: t9 }) }), $[31] = t9, $[32] = t10) : t10 = $[32];
  let t11;
  $[33] !== scrollRef || $[34] !== t10 ? (t11 = (0, import_jsx_runtime3.jsx)(Card, { flex: 1, paddingX: 2, paddingY: 2, children: (0, import_jsx_runtime3.jsx)(BoundaryElementProvider, { element: scrollRef, children: t10 }) }), $[33] = scrollRef, $[34] = t10, $[35] = t11) : t11 = $[35];
  let t12;
  return $[36] !== t11 || $[37] !== t8 ? (t12 = (0, import_jsx_runtime3.jsxs)(Flex, { "data-testid": "review-changes-pane", direction: "column", height: "fill", overflow: "hidden", children: [
    t8,
    t11
  ] }), $[36] = t11, $[37] = t8, $[38] = t12) : t12 = $[38], t12;
}
function _temp6(props) {
  return (0, import_jsx_runtime3.jsx)(ChangeFieldWrapper, { ...props, hasRevertHover: false });
}
...
function Content$1(t0) {
  ...
  if (error) {
    let t12;
    return $[0] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t12 = (0, import_jsx_runtime3.jsx)(NoChanges, {}), $[0] = t12) : t12 = $[0], t12;
  }
  if (loading) {
    let t12;
    return $[1] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t12 = (0, import_jsx_runtime3.jsx)(LoadingBlock, { showText: true }), $[1] = t12) : t12 = $[1], t12;
  }
  if (!diff) {
    let t12;
    return $[2] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t12 = (0, import_jsx_runtime3.jsx)(NoChanges, {}), $[2] = t12) : t12 = $[2], t12;
  }
  let t1;
  $[3] !== diff || $[4] !== schemaType ? (t1 = (0, import_jsx_runtime3.jsx)(ChangeList, { diff, schemaType }), $[3] = diff, $[4] = schemaType, $[5] = t1) : t1 = $[5];
  let t2;
  return $[6] !== documentContext || $[7] !== t1 ? (t2 = (0, import_jsx_runtime3.jsx)(DocumentChangeContext.Provider, { value: documentContext, children: t1 }), $[6] = documentContext, $[7] = t1, $[8] = t2) : t2 = $[8], t2;
}
...
function EventTimelineItem(t0) {
  ...
  let t7;
  $[11] !== event ? (t7 = (0, import_jsx_runtime3.jsx)(Event$1, { event, showChangesBy: "tooltip" }), $[11] = event, $[12] = t7) : t7 = $[12];
  let t8;
  $[13] !== event.timestamp || $[14] !== handleClick || $[15] !== isSelected || $[16] !== t4 || $[17] !== t6 || $[18] !== t7 ? (t8 = (0, import_jsx_runtime3.jsx)(Card, { as: t4, onClick: handleClick, padding: 2, pressed: isSelected, radius: 2, "data-ui": "timelineItem", "data-testid": "timeline-item-button", "data-chunk-timestamp": event.timestamp, style: t6, children: t7 }), $[13] = event.timestamp, $[14] = handleClick, $[15] = isSelected, $[16] = t4, $[17] = t6, $[18] = t7, $[19] = t8) : t8 = $[19];
  let t9;
  $[20] !== isSelectable || $[21] !== t3 || $[22] !== t8 ? (t9 = (0, import_jsx_runtime3.jsx)(Tooltip, { content: t3, disabled: isSelectable, children: t8 }), $[20] = isSelectable, $[21] = t3, $[22] = t8, $[23] = t9) : t9 = $[23];
  let t10;
  return $[24] !== optionsMenu || $[25] !== t9 ? (t10 = (0, import_jsx_runtime3.jsxs)(Flex, { gap: 1, children: [
    t9,
    optionsMenu
...
function PublishedEventMenu(t0) {
  ...
  $[12] !== event.release ? (t4 = (t52) => {
    ...
    return (0, import_jsx_runtime3.jsx)(VersionInlineBadge, { $tone: event.release ? isReleaseDocument(event.release) ? getReleaseTone(event.release) : "default" : void 0, children });
  ...
  let t10;
  $[24] !== isMenuDisabled || $[25] !== t7 || $[26] !== t9 ? (t10 = (0, import_jsx_runtime3.jsx)(ContextMenuButton, { "aria-label": t7, tooltipProps: t9, disabled: isMenuDisabled }), $[24] = isMenuDisabled, $[25] = t7, $[26] = t9, $[27] = t10) : t10 = $[27];
  let t11;
  $[28] !== VersionBadge || $[29] !== event.release || $[30] !== event.versionRevisionId || $[31] !== handleOpenDraftDocument || $[32] !== handleOpenReleaseDocument || $[33] !== t2 || $[34] !== tCore ? (t11 = (0, import_jsx_runtime3.jsx)(Menu, { padding: 1, children: event.release ? (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
    (0, import_jsx_runtime3.jsx)(IntentLink, { intent: RELEASES_INTENT, params: {
      id: getReleaseIdFromReleaseDocumentId(event.release._id)
    }, style: {
      textDecoration: "none"
    }, children: (0, import_jsx_runtime3.jsx)(MenuItem, { padding: 3, children: (0, import_jsx_runtime3.jsx)(Flex, { align: "center", justify: "flex-start", children: (0, import_jsx_runtime3.jsx)(Text, { size: 1, style: {
      textDecoration: "none"
    }, children: (0, import_jsx_runtime3.jsx)(Translate, { components: {
      VersionBadge: (t122) => {
        const {
          children: children_0
        } = t122;
        return (0, import_jsx_runtime3.jsx)(VersionBadge, { children: children_0 });
      }
    }, i18nKey: "events.open.release", values: {
      releaseTitle: event.release.metadata?.title || tCore("release.placeholder-untitled-release")
    }, t: t2 }) }) }) }) }),
    (0, import_jsx_runtime3.jsx)(MenuItem, { onClick: handleOpenReleaseDocument, children: (0, import_jsx_runtime3.jsx)(Flex, { align: "center", justify: "flex-start", children: (0, import_jsx_runtime3.jsx)(Text, { size: 1, children: (0, import_jsx_runtime3.jsx)(Translate, { components: {
      VersionBadge: (t132) => {
        const {
          children: children_1
        } = t132;
        return (0, import_jsx_runtime3.jsx)(VersionBadge, { children: children_1 });
      }
    }, i18nKey: "events.inspect.release", values: {
      releaseTitle: event.release.metadata?.title || tCore("release.placeholder-untitled-release")
    }, t: t2 }) }) }) })
  ] }) : (0, import_jsx_runtime3.jsx)(MenuItem, { onClick: handleOpenDraftDocument, disabled: !event.versionRevisionId, children: (0, import_jsx_runtime3.jsx)(Flex, { align: "center", children: (0, import_jsx_runtime3.jsx)(Text, { size: 1, children: (0, import_jsx_runtime3.jsx)(Translate, { components: {
  ...
  let t15;
  return $[39] !== t10 || $[40] !== t11 || $[41] !== t14 || $[42] !== t6 ? (t15 = (0, import_jsx_runtime3.jsx)(MenuButton, { id: t6, button: t10, menu: t11, popover: t14 }), $[39] = t10, $[40] = t11, $[41] = t14, $[42] = t6, $[43] = t15) : t15 = $[43], t15;
}
function _temp$4(t0) {
  const {
    children: children_2
  } = t0;
  return (0, import_jsx_runtime3.jsx)(VersionInlineBadge, { $tone: "caution", children: children_2 });
}
...
var EventsTimeline = (t0) => {
  ...
  const [expandedParents, setExpandedParents] = (0, import_react3.useState)(t22);
  let t3;
  $[3] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t3 = /* @__PURE__ */ new Set(), $[3] = t3) : t3 = $[3];
  const [expandingParents, setExpandingParents] = (0, import_react3.useState)(t3);
  let t4;
  ...
  $[11] !== expandedParents || $[12] !== handleExpandParent ? (t7 = (event_3) => {
    ...
    return isPublishDocumentVersionEvent(event_3) && documentVariantType === "published" ? (0, import_jsx_runtime3.jsx)(PublishedEventMenu, { event: event_3 }) : isPublishDocumentVersionEvent(event_3) && documentVariantType === "draft" && event_3.creationEvent || isDeleteDocumentVersionEvent(event_3) && event_3.creationEvent ? (0, import_jsx_runtime3.jsx)(ExpandableTimelineItemButton, { isExpanded: expandedParents.has(event_3.id), onExpand: handleExpandParent(event_3) }) : null;
  ...
  $[14] !== events.length || $[15] !== expandingParents || $[16] !== handleSelectChunk || $[17] !== hasMoreEvents || $[18] !== renderOptionsMenu || $[19] !== selectedEventId ? (t8 = (event_4, t92) => {
    ...
    return showExpandingLoader ? (0, import_jsx_runtime3.jsx)(TimelineItemWrapper, { animate: {
      opacity: 1
    }, initial: {
      opacity: 0
    }, transition: {
      duration: 0.2,
      delay: 0.2
    }, children: (0, import_jsx_runtime3.jsx)(Flex, { align: "center", justify: "center", style: {
      height: ITEM_HEIGHT
    }, children: (0, import_jsx_runtime3.jsx)(Spinner, {}) }) }) : (0, import_jsx_runtime3.jsxs)(TimelineItemWrapper, { paddingBottom: 1, paddingRight: 1, animate: "animate", exit: "exit", initial: "initial", variants: "parentId" in event_4 ? CHILDREN_ITEMS_VARIANTS : void 0, paddingLeft: (isEditDocumentVersionEvent(event_4) || isCreateDocumentVersionEvent(event_4)) && event_4.parentId && !isLastEvent_0 ? 4 : 1, children: [
      (0, import_jsx_runtime3.jsx)(EventTimelineItem, { event: event_4, isSelected: event_4.id === selectedEventId, onSelect: handleSelectChunk, optionsMenu: renderOptionsMenu(event_4) }),
      isLastEvent_0 && hasMoreEvents && (0, import_jsx_runtime3.jsx)(LoadingBlock, {})
    ] }, event_4.timestamp);
  ...
  const renderItem = t8;
  let t10, t9;
  $[21] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t9 = () => setMounted(true), t10 = [], $[21] = t10, $[22] = t9) : (t10 = $[21], t9 = $[22]), (0, import_react3.useEffect)(t9, t10);
  let t11;
  ...
  let t13;
  $[28] !== events || $[29] !== listMaxHeight || $[30] !== onLoadMore || $[31] !== renderItem || $[32] !== selectedIndex || $[33] !== t2 ? (t13 = events.length > 0 ? (0, import_jsx_runtime3.jsx)(ListWrapper, { direction: "column", $maxHeight: listMaxHeight, id: TIMELINE_LIST_WRAPPER_ID, children: (0, import_jsx_runtime3.jsx)(CommandList, { activeItemDataAttr: "data-hovered", ariaLabel: t2("timeline.list.aria-label"), autoFocus: "list", initialIndex: selectedIndex, initialScrollAlign: "center", itemHeight: ITEM_HEIGHT, items: events, onEndReached: onLoadMore, onEndReachedIndexOffset: 20, overscan: 5, renderItem, wrapAround: false }) }) : (0, import_jsx_runtime3.jsxs)(Stack, { padding: 3, space: 3, children: [
    (0, import_jsx_runtime3.jsx)(Text, { size: 1, weight: "medium", children: t2("timeline.error.no-document-history-title") }),
    (0, import_jsx_runtime3.jsx)(Text, { muted: true, size: 1, children: t2("timeline.error.no-document-history-description") })
  ] }), $[28] = events, $[29] = listMaxHeight, $[30] = onLoadMore, $[31] = renderItem, $[32] = selectedIndex, $[33] = t2, $[34] = t13) : t13 = $[34];
  let t14;
  return $[35] !== t12 || $[36] !== t13 ? (t14 = (0, import_jsx_runtime3.jsx)(Root$2, { $visible: t12, "data-ui": "timeline", children: t13 }), $[35] = t12, $[36] = t13, $[37] = t14) : t14 = $[37], t14;
};
EventsTimeline.displayName = "EventsTimeline";
var Root = at(Popover2)`
  overflow: hidden;
  overflow: clip;
`;
...
function EventsTimelineMenu(t0) {
  const $ = (0, import_compiler_runtime2.c)(58), {
    ...
    setTimelineRange
  } = useDocumentPane(), [open, setOpen] = (0, import_react3.useState)(false), [button, setButton] = (0, import_react3.useState)(null), [popoverRef, setPopoverRef] = (0, import_react3.useState)(null), toast = useToast(), {
    nextCursor,
    loading,
    error: eventsError,
  ...
  let t18;
  $[44] !== open || $[45] !== t13 || $[46] !== t14 || $[47] !== t15 || $[48] !== t17 ? (t18 = (0, import_jsx_runtime3.jsx)(Flex, { width: "fill", children: (0, import_jsx_runtime3.jsx)(Button2, { "data-testid": t13, disabled: t14, mode: "ghost", onClick: t15, ref: setButton, selected: open, width: "fill", tooltipProps: null, justify: "space-between", style: t16, iconRight: ChevronDownIcon, text: t17 }) }), $[44] = open, $[45] = t13, $[46] = t14, $[47] = t15, $[48] = t17, $[49] = t18) : t18 = $[49];
  let t19;
  $[50] !== open || $[51] !== placement || $[52] !== t12 || $[53] !== t18 ? (t19 = (0, import_jsx_runtime3.jsx)(Root, { "data-testid": "timeline-menu", constrainSize: true, content: t12, "data-ui": "versionMenu", open, placement, matchReferenceWidth: true, portal: true, ref: setPopoverRef, children: t18 }), $[50] = open, $[51] = placement, $[52] = t12, $[53] = t18, $[54] = t19) : t19 = $[54];
  let t20;
  return $[55] !== portalElements || $[56] !== t19 ? (t20 = (0, import_jsx_runtime3.jsx)(PortalProvider, { __unstable_elements: portalElements, children: t19 }), $[55] = portalElements, $[56] = t19, $[57] = t20) : t20 = $[57], t20;
}
var Scroller$2 = at(ScrollContainer)`
  height: 100%;
  overflow: auto;
  position: relative;
  scroll-behavior: smooth;
...
var CompareWithPublishedView = () => {
  ...
  let t22;
  $[5] !== t1 ? (t22 = (0, import_jsx_runtime3.jsx)(Text, { size: 1, weight: "medium", children: t1 }), $[5] = t1, $[6] = t22) : t22 = $[6];
  let t3;
  ...
  let t5;
  $[11] !== t2 || $[12] !== t4 ? (t5 = (0, import_jsx_runtime3.jsx)(Text, { size: 1, muted: true, children: (0, import_jsx_runtime3.jsx)(Translate, { i18nKey: "events.compare-with-published.description", t: t2, values: t4 }) }), $[11] = t2, $[12] = t4, $[13] = t5) : t5 = $[13];
  let t6;
  $[14] !== t22 || $[15] !== t5 ? (t6 = (0, import_jsx_runtime3.jsx)(Card, { borderBottom: true, paddingBottom: 3, children: (0, import_jsx_runtime3.jsxs)(Stack, { space: 3, paddingTop: 1, children: [
    t22,
    t5
  ...
  let t8;
  $[22] !== rootDiff || $[23] !== schemaType ? (t8 = (0, import_jsx_runtime3.jsx)(Box, { paddingY: 1, children: (0, import_jsx_runtime3.jsx)(ChangeList, { diff: rootDiff, schemaType }) }), $[22] = rootDiff, $[23] = schemaType, $[24] = t8) : t8 = $[24];
  let t9;
  $[25] !== t7 || $[26] !== t8 ? (t9 = (0, import_jsx_runtime3.jsx)(DocumentChangeContext.Provider, { value: t7, children: t8 }), $[25] = t7, $[26] = t8, $[27] = t9) : t9 = $[27];
  let t10;
  return $[28] !== t6 || $[29] !== t9 ? (t10 = (0, import_jsx_runtime3.jsxs)(Stack, { space: 2, marginBottom: 3, children: [
    t6,
    t9
...
function EventsInspector(t0) {
  const $ = (0, import_compiler_runtime2.c)(83), {
    ...
    value,
    formState
  } = useDocumentPane(), [scrollRef, setScrollRef] = (0, import_react3.useState)(null), {
    events,
    revision,
    sinceRevision,
    getChangesList
  ...
  if (!events.length) {
    ...
    let t72;
    $[30] !== t62 ? (t72 = (0, import_jsx_runtime3.jsx)(Text, { size: 1, weight: "medium", children: t62 }), $[30] = t62, $[31] = t72) : t72 = $[31];
    let t82;
    $[32] !== t2 ? (t82 = t2("timeline.error.no-document-history-description"), $[32] = t2, $[33] = t82) : t82 = $[33];
    let t92;
    $[34] !== t82 ? (t92 = (0, import_jsx_runtime3.jsx)(Text, { muted: true, size: 1, children: t82 }), $[34] = t82, $[35] = t92) : t92 = $[35];
    let t102;
    return $[36] !== t72 || $[37] !== t92 ? (t102 = (0, import_jsx_runtime3.jsx)(Box, { paddingX: 2, children: (0, import_jsx_runtime3.jsxs)(Stack, { padding: 3, space: 3, children: [
      t72,
      t92
  ...
  let t8;
  $[42] !== t7 ? (t8 = (0, import_jsx_runtime3.jsx)(Text, { size: 1, muted: true, children: t7 }), $[42] = t7, $[43] = t8) : t8 = $[43];
  const t9 = sinceEvent || null;
  let t10;
  $[44] !== sinceEvents || $[45] !== t9 ? (t10 = (0, import_jsx_runtime3.jsx)(EventsTimelineMenu, { event: t9, events: sinceEvents, mode: "since", placement: "bottom-start" }), $[44] = sinceEvents, $[45] = t9, $[46] = t10) : t10 = $[46];
  let t11;
  $[47] !== t2 ? (t11 = t2("changes.inspector.to-label"), $[47] = t2, $[48] = t11) : t11 = $[48];
  let t12;
  $[49] !== t11 ? (t12 = (0, import_jsx_runtime3.jsx)(Text, { size: 1, muted: true, children: t11 }), $[49] = t11, $[50] = t12) : t12 = $[50];
  const t13 = toEvent || null;
  let t14;
  $[51] !== events || $[52] !== t13 ? (t14 = (0, import_jsx_runtime3.jsx)(EventsTimelineMenu, { event: t13, events, mode: "rev", placement: "bottom-end" }), $[51] = events, $[52] = t13, $[53] = t14) : t14 = $[53];
  let t15;
  $[54] !== t10 || $[55] !== t12 || $[56] !== t14 || $[57] !== t8 ? (t15 = (0, import_jsx_runtime3.jsxs)(Grid, { paddingX: 2, paddingBottom: 2, children: [
    t8,
    t10,
    t12,
    t14
  ...
  let t16;
  $[59] !== diffLoading || $[60] !== t2 ? (t16 = diffLoading && (0, import_jsx_runtime3.jsx)(motion.div, { animate: {
    opacity: 1
  }, initial: {
    opacity: 0
  }, transition: {
    delay: 0.2,
    duration: 0.2
  }, children: (0, import_jsx_runtime3.jsxs)(SpinnerContainer, { justify: "center", align: "center", gap: 2, children: [
    (0, import_jsx_runtime3.jsx)(Text, { muted: true, size: 0, children: t2("changes.loading-changes") }),
    (0, import_jsx_runtime3.jsx)(Spinner, { size: 0 })
  ] }) }), $[59] = diffLoading, $[60] = t2, $[61] = t16) : t16 = $[61];
  let t17;
  $[62] !== t15 || $[63] !== t16 ? (t17 = (0, import_jsx_runtime3.jsxs)(Box, { padding: 3, style: t6, children: [
    t15,
    t16
  ] }), $[62] = t15, $[63] = t16, $[64] = t17) : t17 = $[64];
  let t18;
  $[65] !== diffError || $[66] !== documentContext || $[67] !== revision?.loading || $[68] !== schemaType || $[69] !== showChanges || $[70] !== sinceEvent || $[71] !== sinceRevision?.loading || $[72] !== timelineError || $[73] !== toEvent?.id ? (t18 = showChanges && (0, import_jsx_runtime3.jsx)(Content, { documentContext, error: timelineError || diffError, loading: revision?.loading || sinceRevision?.loading || false, schemaType, sameRevisionSelected: sinceEvent?.id === toEvent?.id, sinceEvent }), $[65] = diffError, $[66] = documentContext, $[67] = revision?.loading, $[68] = schemaType, $[69] = showChanges, $[70] = sinceEvent, $[71] = sinceRevision?.loading, $[72] = timelineError, $[73] = toEvent?.id, $[74] = t18) : t18 = $[74];
  let t19;
  $[75] !== t18 ? (t19 = (0, import_jsx_runtime3.jsx)(Scroller$2, { "data-ui": "Scroller", ref: setScrollRef, children: (0, import_jsx_runtime3.jsx)(Box, { flex: 1, paddingX: 3, height: "fill", children: t18 }) }), $[75] = t18, $[76] = t19) : t19 = $[76];
  let t20;
  $[77] !== scrollRef || $[78] !== t19 ? (t20 = (0, import_jsx_runtime3.jsx)(Card, { flex: 1, paddingX: 2, paddingY: 2, children: (0, import_jsx_runtime3.jsx)(BoundaryElementProvider, { element: scrollRef, children: t19 }) }), $[77] = scrollRef, $[78] = t19, $[79] = t20) : t20 = $[79];
  let t21;
  return $[80] !== t17 || $[81] !== t20 ? (t21 = (0, import_jsx_runtime3.jsxs)(Flex, { "data-testid": "review-changes-pane", direction: "column", height: "fill", overflow: "hidden", children: [
    t17,
    t20
  ] }), $[80] = t17, $[81] = t20, $[82] = t21) : t21 = $[82], t21;
}
function _temp2$1(props) {
  return props.path.length > 0 ? (0, import_jsx_runtime3.jsx)(ChangeFieldWrapper, { ...props }) : props.children;
}
function Content(t0) {
  ...
  if (error) {
    let t12;
    $[0] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t12 = (0, import_jsx_runtime3.jsx)(CompareWithPublishedView, {}), $[0] = t12) : t12 = $[0];
    let t22;
    $[1] !== error || $[2] !== sinceEvent?.type ? (t22 = sinceEvent?.type !== "historyCleared" && (0, import_jsx_runtime3.jsx)(ChangesError, { error }), $[1] = error, $[2] = sinceEvent?.type, $[3] = t22) : t22 = $[3];
    let t3;
    return $[4] !== t22 ? (t3 = (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
      t12,
      t22
    ] }), $[4] = t22, $[5] = t3) : t3 = $[5], t3;
  }
  if (loading) {
    let t12;
    return $[6] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t12 = (0, import_jsx_runtime3.jsx)(LoadingBlock, { showText: true }), $[6] = t12) : t12 = $[6], t12;
  }
  if (sameRevisionSelected) {
    let t12;
    return $[7] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t12 = (0, import_jsx_runtime3.jsx)(SameRevisionSelected, {}), $[7] = t12) : t12 = $[7], t12;
  }
  if (!documentContext.rootDiff) {
    let t12;
    return $[8] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t12 = (0, import_jsx_runtime3.jsx)(motion.div, { animate: {
      opacity: 1
    }, initial: {
      opacity: 0
    }, transition: {
      delay: 0.2,
      duration: 0.2
    }, children: (0, import_jsx_runtime3.jsx)(NoChanges, {}) }), $[8] = t12) : t12 = $[8], t12;
  }
  let t1;
  $[9] !== documentContext.rootDiff || $[10] !== schemaType ? (t1 = (0, import_jsx_runtime3.jsx)(Box, { paddingY: 1, children: (0, import_jsx_runtime3.jsx)(ChangeList, { diff: documentContext.rootDiff, schemaType }) }), $[9] = documentContext.rootDiff, $[10] = schemaType, $[11] = t1) : t1 = $[11];
  let t2;
  return $[12] !== documentContext || $[13] !== t1 ? (t2 = (0, import_jsx_runtime3.jsx)(DocumentChangeContext.Provider, { value: documentContext, children: t1 }), $[12] = documentContext, $[13] = t1, $[14] = t2) : t2 = $[14], t2;
}
function SameRevisionSelected() {
  ...
  let t4;
  $[5] !== t3 ? (t4 = (0, import_jsx_runtime3.jsx)(Text, { size: 1, weight: "medium", as: "h3", children: t3 }), $[5] = t3, $[6] = t4) : t4 = $[6];
  let t5;
  $[7] !== t2 ? (t5 = (0, import_jsx_runtime3.jsx)(Text, { as: "p", size: 1, muted: true, children: (0, import_jsx_runtime3.jsx)(Translate, { i18nKey: "changes.same-revision-selected-description", t: t2 }) }), $[7] = t2, $[8] = t5) : t5 = $[8];
  let t6;
  return $[9] !== t4 || $[10] !== t5 ? (t6 = (0, import_jsx_runtime3.jsx)(motion.div, { animate: t0, initial: t1, transition: t22, children: (0, import_jsx_runtime3.jsxs)(Stack, { space: 3, paddingTop: 2, children: [
    t4,
    t5
...
var Scroller$1 = at(ScrollContainer)`
  height: 100%;
  overflow: auto;
  position: relative;
  scroll-behavior: smooth;
...
function EventsSelector(t0) {
  const $ = (0, import_compiler_runtime2.c)(21), {
    showList
  } = t0, [scrollRef, setScrollRef] = (0, import_react3.useState)(null), [listHeight, setListHeight] = (0, import_react3.useState)(0), {
    setTimelineRange
  } = useDocumentPane();
  let t1;
  $[0] !== listHeight ? (t1 = (el) => {
  ...
  let t3;
  return $[7] !== error || $[8] !== events || $[9] !== expandEvent || $[10] !== getScrollerRef || $[11] !== initialLoad || $[12] !== listHeight || $[13] !== loadMoreEvents || $[14] !== loading || $[15] !== nextCursor || $[16] !== revision?.revisionId || $[17] !== scrollRef || $[18] !== selectRev || $[19] !== showList ? (t3 = (0, import_jsx_runtime3.jsx)(Flex, { "data-testid": "review-changes-pane", direction: "column", height: "fill", children: (0, import_jsx_runtime3.jsx)(Card, { flex: 1, padding: 2, paddingTop: 0, children: error ? (0, import_jsx_runtime3.jsx)(TimelineError, {}) : (0, import_jsx_runtime3.jsx)(BoundaryElementProvider, { element: scrollRef, children: (0, import_jsx_runtime3.jsxs)(Scroller$1, { "data-ui": "Scroller", ref: getScrollerRef, children: [
    listHeight && showList && !initialLoad ? (0, import_jsx_runtime3.jsx)(EventsTimeline, { events, fetchEventChildren: expandEvent, hasMoreEvents: !!nextCursor, selectedEventId: revision?.revisionId || events[0]?.id, onLoadMore: loadMoreEvents, onSelect: selectRev, listMaxHeight: `${listHeight}px` }) : null,
    loading && (0, import_jsx_runtime3.jsx)(LoadingBlock, {})
...
var Scroller = at(ScrollContainer)`
  height: 100%;
  overflow: auto;
  position: relative;
  scroll-behavior: smooth;
...
function HistorySelector(t0) {
  const $ = (0, import_compiler_runtime2.c)(20), {
    ...
    selectedReleaseId
  } = usePerspective(), [scrollRef, setScrollRef] = (0, import_react3.useState)(null), [listHeight, setListHeight] = (0, import_react3.useState)(0);
  let t1;
  ...
  let t4;
  return $[9] !== chunks || $[10] !== handleLoadMore || $[11] !== hasMoreChunks || $[12] !== listHeight || $[13] !== realRevChunk || $[14] !== scrollRef || $[15] !== selectRev || $[16] !== selectedReleaseId || $[17] !== showList || $[18] !== timelineError ? (t4 = (0, import_jsx_runtime3.jsx)(Flex, { "data-testid": "review-changes-pane", direction: "column", height: "fill", children: (0, import_jsx_runtime3.jsx)(Card, { flex: 1, padding: 2, paddingTop: 0, children: timelineError || selectedReleaseId ? (0, import_jsx_runtime3.jsx)(TimelineError, { versionError: !!selectedReleaseId }) : (0, import_jsx_runtime3.jsx)(BoundaryElementProvider, { element: scrollRef, children: (0, import_jsx_runtime3.jsx)(Scroller, { "data-ui": "Scroller", ref: getScrollerRef, children: listHeight && showList ? (0, import_jsx_runtime3.jsx)(Timeline, { chunks, hasMoreChunks, lastChunk: realRevChunk, onLoadMore: handleLoadMore, onSelect: selectRev, listMaxHeight: `${listHeight}px` }) : null }) }) }) }), $[9] = chunks, $[10] = handleLoadMore, $[11] = hasMoreChunks, $[12] = listHeight, $[13] = realRevChunk, $[14] = scrollRef, $[15] = selectRev, $[16] = selectedReleaseId, $[17] = showList, $[18] = timelineError, $[19] = t4) : t4 = $[19], t4;
}
...
function ChangesTabs(props) {
  const $ = (0, import_compiler_runtime2.c)(72), {
    params,
    setParams
  } = usePaneRouter(), source = useSource(), [parentRef, setParentRef] = (0, import_react3.useState)(null), {
    t: t2
  ...
  let t6;
  $[9] !== t3 || $[10] !== t4 || $[11] !== t5 ? (t6 = (0, import_jsx_runtime3.jsx)(Tab, { "aria-controls": "history-panel", id: "history-tab", label: t3, onClick: t4, selected: t5 }), $[9] = t3, $[10] = t4, $[11] = t5, $[12] = t6) : t6 = $[12];
  let t7;
  ...
  let t10;
  $[17] !== t7 || $[18] !== t8 || $[19] !== t9 ? (t10 = (0, import_jsx_runtime3.jsx)(Tab, { "aria-controls": "review-changes-panel", id: "changes-tab", label: t7, onClick: t8, selected: t9 }), $[17] = t7, $[18] = t8, $[19] = t9, $[20] = t10) : t10 = $[20];
  let t11;
  $[21] !== t10 || $[22] !== t6 ? (t11 = (0, import_jsx_runtime3.jsxs)(TabList, { space: 1, flex: 1, children: [
    t6,
    t10
  ...
  let t16;
  $[30] !== props.onClose || $[31] !== t12 || $[32] !== t15 ? (t16 = (0, import_jsx_runtime3.jsx)(Button2, { "aria-label": t12, icon: CloseIcon, mode: "bleed", onClick: t13, tooltipProps: t15 }), $[30] = props.onClose, $[31] = t12, $[32] = t15, $[33] = t16) : t16 = $[33];
  let t17;
  $[34] !== t11 || $[35] !== t16 ? (t17 = (0, import_jsx_runtime3.jsx)(Card, { paddingBottom: 1, children: (0, import_jsx_runtime3.jsxs)(Flex, { align: "center", padding: 3, gap: 2, children: [
    t11,
    t16
  ] }) }), $[34] = t11, $[35] = t16, $[36] = t17) : t17 = $[36];
  let t18;
  $[37] !== t2 ? (t18 = (0, import_jsx_runtime3.jsx)(Box, { flex: 1, padding: 1, children: (0, import_jsx_runtime3.jsx)(Text, { size: 1, children: (0, import_jsx_runtime3.jsx)(Translate, { t: t2, i18nKey: "changes.banner.tooltip" }) }) }), $[37] = t2, $[38] = t18) : t18 = $[38];
  let t19;
  $[39] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t19 = (0, import_jsx_runtime3.jsx)(Text, { size: 0, muted: true, children: (0, import_jsx_runtime3.jsx)(InfoOutlineIcon, { fontSize: 1 }) }), $[39] = t19) : t19 = $[39];
  let t20;
  $[40] !== parentRef || $[41] !== t18 ? (t20 = (0, import_jsx_runtime3.jsx)(Tooltip, { portal: true, placement: "bottom-end", boundaryElement: parentRef, content: t18, children: t19 }), $[40] = parentRef, $[41] = t18, $[42] = t20) : t20 = $[42];
  let t21;
  $[43] !== selectedPerspective || $[44] !== t2 ? (t21 = perspectiveLabel(selectedPerspective, {
    t: t2
  }), $[43] = selectedPerspective, $[44] = t2, $[45] = t21) : t21 = $[45];
  let t222;
  $[46] !== t21 ? (t222 = {
    perspective: t21
  }, $[46] = t21, $[47] = t222) : t222 = $[47];
  let t23;
  $[48] !== t2 || $[49] !== t222 ? (t23 = (0, import_jsx_runtime3.jsx)(Text, { size: 0, muted: true, children: (0, import_jsx_runtime3.jsx)(Translate, { t: t2, values: t222, i18nKey: "changes.banner.description" }) }), $[48] = t2, $[49] = t222, $[50] = t23) : t23 = $[50];
  let t24;
  $[51] !== t20 || $[52] !== t23 ? (t24 = (0, import_jsx_runtime3.jsx)(Card, { padding: 2, marginBottom: 3, marginX: 3, tone: "neutral", border: true, radius: 3, children: (0, import_jsx_runtime3.jsxs)(Flex, { gap: 2, align: "flex-start", children: [
    t20,
    t23
  ] }) }), $[51] = t20, $[52] = t23, $[53] = t24) : t24 = $[53];
  const t25 = paneRouterTab !== "history";
  let t26;
  $[54] !== paneRouterTab || $[55] !== source.beta?.eventsAPI?.documents ? (t26 = source.beta?.eventsAPI?.documents ? (0, import_jsx_runtime3.jsx)(EventsSelector, { showList: paneRouterTab === "history" }) : (0, import_jsx_runtime3.jsx)(HistorySelector, { showList: paneRouterTab === "history" }), $[54] = paneRouterTab, $[55] = source.beta?.eventsAPI?.documents, $[56] = t26) : t26 = $[56];
  let t27;
  $[57] !== t25 || $[58] !== t26 ? (t27 = (0, import_jsx_runtime3.jsx)(TabPanel, { "aria-labelledby": "history-tab", height: "fill", hidden: t25, id: "history-panel", children: t26 }), $[57] = t25, $[58] = t26, $[59] = t27) : t27 = $[59];
  const t28 = paneRouterTab !== "review";
  let t29;
  $[60] !== paneRouterTab || $[61] !== source.beta?.eventsAPI?.documents ? (t29 = source.beta?.eventsAPI?.documents ? (0, import_jsx_runtime3.jsx)(import_jsx_runtime3.Fragment, { children: paneRouterTab === "review" ? (0, import_jsx_runtime3.jsx)(EventsInspector, { showChanges: paneRouterTab === "review" }) : null }) : (0, import_jsx_runtime3.jsx)(ChangesInspector, { showChanges: paneRouterTab === "review" }), $[60] = paneRouterTab, $[61] = source.beta?.eventsAPI?.documents, $[62] = t29) : t29 = $[62];
  let t30;
  $[63] !== t28 || $[64] !== t29 ? (t30 = (0, import_jsx_runtime3.jsx)(TabPanel, { "aria-labelledby": "review-tab", hidden: t28, id: "review-panel", height: "fill", children: t29 }), $[63] = t28, $[64] = t29, $[65] = t30) : t30 = $[65];
  let t31;
  return $[66] !== t17 || $[67] !== t22 || $[68] !== t24 || $[69] !== t27 || $[70] !== t30 ? (t31 = (0, import_jsx_runtime3.jsxs)(FadeInFlex, { direction: "column", padding: 0, height: "fill", "data-ready": t22, ref: setParentRef, children: [
    t17,
    t24,
    t27,
    t30
  ] }), $[66] = t17, $[67] = t22, $[68] = t24, $[69] = t27, $[70] = t30, $[71] = t31) : t31 = $[71], t31;
}
function perspectiveLabel(perspective, {
  t: t2
}) {
  return isReleaseDocument(perspective) ? perspective.metadata.title ?? perspective._id : perspective === "drafts" ? t2("compare-versions.status.draft") : perspective === "published" ? t2("compare-versions.status.published") : perspective;
}
...
function ValidationInspector(props) {
  ...
  let t4;
  $[9] !== onClose || $[10] !== t22 || $[11] !== t3 ? (t4 = (0, import_jsx_runtime3.jsx)(DocumentInspectorHeader, { as: "header", closeButtonLabel: t22, flex: "none", onClose, title: t3 }), $[9] = onClose, $[10] = t22, $[11] = t3, $[12] = t4) : t4 = $[12];
  let t5;
  $[13] !== handleOpen || $[14] !== isVersionGoingToUnpublish || $[15] !== schemaType || $[16] !== t2 || $[17] !== validation || $[18] !== value ? (t5 = (0, import_jsx_runtime3.jsx)(Card, { flex: 1, overflow: "auto", padding: 3, children: isVersionGoingToUnpublish ? (0, import_jsx_runtime3.jsx)(Box, { padding: 2, children: (0, import_jsx_runtime3.jsx)(Text, { muted: true, size: 1, children: t2("panel.unpublish-message") }) }) : (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
    validation.length === 0 && (0, import_jsx_runtime3.jsx)(Box, { padding: 2, children: (0, import_jsx_runtime3.jsx)(Text, { muted: true, size: 1, children: t2("panel.no-errors-message") }) }),
    validation.length > 0 && (0, import_jsx_runtime3.jsx)(Stack, { space: 2, children: validation.map((marker, i) => (0, import_jsx_runtime3.jsx)(ValidationCard, { marker, onOpen: handleOpen, schemaType, value }, i)) })
  ] }) }), $[13] = handleOpen, $[14] = isVersionGoingToUnpublish, $[15] = schemaType, $[16] = t2, $[17] = validation, $[18] = value, $[19] = t5) : t5 = $[19];
  let t6;
  return $[20] !== t4 || $[21] !== t5 ? (t6 = (0, import_jsx_runtime3.jsxs)(Flex, { direction: "column", height: "fill", overflow: "hidden", children: [
    t4,
    t5
...
function ValidationCard(props) {
  ...
  const handleOpen = t0, [errorInfo, setErrorInfo] = (0, import_react3.useState)(null), Icon = MARKER_ICON[marker.level];
  let t1;
  $[3] !== errorInfo ? (t1 = errorInfo && (0, import_jsx_runtime3.jsx)(Card, { padding: 3, radius: 2, tone: "critical", children: (0, import_jsx_runtime3.jsx)(Text, { size: 1, children: errorInfo.error.message }) }), $[3] = errorInfo, $[4] = t1) : t1 = $[4];
  let t2;
  $[5] !== Icon || $[6] !== errorInfo || $[7] !== handleOpen || $[8] !== marker.level || $[9] !== marker.message || $[10] !== marker.path || $[11] !== schemaType || $[12] !== value ? (t2 = !errorInfo && (0, import_jsx_runtime3.jsx)(Card, { __unstable_focusRing: true, as: "button", onClick: handleOpen, padding: 3, radius: 2, tone: MARKER_TONE[marker.level], children: (0, import_jsx_runtime3.jsxs)(Flex, { align: "flex-start", gap: 3, children: [
    (0, import_jsx_runtime3.jsx)(Box, { flex: "none", children: (0, import_jsx_runtime3.jsx)(Text, { size: 1, children: (0, import_jsx_runtime3.jsx)(Icon, {}) }) }),
    (0, import_jsx_runtime3.jsxs)(Stack, { flex: 1, space: 2, children: [
      (0, import_jsx_runtime3.jsx)(DocumentNodePathBreadcrumbs, { path: marker.path, schemaType, value }),
      (0, import_jsx_runtime3.jsx)(Text, { muted: true, size: 1, children: marker.message })
    ] })
  ] }) }), $[5] = Icon, $[6] = errorInfo, $[7] = handleOpen, $[8] = marker.level, $[9] = marker.message, $[10] = marker.path, $[11] = schemaType, $[12] = value, $[13] = t2) : t2 = $[13];
  let t3;
  return $[14] !== t1 || $[15] !== t2 ? (t3 = (0, import_jsx_runtime3.jsxs)(ErrorBoundary, { onCatch: setErrorInfo, children: [
    t1,
    t2
...
function DocumentNodePathBreadcrumbs(props) {
  ...
  let t2;
  return $[6] !== t1 ? (t2 = (0, import_jsx_runtime3.jsx)(Text, { size: 1, children: t1 }), $[6] = t1, $[7] = t2) : t2 = $[7], t2;
}
function _temp$1(t2, i) {
  return (0, import_jsx_runtime3.jsxs)(import_react3.Fragment, { children: [
    i > 0 && (0, import_jsx_runtime3.jsx)("span", { style: {
      color: "var(--card-muted-fg-color)",
      opacity: 0.5
    }, children: " / " }),
    (0, import_jsx_runtime3.jsx)("span", { style: {
      fontWeight: 500
...
function encodeChunks(pane2, index, group) {
  const {
    ...
    params = {},
    id: id2
  } = pane2, [firstSibling] = group, paneIsFirstSibling = pane2 === firstSibling, sameAsFirst = index !== 0 && id2 === firstSibling.id, encodedPayload = typeof payload > "u" ? void 0 : encodeJsonParams(payload), encodedParams = Object.entries(params).filter((entry) => {
  ...
  return [sameAsFirst ? "" : id2].concat([encodedParams.length > 0 && encodedParams, encodedPayload].filter(isTruthy).flat()).join(",") || ",";
}
function parsePanesSegment(str) {
  return str.indexOf(",{") !== -1 ? parseOldPanesSegment(str) : str.split(";").map((group) => {
    const [firstSibling, ...restOfSiblings] = group.split("|").map((segment) => {
      const [id2, ...chunks] = segment.split(",");
...
function parseOldPanesSegment(str) {
  ...
  let buffer = str;
  for (; buffer.length; ) {
    const [match, id2, payloadChunk] = buffer.match(panePattern) || [];
    if (!match) {
...
var structureTool = definePlugin((options) => {
  ...
  return {
    ...
    tools: [{
      ...
      icon,
      component: (0, import_react3.lazy)(() => import("./index4-2VERT2MT.js")),
...
//# sourceMappingURL=chunk-I7QD7V2B.js.map
