...
// node_modules/sanity/lib/_chunks-es/resources2.js
var releasesLocaleStrings = {
  ...
  "archive-info.description": "It will be available for {{retentionDays}} days, then automatically removed on {{removalDate}}. <Link>Learn about retention</Link>.",
  ...
  "copy-to-draft-dialog.description": "A draft version of this document already exists. Copy the current version to the draft and override the existing draft version.",
  ...
  "summary.errors-found": "In order to publish or schedule the release, please resolve the conflicts found in the documents",
  ...
  "banner.scheduled-drafts-disabled": "Scheduled drafts has been disabled but there are still scheduled drafts to be published.",
  ...
  "banner.confirm-active-scheduled-drafts_one": "There is {{count}} Scheduled Draft that requires scheduling confirmation",
  /** Banner text showing count of active scheduled drafts requiring confirmation with multiple drafts */
  "banner.confirm-active-scheduled-drafts_other": "There are {{count}} Scheduled Drafts that require scheduling confirmation",
  ...
  "confirm-active-scheduled-drafts-dialog.description": "Schedule all paused Scheduled Drafts for their intended publish dates",
  /** Dialog warning when some scheduled drafts have past dates */
  "confirm-active-scheduled-drafts-dialog.past-dates-warning": "Some of these Scheduled Drafts are scheduled for past dates. Confirming schedules will immediately publish those versions of documents.",
...
//# sourceMappingURL=resources2-Y5SIZEG3.js.map
